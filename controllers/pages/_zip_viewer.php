...
?>
<script>var backupbuddy_legacy_file_browser;</script>
<?php

require_once pb_backupbuddy::plugin_path() . '/views/backups/generate-data-file.php';

$serial = backupbuddy_core::get_serial_from_file( $file );
?>

<div class="legacy-file-restore-wrapper" style="display:none;">
	<?php
	...
	<script type="text/javascript">
		jQuery(function() {
			backupbuddy_legacy_file_browser = function() {
