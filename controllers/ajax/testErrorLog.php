...
$test_message = 'Solid Backups Test - This is only a test. A user triggered Solid Backups to determine if writing to the PHP error log is working as expected.';
