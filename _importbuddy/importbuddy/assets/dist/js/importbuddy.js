...
(function (c, j) {
  ...
  if (!c.ui.version) {
    ...
    c.extend(c.expr[":"], {
      ...
      focusable: function focusable(a) {
    ...
    c.extend(c.ui, {
      ...
      hasScroll: function hasScroll(a, b) {
      ...
      isOverAxis: function isOverAxis(a, b, d) {
        return a > b && a < b + d;
      },
      isOver: function isOver(a, b, d, e, h, i) {
...
// leanModal v1.1.1 by Ray Stone - http://finelysliced.com.au
// Modified by Brian DiChiara, used translateX(-50%) to center modal.
...
function backupbuddy_saveLogAsFile() {
  var textFileAsBlob = new Blob([jQuery('#backupbuddy_messages').text()], {
    type: 'text/plain'
  });
...
function importbuddy_loadRestoreEvents() {
  ...
  // The entire backup process has been halted, whether by Solid Backups or the user.
  jQuery('#backupbuddy_messages').bind('backupbuddy_haltScript', function (e, json) {
    ...
    /*
     ...
     quickFix: 'Turn off inclusion of ImportBuddy. Navigate to Settings: Advanced Settings / Troubleshooting tab: Uncheck "Include Importer in full backup archive".',
