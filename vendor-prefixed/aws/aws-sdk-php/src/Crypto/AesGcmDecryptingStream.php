<?php
namespace Solid_Backups\Strauss\Aws\Crypto;

use Solid_Backups\Strauss\Aws\Exception\CryptoException;
use Solid_Backups\Strauss\GuzzleHttp\Psr7;
use Solid_Backups\Strauss\GuzzleHttp\Psr7\StreamDecoratorTrait;
use Solid_Backups\Strauss\Psr\Http\Message\StreamInterface;
use Solid_Backups\Strauss\Aws\Crypto\Polyfill\AesGcm;
use Solid_Backups\Strauss\Aws\Crypto\Polyfill\Key;
