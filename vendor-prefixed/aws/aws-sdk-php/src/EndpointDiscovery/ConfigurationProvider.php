<?php
namespace Solid_Backups\Strauss\Aws\EndpointDiscovery;
...
use Solid_Backups\Strauss\Aws\EndpointDiscovery\Exception\ConfigurationException;
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini(
        ...
        return function () use ($profile, $filename, $cacheLimit) {
            ...
            $data = \Solid_Backups\Strauss\Aws\parse_ini_file($filename, true);
            if ($data === false) {
