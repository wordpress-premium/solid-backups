...
use Solid_Backups\Strauss\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
...
use Solid_Backups\Strauss\GuzzleHttp\Psr7\Uri;
...
class AwsClient implements AwsClientInterface
{
     ...
     *   waiter, or paginator.
     * - credentials:
     *   (Solid_Backups\Strauss\Aws\Credentials\CredentialsInterface|array|bool|callable) Specifies
     ...
     * - token:
     *   (Solid_Backups\Strauss\Aws\Token\TokenInterface|array|bool|callable) Specifies
     ...
     * - csm:
     *   (Solid_Backups\Strauss\Aws\ClientSideMonitoring\ConfigurationInterface|array|callable) Specifies
     *   the credentials used to sign requests. Provide an
     ...
     *   of S3).
     * - endpoint_discovery: (Solid_Backups\Strauss\Aws\EndpointDiscovery\ConfigurationInterface,
     ...
     *   available regions.
     * - retries: (int, Solid_Backups\Strauss\Aws\Retry\ConfigurationInterface, Solid_Backups\Strauss\Aws\CacheInterface,
    ...
    private function parseClass()
    {
        ...
        return [
            strtolower($service),
            "Solid_Backups\\Strauss\\Aws\\{$service}\\Exception\\{$service}Exception"
        ];
    }
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \Solid_Backups\Strauss\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \Solid_Backups\Strauss\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
