...
use Solid_Backups\Strauss\Aws\Exception\UnresolvedApiException;
 ...
 *
 *     $c = \Solid_Backups\Strauss\Aws\or_chain($a, $b);
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \Solid_Backups\Strauss\Aws\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \Solid_Backups\Strauss\Aws\load_compiled_json($path);
