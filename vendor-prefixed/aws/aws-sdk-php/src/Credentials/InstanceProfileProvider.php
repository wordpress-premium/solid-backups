...
use Solid_Backups\Strauss\Aws\Exception\InvalidJsonException;
use Solid_Backups\Strauss\Aws\Sdk;
use Solid_Backups\Strauss\GuzzleHttp\Exception\TransferException;
...
class InstanceProfileProvider
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = isset($config['client'])
            ...
            : \Solid_Backups\Strauss\Aws\default_http_handler();
    }
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \Solid_Backups\Strauss\Aws\default_user_agent();
