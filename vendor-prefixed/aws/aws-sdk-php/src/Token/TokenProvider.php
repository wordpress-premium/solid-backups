<?php
namespace Solid_Backups\Strauss\Aws\Token;
...
use Solid_Backups\Strauss\Aws\Exception\TokenException;
...
class TokenProvider
{
     ...
     *
     * @return SsoToken
     * @see Solid_Backups\Strauss\Aws\Token\SsoToken for $config details.
     */
