...
use Solid_Backups\Strauss\Aws\Api\Validator;
use Solid_Backups\Strauss\Aws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use Solid_Backups\Strauss\Aws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use Solid_Backups\Strauss\Aws\ClientSideMonitoring\Configuration;
use Solid_Backups\Strauss\Aws\Configuration\ConfigurationResolver;
use Solid_Backups\Strauss\Aws\Credentials\CredentialProvider;
use Solid_Backups\Strauss\Aws\Credentials\Credentials;
use Solid_Backups\Strauss\Aws\Credentials\CredentialsInterface;
use Solid_Backups\Strauss\Aws\DefaultsMode\ConfigurationInterface as ConfigModeInterface;
use Solid_Backups\Strauss\Aws\DefaultsMode\ConfigurationProvider as ConfigModeProvider;
use Solid_Backups\Strauss\Aws\Endpoint\EndpointProvider;
use Solid_Backups\Strauss\Aws\Endpoint\PartitionEndpointProvider;
use Solid_Backups\Strauss\Aws\Endpoint\UseDualstackEndpoint\Configuration as UseDualStackEndpointConfiguration;
use Solid_Backups\Strauss\Aws\Endpoint\UseDualstackEndpoint\ConfigurationInterface as UseDualStackEndpointConfigurationInterface;
use Solid_Backups\Strauss\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider as UseDualStackConfigProvider;
use Solid_Backups\Strauss\Aws\Endpoint\UseFipsEndpoint\Configuration as UseFipsEndpointConfiguration;
use Solid_Backups\Strauss\Aws\Endpoint\UseFipsEndpoint\ConfigurationInterface as UseFipsEndpointConfigurationInterface;
use Solid_Backups\Strauss\Aws\Endpoint\UseFipsEndpoint\ConfigurationProvider as UseFipsConfigProvider;
use Solid_Backups\Strauss\Aws\EndpointDiscovery\ConfigurationInterface;
use Solid_Backups\Strauss\Aws\EndpointDiscovery\ConfigurationProvider;
use Solid_Backups\Strauss\Aws\EndpointV2\EndpointDefinitionProvider;
use Solid_Backups\Strauss\Aws\Exception\AwsException;
use Solid_Backups\Strauss\Aws\Exception\InvalidRegionException;
use Solid_Backups\Strauss\Aws\Retry\ConfigurationInterface as RetryConfigInterface;
use Solid_Backups\Strauss\Aws\Retry\ConfigurationProvider as RetryConfigProvider;
use Solid_Backups\Strauss\Aws\Signature\SignatureProvider;
use Solid_Backups\Strauss\Aws\Token\Token;
use Solid_Backups\Strauss\Aws\Token\TokenInterface;
use Solid_Backups\Strauss\Aws\Token\TokenProvider;
...
class ClientResolver
{
    ...
    private static $defaultArgs = [
        'service' => [
            'type'     => 'value',
            'valid'    => ['string'],
            'doc'      => 'Name of the service to utilize. This value will be supplied by default when using one of the SDK clients (e.g., Solid_Backups\\Strauss\\Aws\\S3\\S3Client).',
            'required' => true,
            'internal' => true
        ],
        'exception_class' => [
        ...
        'csm' => [
            'type'     => 'value',
            'valid'    => [\Solid_Backups\Strauss\Aws\ClientSideMonitoring\ConfigurationInterface::class, 'callable', 'array', 'bool'],
            ...
            'default'  => [\Solid_Backups\Strauss\Aws\ClientSideMonitoring\ConfigurationProvider::class, 'defaultProvider']
        ],
        'http' => [
            'type'    => 'value',
            'valid'   => ['array'],
    ...
    public static function _apply_csm($value, array &$args, HandlerList $list)
    {
        if ($value === false) {
            $value = new Configuration(
                false,
                \Solid_Backups\Strauss\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST,
                \Solid_Backups\Strauss\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT,
                \Solid_Backups\Strauss\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID
            );
            $args['csm'] = $value;
        }
    ...
    public static function _apply_endpoint_provider($value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            if ($value instanceof \Solid_Backups\Strauss\Aws\EndpointV2\EndpointProviderV2) {
            ...
            $args['region'] = \Solid_Backups\Strauss\Aws\strip_fips_pseudo_regions($args['region']);
    ...
    public static function _apply_user_agent($inputUserAgent, array &$args, HandlerList $list)
    {
        ...
        if (isset($args['endpoint_discovery'])) {
            if (($args['endpoint_discovery'] instanceof \Solid_Backups\Strauss\Aws\EndpointDiscovery\Configuration
        ...
        if (isset($args['retries'])) {
            if ($args['retries'] instanceof \Solid_Backups\Strauss\Aws\Retry\Configuration) {
    ...
    public static function _default_endpoint_provider(array $args)
    {
        ...
        if (self::isValidService($serviceName)
            ...
            return new \Solid_Backups\Strauss\Aws\EndpointV2\EndpointProviderV2(
                $ruleset,
...
EOT;
    ...
    private static function isValidService($service) {
        ...
        $services = \Solid_Backups\Strauss\Aws\manifest();
