...
use Solid_Backups\Strauss\AWS\CRT\Auth\Signable;
use Solid_Backups\Strauss\AWS\CRT\Auth\SignatureType;
use Solid_Backups\Strauss\AWS\CRT\Auth\Signing;
use Solid_Backups\Strauss\AWS\CRT\Auth\SigningAlgorithm;
use Solid_Backups\Strauss\AWS\CRT\Auth\SigningConfigAWS;
use Solid_Backups\Strauss\AWS\CRT\Auth\StaticCredentialsProvider;
use Solid_Backups\Strauss\AWS\CRT\HTTP\Request;
use Solid_Backups\Strauss\Aws\Exception\CommonRuntimeException;
use Solid_Backups\Strauss\Aws\Exception\CouldNotCreateChecksumException;
