<?php
namespace Solid_Backups\Strauss\Aws\Endpoint;

use Solid_Backups\Strauss\JmesPath\Env;
...
class PartitionEndpointProvider
{
    ...
    {
        $data = \Solid_Backups\Strauss\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \Solid_Backups\Strauss\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
