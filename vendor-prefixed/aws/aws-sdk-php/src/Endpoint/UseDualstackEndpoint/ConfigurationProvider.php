<?php
namespace Solid_Backups\Strauss\Aws\Endpoint\UseDualstackEndpoint;

use Solid_Backups\Strauss\Aws\AbstractConfigurationProvider;
use Solid_Backups\Strauss\Aws\CacheInterface;
use Solid_Backups\Strauss\Aws\ConfigurationProviderInterface;
use Solid_Backups\Strauss\Aws\Endpoint\UseDualstackEndpoint\Exception\ConfigurationException;
 ...
 *
 * <code>
 * use Solid_Backups\Strauss\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider;
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini($region, $profile = null, $filename = null)
    {
        ...
        return function () use ($region, $profile, $filename) {
            ...
            $data = \Solid_Backups\Strauss\Aws\parse_ini_file($filename, true, INI_SCANNER_NORMAL);
            if ($data === false) {
