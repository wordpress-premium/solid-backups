...
use Solid_Backups\Strauss\Aws\Signature\SignatureV4;
...
class PresignUrlMiddleware
{
    ...
    private function createPresignedUrl(
        ...
        $request = \Solid_Backups\Strauss\Aws\serialize($newCmd);
        // Create the new endpoint for the target endpoint.
        if ($this->endpointProvider instanceof \Solid_Backups\Strauss\Aws\EndpointV2\EndpointProviderV2) {
