...
use Solid_Backups\Strauss\Aws\Endpoint\PartitionInterface;
...
class MultiRegionClient implements AwsClientInterface
{
        ...
        return $args + [
            'client_factory' => [
                ...
                'default' => function (array $args) {
                    ...
                    $klass = "Solid_Backups\\Strauss\\Aws\\{$namespace}\\{$namespace}Client";
     ...
     * - partition: (Solid_Backups\Strauss\Aws\Endpoint\Partition|string) AWS partition to connect to.
