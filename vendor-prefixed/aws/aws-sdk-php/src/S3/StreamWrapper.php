...
use Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream;
use Solid_Backups\Strauss\GuzzleHttp\Psr7\CachingStream;
...
class StreamWrapper
{
    ...
    public function dir_opendir($path, $options)
    {
        ...
        $this->objectIterator = \Solid_Backups\Strauss\Aws\flatmap(
