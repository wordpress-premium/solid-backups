<?php
namespace Solid_Backups\Strauss\Aws\S3\Exception;

use Solid_Backups\Strauss\Aws\CommandInterface;
use Solid_Backups\Strauss\Aws\Exception\AwsException;
use Solid_Backups\Strauss\Aws\Multipart\UploadState;

class S3MultipartUploadException extends \Solid_Backups\Strauss\Aws\Exception\MultipartUploadException
{
