...
use Solid_Backups\Strauss\Aws\Crypto\DecryptionTraitV2;
use Solid_Backups\Strauss\Aws\Exception\CryptoException;
use Solid_Backups\Strauss\Aws\HashingStream;
use Solid_Backups\Strauss\Aws\PhpHash;
use Solid_Backups\Strauss\Aws\Crypto\AbstractCryptoClientV2;
use Solid_Backups\Strauss\Aws\Crypto\EncryptionTraitV2;
use Solid_Backups\Strauss\Aws\Crypto\MetadataEnvelope;
use Solid_Backups\Strauss\Aws\Crypto\MaterialsProvider;
use Solid_Backups\Strauss\Aws\Crypto\Cipher\CipherBuilderTrait;
 ...
 *
 * <code>
 * use Solid_Backups\Strauss\Aws\Crypto\KmsMaterialsProviderV2;
 * use Solid_Backups\Strauss\Aws\S3\Crypto\S3EncryptionClientV2;
 * use Solid_Backups\Strauss\Aws\S3\S3Client;
 *
...
class S3EncryptionClientV2 extends AbstractCryptoClientV2
{
     ...
     *   determined.
     *
     * @return \Solid_Backups\Strauss\Aws\Result PutObject call result with the details of uploading
     *                     the encrypted file.
     *
     * @throws \InvalidArgumentException Thrown when arguments above are not
     *                                   passed or are passed incorrectly.
     ...
     *   materials providers. Defaults to false.
     *
     * @return \Solid_Backups\Strauss\Aws\Result GetObject call result with the 'Body' field
