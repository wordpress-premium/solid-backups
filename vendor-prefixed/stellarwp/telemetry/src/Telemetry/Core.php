...
namespace Solid_Backups\Strauss\StellarWP\Telemetry;

use Solid_Backups\Strauss\StellarWP\ContainerContract\ContainerInterface;
use Solid_Backups\Strauss\StellarWP\Telemetry\Admin\Admin_Subscriber;
use Solid_Backups\Strauss\StellarWP\Telemetry\Admin\Resources;
use Solid_Backups\Strauss\StellarWP\Telemetry\Contracts\Data_Provider;
use Solid_Backups\Strauss\StellarWP\Telemetry\Data_Providers\Debug_Data;
use Solid_Backups\Strauss\StellarWP\Telemetry\Events\Event_Subscriber;
use Solid_Backups\Strauss\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use Solid_Backups\Strauss\StellarWP\Telemetry\Exit_Interview\Template;
use Solid_Backups\Strauss\StellarWP\Telemetry\Last_Send\Last_Send;
use Solid_Backups\Strauss\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use Solid_Backups\Strauss\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use Solid_Backups\Strauss\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use Solid_Backups\Strauss\StellarWP\Telemetry\Opt_In\Status;
use Solid_Backups\Strauss\StellarWP\Telemetry\Telemetry\Telemetry;
use Solid_Backups\Strauss\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \Solid_Backups\Strauss\StellarWP\ContainerContract\ContainerInterface
	 */
