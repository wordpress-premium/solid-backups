...
namespace Solid_Backups\Strauss\League\OAuth2\Client\Provider;

use Solid_Backups\Strauss\GuzzleHttp\Client as HttpClient;
use Solid_Backups\Strauss\GuzzleHttp\ClientInterface as HttpClientInterface;
use Solid_Backups\Strauss\GuzzleHttp\Exception\BadResponseException;
use InvalidArgumentException;
use Solid_Backups\Strauss\League\OAuth2\Client\Grant\AbstractGrant;
use Solid_Backups\Strauss\League\OAuth2\Client\Grant\GrantFactory;
use Solid_Backups\Strauss\League\OAuth2\Client\OptionProvider\OptionProviderInterface;
use Solid_Backups\Strauss\League\OAuth2\Client\OptionProvider\PostAuthOptionProvider;
use Solid_Backups\Strauss\League\OAuth2\Client\Provider\Exception\IdentityProviderException;
use Solid_Backups\Strauss\League\OAuth2\Client\Token\AccessToken;
use Solid_Backups\Strauss\League\OAuth2\Client\Token\AccessTokenInterface;
use Solid_Backups\Strauss\League\OAuth2\Client\Tool\ArrayAccessorTrait;
use Solid_Backups\Strauss\League\OAuth2\Client\Tool\GuardedPropertyTrait;
use Solid_Backups\Strauss\League\OAuth2\Client\Tool\QueryBuilderTrait;
use Solid_Backups\Strauss\League\OAuth2\Client\Tool\RequestFactory;
