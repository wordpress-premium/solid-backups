...
namespace Solid_Backups\Strauss\League\OAuth2\Client\Grant;

use Solid_Backups\Strauss\League\OAuth2\Client\Grant\Exception\InvalidGrantException;
...
class GrantFactory
{
    ...
    protected function registerDefaultGrant($name)
    {
        ...
        $class = 'Solid_Backups\\Strauss\\League\\OAuth2\\Client\\Grant\\' . $class;
