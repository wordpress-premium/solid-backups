 ...
 *
 * @see \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\DriveItemProxy
 */
abstract class DriveItem
{
    /**
     * @var \Solid_Backups\Strauss\Krizalys\Onedrive\Client
     ...
     * Constructor.
     *
     * @param \Solid_Backups\Strauss\Krizalys\Onedrive\Client $client
    ...
    public function __construct(Client $client, $id, $options = [])
    {
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\DriveItemProxy instead',
            __METHOD__
        );
    ...
    public function isFolder()
    {
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\DriveItemProxy::folder instead',
            __METHOD__
        );
    ...
    public function getId()
    {
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\DriveItemProxy::id instead',
            __METHOD__
        );
    ...
    public function getParentId()
    {
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\DriveItemProxy::parentReference'
                . ' instead',
            __METHOD__
        );
    ...
    public function getName()
    {
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\BaseItemProxy::name instead',
            __METHOD__
        );
    ...
    public function getDescription()
    {
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\BaseItemProxy::description',
            __METHOD__
        );
    ...
    public function getSize()
    {
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\DriveItemProxy::size instead',
            __METHOD__
        );
    ...
    public function getCreatedTime()
    {
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\BaseItemProxy::createdDateTime'
                . ' instead',
            __METHOD__
        );
    ...
    public function getUpdatedTime()
    {
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\BaseItemProxy::lastModifiedDateTime'
                . ' instead',
            __METHOD__
        );
