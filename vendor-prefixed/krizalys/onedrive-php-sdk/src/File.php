 ...
 * @see \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\File
 */
class File extends DriveItem
{
    ...
    public function __construct(Client $client, $id, $options = [])
    {
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\FileProxy instead',
            __METHOD__
        );
    ...
    public function fetchContent(array $options = [])
    {
        ...
        $message = sprintf(
            '%s() is deprecated and will be removed in version 3;'
                . ' use \Solid_Backups\Strauss\Krizalys\Onedrive\Proxy\DriveItemProxy::content'
                . ' instead.',
            __METHOD__
        );
