...
namespace Solid_Backups\Strauss\Monolog;

use DateTimeZone;
use Solid_Backups\Strauss\Monolog\Handler\HandlerInterface;
use Solid_Backups\Strauss\Psr\Log\LoggerInterface;
use Solid_Backups\Strauss\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \Solid_Backups\Strauss\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
