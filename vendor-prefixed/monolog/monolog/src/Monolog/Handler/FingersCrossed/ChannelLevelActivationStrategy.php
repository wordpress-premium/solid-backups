...
namespace Solid_Backups\Strauss\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = array_map('Solid_Backups\Strauss\Monolog\Logger::toMonologLevel', $channelToActionLevel);
    }
