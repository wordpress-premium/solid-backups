...
namespace Solid_Backups\Strauss\Monolog\Handler;

use Solid_Backups\Strauss\Monolog\Formatter\LineFormatter;
use Solid_Backups\Strauss\Monolog\Formatter\FormatterInterface;
use Solid_Backups\Strauss\Monolog\Logger;
use Solid_Backups\Strauss\Monolog\Utils;
 ...
 *
 *      $logger = new \Solid_Backups\Strauss\Monolog\Logger('all', array(new \Solid_Backups\Strauss\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['Solid_Backups\\Strauss\\Monolog\\'], // array Hide calls of classes started with...
