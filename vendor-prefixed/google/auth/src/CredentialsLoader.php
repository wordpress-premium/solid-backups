...
use Solid_Backups\Strauss\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use Solid_Backups\Strauss\Google\Auth\Credentials\InsecureCredentials;
    ...
    UpdateMetadataInterface
{
     ...
     * @return \Solid_Backups\Strauss\GuzzleHttp\Client
     */
    public static function makeHttpClient(
        ...
        $stack = \Solid_Backups\Strauss\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \Solid_Backups\Strauss\GuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
