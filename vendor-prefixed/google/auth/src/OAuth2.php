...
use Solid_Backups\Strauss\Firebase\JWT\JWT;
...
use Solid_Backups\Strauss\GuzzleHttp\Psr7\Query;
use Solid_Backups\Strauss\GuzzleHttp\Psr7\Request;
use Solid_Backups\Strauss\GuzzleHttp\Psr7\Utils;
...
use Solid_Backups\Strauss\Psr\Http\Message\UriInterface;
...
class OAuth2 implements FetchAuthTokenInterface
{
     ...
     * @throws \Solid_Backups\Strauss\Firebase\JWT\SignatureInvalidException If the signature is invalid.
     * @throws \Solid_Backups\Strauss\Firebase\JWT\BeforeValidException If the token is not yet valid.
     * @throws \Solid_Backups\Strauss\Firebase\JWT\ExpiredException If the token has expired.
     * @return null|object
     */
