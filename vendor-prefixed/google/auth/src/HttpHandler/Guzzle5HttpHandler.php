...
use Solid_Backups\Strauss\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!class_exists('Solid_Backups\Strauss\GuzzleHttp\Promise\Promise')) {
