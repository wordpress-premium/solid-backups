...
namespace Solid_Backups\Strauss\Google\Auth\Middleware;

use Solid_Backups\Strauss\Google\Auth\CacheTrait;
...
class ScopedAccessTokenMiddleware
{
     ...
     *       $scope,
     *       [ 'prefix' => 'Solid_Backups\Strauss\Google\Auth\ScopedAccessToken::' ],
     *       $cache = new Memcache()
     *   );
