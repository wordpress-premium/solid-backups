...
namespace Solid_Backups\Strauss\Google\Auth\Credentials;

use Solid_Backups\Strauss\Google\Auth\CredentialsLoader;
use Solid_Backups\Strauss\Google\Auth\GetQuotaProjectInterface;
use Solid_Backups\Strauss\Google\Auth\HttpHandler\HttpClientCache;
use Solid_Backups\Strauss\Google\Auth\HttpHandler\HttpHandlerFactory;
use Solid_Backups\Strauss\Google\Auth\Iam;
use Solid_Backups\Strauss\Google\Auth\IamSignerTrait;
use Solid_Backups\Strauss\Google\Auth\ProjectIdProviderInterface;
use Solid_Backups\Strauss\Google\Auth\SignBlobInterface;
use Solid_Backups\Strauss\GuzzleHttp\Exception\ClientException;
use Solid_Backups\Strauss\GuzzleHttp\Exception\ConnectException;
use Solid_Backups\Strauss\GuzzleHttp\Exception\RequestException;
use Solid_Backups\Strauss\GuzzleHttp\Exception\ServerException;
 ...
 *
 *   use Solid_Backups\Strauss\Google\Auth\Credentials\GCECredentials;
 *   use Solid_Backups\Strauss\Google\Auth\Middleware\AuthTokenMiddleware;
            ...
            try {
                ...
                $resp = $httpHandler(
                    new Request(
                        'GET',
                        $checkUri,
                        [self::FLAVOR_HEADER => 'Solid_Backups\Strauss\Google']
                    ),
                    ['timeout' => self::COMPUTE_PING_CONNECTION_TIMEOUT_S]
                );

                return $resp->getHeaderLine(self::FLAVOR_HEADER) == 'Solid_Backups\Strauss\Google';
