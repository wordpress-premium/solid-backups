...
namespace Solid_Backups\Strauss\Google\Auth;

use DomainException;
use Solid_Backups\Strauss\Google\Auth\Credentials\AppIdentityCredentials;
...
use Solid_Backups\Strauss\Google\Auth\Middleware\ProxyAuthTokenMiddleware;
use Solid_Backups\Strauss\Google\Auth\Subscriber\AuthTokenSubscriber;
