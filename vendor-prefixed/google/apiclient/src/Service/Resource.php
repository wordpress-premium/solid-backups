...
namespace Solid_Backups\Strauss\Google\Service;

use Solid_Backups\Strauss\Google\Exception as GoogleException;
use Solid_Backups\Strauss\Google\Http\MediaFileUpload;
use Solid_Backups\Strauss\Google\Model;
use Solid_Backups\Strauss\Google\Utils\UriTemplate;
...
class Resource
{
    ...
    /** @var \Solid_Backups\Strauss\Google\Client $client */
    private $client;
