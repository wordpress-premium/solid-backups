...
namespace Solid_Backups\Strauss\Google;

use BadMethodCallException;
use DomainException;
use Solid_Backups\Strauss\Google\AccessToken\Revoke;
use Solid_Backups\Strauss\Google\AccessToken\Verify;
use Solid_Backups\Strauss\Google\Auth\ApplicationDefaultCredentials;
use Solid_Backups\Strauss\Google\Auth\Cache\MemoryCacheItemPool;
use Solid_Backups\Strauss\Google\Auth\Credentials\ServiceAccountCredentials;
use Solid_Backups\Strauss\Google\Auth\Credentials\UserRefreshCredentials;
use Solid_Backups\Strauss\Google\Auth\CredentialsLoader;
use Solid_Backups\Strauss\Google\Auth\FetchAuthTokenCache;
use Solid_Backups\Strauss\Google\Auth\HttpHandler\HttpHandlerFactory;
use Solid_Backups\Strauss\Google\Auth\OAuth2;
use Solid_Backups\Strauss\Google\AuthHandler\AuthHandlerFactory;
use Solid_Backups\Strauss\Google\Http\REST;
use Solid_Backups\Strauss\GuzzleHttp\Client as GuzzleClient;
use Solid_Backups\Strauss\GuzzleHttp\ClientInterface;
use Solid_Backups\Strauss\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use Solid_Backups\Strauss\Monolog\Handler\StreamHandler as MonologStreamHandler;
use Solid_Backups\Strauss\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use Solid_Backups\Strauss\Monolog\Logger;
use Solid_Backups\Strauss\Psr\Cache\CacheItemPoolInterface;
use Solid_Backups\Strauss\Psr\Http\Message\RequestInterface;
use Solid_Backups\Strauss\Psr\Http\Message\ResponseInterface;
use Solid_Backups\Strauss\Psr\Log\LoggerInterface;
...
class Client
{
     ...
     * @throws \Solid_Backups\Strauss\Google\Exception
