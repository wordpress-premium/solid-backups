...
namespace Solid_Backups\Strauss\Google\Http;

use Solid_Backups\Strauss\Google\Auth\HttpHandler\HttpHandlerFactory;
use Solid_Backups\Strauss\Google\Service\Exception as GoogleServiceException;
use Solid_Backups\Strauss\Google\Task\Runner;
use Solid_Backups\Strauss\GuzzleHttp\ClientInterface;
use Solid_Backups\Strauss\GuzzleHttp\Exception\RequestException;
use Solid_Backups\Strauss\GuzzleHttp\Psr7\Response;
...
class REST
{
     ...
     * @return mixed|T|null
     * @throws \Solid_Backups\Strauss\Google\Service\Exception on server side error (ie: not authenticated,
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (
                interface_exists('\Solid_Backups\Strauss\GuzzleHttp\Message\ResponseInterface')
     ...
     * @param class-string<T>|false|null $expectedClass
     * @return mixed|T|null
     * @throws \Solid_Backups\Strauss\Google\Service\Exception
     */
