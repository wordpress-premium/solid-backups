...
{
    /**
     * If you need to specify a NULL JSON value, use Solid_Backups\Strauss\Google\Model::NULL_VALUE
     ...
     * @throws \Solid_Backups\Strauss\Google\Exception Thrown if $obj isn't an array.
