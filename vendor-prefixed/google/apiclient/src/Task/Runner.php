...
namespace Solid_Backups\Strauss\Google\Task;

use Solid_Backups\Strauss\Google\Service\Exception as GoogleServiceException;
use Solid_Backups\Strauss\Google\Task\Exception as GoogleTaskException;
...
class Runner
{
     ...
     * @throws \Solid_Backups\Strauss\Google\Task\Exception when misconfigured
     */
     ...
     *
     * @return mixed
     * @throws \Solid_Backups\Strauss\Google\Service\Exception on failure when no retries are available.
     */
    public function run()
    {
        while ($this->attempt()) {
