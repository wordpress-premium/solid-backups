...
namespace Solid_Backups\Strauss\Google\Service\Drive\Resource;

use Solid_Backups\Strauss\Google\Service\Drive\Channel;
use Solid_Backups\Strauss\Google\Service\Drive\DriveFile;
use Solid_Backups\Strauss\Google\Service\Drive\FileList;
use Solid_Backups\Strauss\Google\Service\Drive\GeneratedIds;
use Solid_Backups\Strauss\Google\Service\Drive\LabelList;
use Solid_Backups\Strauss\Google\Service\Drive\ModifyLabelsRequest;
use Solid_Backups\Strauss\Google\Service\Drive\ModifyLabelsResponse;

/**
 * The "files" collection of methods.
 * Typical usage is:
 *  <code>
 *   $driveService = new \Solid_Backups\Strauss\Google\Service\Drive(...);
 *   $files = $driveService->files;
 *  </code>
 */
class Files extends \Solid_Backups\Strauss\Google\Service\Resource
{
  /**
