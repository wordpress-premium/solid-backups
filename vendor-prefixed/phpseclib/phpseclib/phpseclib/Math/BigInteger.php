 ...
 * <code>
 * <?php
 *    $a = new \Solid_Backups\Strauss\phpseclib3\Math\BigInteger(2);
 *    $b = new \Solid_Backups\Strauss\phpseclib3\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
...
namespace Solid_Backups\Strauss\phpseclib3\Math;

use Solid_Backups\Strauss\phpseclib3\Exception\BadConfigurationException;
use Solid_Backups\Strauss\phpseclib3\Math\BigInteger\Engines\Engine;
...
class BigInteger implements \JsonSerializable
{
    ...
    public static function setEngine($main, array $modexps = ['DefaultEngine'])
    {
        ...
        $fqmain = 'Solid_Backups\\Strauss\\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
     ...
     * <code>
     * <?php
     *    $a = new \Solid_Backups\Strauss\phpseclib3\Math\BigInteger('10');
     *    $b = new \Solid_Backups\Strauss\phpseclib3\Math\BigInteger('20');
     *
