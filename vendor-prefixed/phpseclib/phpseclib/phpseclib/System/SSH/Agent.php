 ...
 *
 *    $agent = new \Solid_Backups\Strauss\phpseclib3\System\SSH\Agent();
 *
...
namespace Solid_Backups\Strauss\phpseclib3\System\SSH;
...
use Solid_Backups\Strauss\phpseclib3\Net\SSH2;
use Solid_Backups\Strauss\phpseclib3\System\SSH\Agent\Identity;
...
class Agent
{
     ...
     * Default Constructor
     *
     * @return \Solid_Backups\Strauss\phpseclib3\System\SSH\Agent
     * @throws \Solid_Backups\Strauss\phpseclib3\Exception\BadConfigurationException if SSH_AUTH_SOCK cannot be found
     ...
     *
     * @param \Solid_Backups\Strauss\phpseclib3\Net\SSH2 $ssh
     * @return bool
     */
