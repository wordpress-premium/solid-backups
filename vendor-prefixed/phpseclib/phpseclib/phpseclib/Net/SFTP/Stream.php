...
namespace Solid_Backups\Strauss\phpseclib3\Net\SFTP;

use Solid_Backups\Strauss\phpseclib3\Crypt\Common\PrivateKey;
use Solid_Backups\Strauss\phpseclib3\Net\SFTP;
...
class Stream
{
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \Solid_Backups\Strauss\phpseclib3\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     */
