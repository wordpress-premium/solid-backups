 ...
 *
 *    $ssh = new \Solid_Backups\Strauss\phpseclib3\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = \Solid_Backups\Strauss\phpseclib3\Crypt\PublicKeyLoader::load('...', '(optional) password');
 *
 *    $ssh = new \Solid_Backups\Strauss\phpseclib3\Net\SSH2('www.domain.tld');
...
namespace Solid_Backups\Strauss\phpseclib3\Net;

use Solid_Backups\Strauss\phpseclib3\Common\Functions\Strings;
use Solid_Backups\Strauss\phpseclib3\Crypt\Blowfish;
use Solid_Backups\Strauss\phpseclib3\Crypt\ChaCha20;
use Solid_Backups\Strauss\phpseclib3\Crypt\Common\AsymmetricKey;
use Solid_Backups\Strauss\phpseclib3\Crypt\Common\PrivateKey;
use Solid_Backups\Strauss\phpseclib3\Crypt\Common\PublicKey;
use Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey;
use Solid_Backups\Strauss\phpseclib3\Crypt\DH;
use Solid_Backups\Strauss\phpseclib3\Crypt\DSA;
use Solid_Backups\Strauss\phpseclib3\Crypt\EC;
use Solid_Backups\Strauss\phpseclib3\Crypt\Hash;
use Solid_Backups\Strauss\phpseclib3\Crypt\Random;
use Solid_Backups\Strauss\phpseclib3\Crypt\RC4;
use Solid_Backups\Strauss\phpseclib3\Crypt\Rijndael;
use Solid_Backups\Strauss\phpseclib3\Crypt\RSA;
use Solid_Backups\Strauss\phpseclib3\Crypt\TripleDES; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use Solid_Backups\Strauss\phpseclib3\Crypt\Twofish;
use Solid_Backups\Strauss\phpseclib3\Exception\ConnectionClosedException;
use Solid_Backups\Strauss\phpseclib3\Exception\InsufficientSetupException;
use Solid_Backups\Strauss\phpseclib3\Exception\NoSupportedAlgorithmsException;
use Solid_Backups\Strauss\phpseclib3\Exception\UnableToConnectException;
use Solid_Backups\Strauss\phpseclib3\Exception\UnsupportedAlgorithmException;
use Solid_Backups\Strauss\phpseclib3\Exception\UnsupportedCurveException;
use Solid_Backups\Strauss\phpseclib3\Math\BigInteger;
use Solid_Backups\Strauss\phpseclib3\System\SSH\Agent;
...
class SSH2
{
     ...
     *     the other side.
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Net\SSH2::send_channel_packet()
     * @see \Solid_Backups\Strauss\phpseclib3\Net\SSH2::get_channel_packet()
     */
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Net\SSH2::getLog()
     */
    const LOG_SIMPLE = 1;
    /**
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Net\SSH2::read()
     */
    const READ_SIMPLE = 1;
    /**
     ...
     * @throws \UnexpectedValueException on receipt of unexpected packets
     * @throws \RuntimeException on other errors
     * @throws \Solid_Backups\Strauss\phpseclib3\Exception\NoSupportedAlgorithmsException when none of the algorithms phpseclib has loaded are compatible
     */
     ...
     *
     * @param string $username
     * @param \Solid_Backups\Strauss\phpseclib3\System\SSH\Agent $agent
     * @return bool
     */
     ...
     *
     * @param string $username
     * @param \Solid_Backups\Strauss\phpseclib3\Crypt\Common\PrivateKey $privatekey
     * @return bool
     * @throws \RuntimeException on connection error
     */
     ...
     * @throws \Solid_Backups\Strauss\phpseclib3\Exception\NoSupportedAlgorithmsException when the key isn't in a supported format
     */
