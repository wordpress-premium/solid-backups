 ...
 *
 *    $sftp = new \Solid_Backups\Strauss\phpseclib3\Net\SFTP('www.domain.tld');
...
use Solid_Backups\Strauss\phpseclib3\Exception\FileNotFoundException;
...
class SFTP extends SSH2
{
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Net\SFTP::put()
     */
     ...
     *
     * By default, \Solid_Backups\Strauss\phpseclib3\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     ...
     * @throws \Solid_Backups\Strauss\phpseclib3\Exception\FileNotFoundException if you're uploading via a file and the file doesn't exist
     * @return bool
     */
