...
namespace Solid_Backups\Strauss\phpseclib3\File;
...
use Solid_Backups\Strauss\phpseclib3\Crypt\PublicKeyLoader;
use Solid_Backups\Strauss\phpseclib3\Crypt\Random;
use Solid_Backups\Strauss\phpseclib3\Crypt\RSA;
use Solid_Backups\Strauss\phpseclib3\Crypt\RSA\Formats\Keys\PSS;
use Solid_Backups\Strauss\phpseclib3\Exception\UnsupportedAlgorithmException;
use Solid_Backups\Strauss\phpseclib3\File\ASN1\Element;
use Solid_Backups\Strauss\phpseclib3\File\ASN1\Maps;
...
class X509
{
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\File\X509::getDN()
     */
    const DN_ARRAY = 0;
    /**
     * Return string
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\File\X509::saveX509()
     * @see \Solid_Backups\Strauss\phpseclib3\File\X509::saveCSR()
     * @see \Solid_Backups\Strauss\phpseclib3\File\X509::saveCRL()
     */
    const FORMAT_PEM = 0;
    /**
     * Save as DER
     ...
     * Default Constructor.
     *
     * @return \Solid_Backups\Strauss\phpseclib3\File\X509
     */
    ...
    public function saveX509(array $cert, $format = self::FORMAT_PEM)
    {
        ...
        /* in the case of policyQualifiers/qualifier, the type has to be \phpseclib3\File\ASN1::TYPE_IA5_STRING.
           \Solid_Backups\Strauss\phpseclib3\File\ASN1::TYPE_PRINTABLE_STRING will cause OpenSSL's X.509 parser to spit out random
           characters.
         */
     ...
     * @throws \Solid_Backups\Strauss\phpseclib3\Exception\UnsupportedAlgorithmException if the algorithm is unsupported
     * @return bool
     */
    ...
    public function sign(X509 $issuer, X509 $subject)
    {
        ...
        if (isset($subject->domains) && count($subject->domains)) {
            $altName = array_map(['\Solid_Backups\Strauss\phpseclib3\File\X509', 'dnsName'], $subject->domains);
        }
    ...
    public function computeKeyIdentifier($key = null, $method = 1)
    {
        ...
        switch (true) {
            ...
            case $key instanceof X509:
                ...
                return false;
            default: // Should be a key object (i.e.: \Solid_Backups\Strauss\phpseclib3\Crypt\RSA).
