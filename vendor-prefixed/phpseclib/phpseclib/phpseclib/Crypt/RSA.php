 ...
 *
 * $private = \Solid_Backups\Strauss\phpseclib3\Crypt\RSA::createKey();
...
use Solid_Backups\Strauss\phpseclib3\Crypt\RSA\PrivateKey;
use Solid_Backups\Strauss\phpseclib3\Crypt\RSA\PublicKey;
...
abstract class RSA extends AsymmetricKey
{
     ...
     *
     * @var \Solid_Backups\Strauss\phpseclib3\Crypt\Hash
     */
    protected $mgfHash;
     ...
     *
     * @param bool|\Solid_Backups\Strauss\phpseclib3\Math\BigInteger $x
     * @param int $xLen
     * @return bool|string
     */
