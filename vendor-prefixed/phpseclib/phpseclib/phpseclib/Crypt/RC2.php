 ...
 *
 *    $rc2 = new \Solid_Backups\Strauss\phpseclib3\Crypt\RC2('ctr');
 *
 *    $rc2->setKey('abcdefgh');
 *
...
class RC2 extends BlockCipher
{
     ...
     * The Key
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey::key
     * @see self::setKey()
     * @var string
     */
    protected $key;
     ...
     * Key Length (in bytes)
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\RC2::setKeyLength()
     * @var int
     */
