...
namespace Solid_Backups\Strauss\phpseclib3\Crypt\Common;
...
use Solid_Backups\Strauss\phpseclib3\Exception\BadDecryptionException;
use Solid_Backups\Strauss\phpseclib3\Exception\BadModeException;
use Solid_Backups\Strauss\phpseclib3\Exception\InconsistentSetupException;
...
use Solid_Backups\Strauss\phpseclib3\Math\BinaryField;
use Solid_Backups\Strauss\phpseclib3\Math\PrimeField;
...
abstract class SymmetricKey
{
     ...
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey::encrypt()
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey::decrypt()
     */
    const MODE_CTR = -1;
    /**
     ...
     * Mode Map
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey::__construct()
     */
    const MODE_MAP = [
        'ctr'    => self::MODE_CTR,
        'ecb'    => self::MODE_ECB,
     ...
     * Engine Reverse Map
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey::getEngine()
     */
    const ENGINE_MAP = [
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Twofish::setKey()
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Twofish::setIV()
     * @var bool
     */
     ...
     * @see self::setPassword()
     * @param int $n
     * @param \Solid_Backups\Strauss\phpseclib3\Crypt\Hash $hashObj
     * @param string $i
     * @param string $d
     * @param int $count
     * @return string $a
                    ...
                    if (strlen($_buffer["ciphertext"])) {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
                            ...
                            if (strlen($_block) > strlen($_buffer["ciphertext"])) {
                                $in = $_xor;
                                ' . $encrypt_block . '
                                \Solid_Backups\Strauss\phpseclib3\Common\Functions\Strings::increment_str($_xor);
                                $_buffer["ciphertext"].= $in;
                            }
                            $_key = \Solid_Backups\Strauss\phpseclib3\Common\Functions\Strings::shift($_buffer["ciphertext"], ' . $block_size . ');
                ...
                $encrypt = $init_encrypt . '
                    ...
                    if (strlen($_buffer["xor"])) {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
                            ...
                            $_key = \Solid_Backups\Strauss\phpseclib3\Common\Functions\Strings::shift($_buffer["xor"], ' . $block_size . ');
                            $_ciphertext.= $_block ^ $_key;
                        }
                    } else {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
