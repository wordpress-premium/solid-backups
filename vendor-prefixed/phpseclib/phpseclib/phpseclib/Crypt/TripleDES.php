 ...
 *
 *    $des = new \Solid_Backups\Strauss\phpseclib3\Crypt\TripleDES('ctr');
 *
...
class TripleDES extends DES
{
     ...
     * Key Length (in bytes)
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\TripleDES::setKeyLength()
     * @var int
     */
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\DES::cipher_name_mcrypt
     ...
     *
     * @see self::setKey()
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\DES::setKey()
     * @var string
     */
     ...
     * - cbc3 (same as cbc)
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\DES::__construct()
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey::setIV()
     * @param string $iv
     */
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey::enableContinuousBuffer()
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey::disableContinuousBuffer()
     ...
     *
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey::__construct()
     * @see \Solid_Backups\Strauss\phpseclib3\Crypt\Common\SymmetricKey::setPreferredEngine()
     * @param int $engine
     */
