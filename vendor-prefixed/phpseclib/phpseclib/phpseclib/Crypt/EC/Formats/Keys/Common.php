...
use Solid_Backups\Strauss\phpseclib3\Crypt\EC\BaseCurves\Binary as BinaryCurve;
...
trait Common
{
    ...
    protected static function loadCurveByParam(array $params)
    {
        ...
        if (isset($params['namedCurve'])) {
            $curve = '\Solid_Backups\Strauss\phpseclib3\Crypt\EC\Curves\\' . $params['namedCurve'];
    ...
    private static function encodeParameters(BaseCurve $curve, $returnArray = false, array $options = [])
    {
        ...
        if ($useNamedCurves) {
            ...
            foreach (new \DirectoryIterator(__DIR__ . '/../../Curves/') as $file) {
                ...
                $class = 'Solid_Backups\Strauss\phpseclib3\Crypt\EC\Curves\\' . $testName;
