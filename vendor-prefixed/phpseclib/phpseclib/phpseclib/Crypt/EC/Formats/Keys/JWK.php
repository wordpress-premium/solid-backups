...
namespace Solid_Backups\Strauss\phpseclib3\Crypt\EC\Formats\Keys;

use Solid_Backups\Strauss\phpseclib3\Common\Functions\Strings;
use Solid_Backups\Strauss\phpseclib3\Crypt\Common\Formats\Keys\JWK as Progenitor;
use Solid_Backups\Strauss\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use Solid_Backups\Strauss\phpseclib3\Crypt\EC\Curves\secp256k1;
use Solid_Backups\Strauss\phpseclib3\Crypt\EC\Curves\secp256r1;
use Solid_Backups\Strauss\phpseclib3\Crypt\EC\Curves\secp384r1;
use Solid_Backups\Strauss\phpseclib3\Crypt\EC\Curves\secp521r1;
...
abstract class JWK extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $curve = '\Solid_Backups\Strauss\phpseclib3\Crypt\EC\Curves\\' . str_replace('P-', 'nistp', $key->crv);
        $curve = new $curve();
     ...
     *
     * @param \Solid_Backups\Strauss\phpseclib3\Crypt\EC\BaseCurves\Base $curve
     * @param \Solid_Backups\Strauss\phpseclib3\Math\Common\FiniteField\Integer[] $publicKey
     * @return array
     */
     ...
     *
     * @param \Solid_Backups\Strauss\phpseclib3\Math\BigInteger $privateKey
     * @param \Solid_Backups\Strauss\phpseclib3\Crypt\EC\Curves\Ed25519 $curve
     * @param \Solid_Backups\Strauss\phpseclib3\Math\Common\FiniteField\Integer[] $publicKey
