...
use Solid_Backups\Strauss\phpseclib3\Crypt\EC\BaseCurves\Prime as PrimeCurve;
use Solid_Backups\Strauss\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use Solid_Backups\Strauss\phpseclib3\Exception\BadConfigurationException;
...
abstract class XML
{
     ...
     *
     * @param \DomXPath $xpath
     * @return \Solid_Backups\Strauss\phpseclib3\Crypt\EC\BaseCurves\Base|false
     */
    private static function loadCurveByParam(\DOMXPath $xpath)
    {
        ...
        if ($namedCurve->length == 1) {
            ...
            $curve = '\Solid_Backups\Strauss\phpseclib3\Crypt\EC\Curves\\' . $name;
