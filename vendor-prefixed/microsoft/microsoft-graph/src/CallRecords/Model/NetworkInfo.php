...
* @link      https://graph.microsoft.com
*/
class NetworkInfo extends \Solid_Backups\Strauss\Microsoft\Graph\Model\Entity
{
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The bandwidthLowEventRatio
    */
    public function getBandwidthLowEventRatio()
    {
        if (array_key_exists("bandwidthLowEventRatio", $this->_propDict)) {
            if (is_a($this->_propDict["bandwidthLowEventRatio"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["bandwidthLowEventRatio"];
            } else {
                $this->_propDict["bandwidthLowEventRatio"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["bandwidthLowEventRatio"]);
                return $this->_propDict["bandwidthLowEventRatio"];
            }
        }
        return null;
    ...
    * Fraction of the call that the media endpoint detected the available bandwidth or bandwidth policy was low enough to cause poor quality of the audio sent.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the bandwidthLowEventRatio
    *
    ...
    */
    public function getConnectionType()
    {
        if (array_key_exists("connectionType", $this->_propDict)) {
            if (is_a($this->_propDict["connectionType"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\NetworkConnectionType")) {
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The delayEventRatio
    */
    public function getDelayEventRatio()
    {
        if (array_key_exists("delayEventRatio", $this->_propDict)) {
            if (is_a($this->_propDict["delayEventRatio"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["delayEventRatio"];
            } else {
                $this->_propDict["delayEventRatio"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["delayEventRatio"]);
                return $this->_propDict["delayEventRatio"];
            }
        }
        return null;
    ...
    * Fraction of the call that the media endpoint detected the network delay was significant enough to impact the ability to have real-time two-way communication.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the delayEventRatio
    *
    * @return NetworkInfo The NetworkInfo
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The receivedQualityEventRatio
    */
    public function getReceivedQualityEventRatio()
    {
        if (array_key_exists("receivedQualityEventRatio", $this->_propDict)) {
            if (is_a($this->_propDict["receivedQualityEventRatio"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["receivedQualityEventRatio"];
            } else {
                $this->_propDict["receivedQualityEventRatio"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["receivedQualityEventRatio"]);
                return $this->_propDict["receivedQualityEventRatio"];
            }
        }
        return null;
    ...
    * Fraction of the call that the media endpoint detected the network was causing poor quality of the audio received.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the receivedQualityEventRatio
    *
    * @return NetworkInfo The NetworkInfo
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The sentQualityEventRatio
    */
    public function getSentQualityEventRatio()
    {
        if (array_key_exists("sentQualityEventRatio", $this->_propDict)) {
            if (is_a($this->_propDict["sentQualityEventRatio"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["sentQualityEventRatio"];
            } else {
                $this->_propDict["sentQualityEventRatio"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["sentQualityEventRatio"]);
                return $this->_propDict["sentQualityEventRatio"];
            }
        }
        return null;
    ...
    * Fraction of the call that the media endpoint detected the network was causing poor quality of the audio sent.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the sentQualityEventRatio
    *
    * @return NetworkInfo The NetworkInfo
    */
    ...
    */
    public function getWifiBand()
    {
        if (array_key_exists("wifiBand", $this->_propDict)) {
            if (is_a($this->_propDict["wifiBand"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\WifiBand")) {
    ...
    */
    public function getWifiRadioType()
    {
        if (array_key_exists("wifiRadioType", $this->_propDict)) {
            if (is_a($this->_propDict["wifiRadioType"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\WifiRadioType")) {
