...
class ParticipantEndpoint extends Endpoint
{
    ...
    */
    public function getFeedback()
    {
        if (array_key_exists("feedback", $this->_propDict)) {
            if (is_a($this->_propDict["feedback"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\UserFeedback")) {
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet The identity
    */
    public function getIdentity()
    {
        if (array_key_exists("identity", $this->_propDict)) {
            if (is_a($this->_propDict["identity"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet")) {
                return $this->_propDict["identity"];
            } else {
                $this->_propDict["identity"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet($this->_propDict["identity"]);
                return $this->_propDict["identity"];
            }
        }
        return null;
    ...
    * Identity associated with the endpoint.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet $val The value to assign to the identity
    *
    * @return ParticipantEndpoint The ParticipantEndpoint
    */
