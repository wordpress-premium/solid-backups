...
*/
namespace Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model;
/**
* MediaStream class
*
* @category  Model
...
* @link      https://graph.microsoft.com
*/
class MediaStream extends \Solid_Backups\Strauss\Microsoft\Graph\Model\Entity
{
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The averageAudioDegradation
    */
    public function getAverageAudioDegradation()
    {
        if (array_key_exists("averageAudioDegradation", $this->_propDict)) {
            if (is_a($this->_propDict["averageAudioDegradation"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["averageAudioDegradation"];
            } else {
                $this->_propDict["averageAudioDegradation"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["averageAudioDegradation"]);
                return $this->_propDict["averageAudioDegradation"];
            }
        }
        return null;
    ...
    * Average Network Mean Opinion Score degradation for stream. Represents how much the network loss and jitter has impacted the quality of received audio.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the averageAudioDegradation
    *
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Duration The averageAudioNetworkJitter
    */
    public function getAverageAudioNetworkJitter()
    {
        if (array_key_exists("averageAudioNetworkJitter", $this->_propDict)) {
            if (is_a($this->_propDict["averageAudioNetworkJitter"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Duration")) {
                return $this->_propDict["averageAudioNetworkJitter"];
            } else {
                $this->_propDict["averageAudioNetworkJitter"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Duration($this->_propDict["averageAudioNetworkJitter"]);
                return $this->_propDict["averageAudioNetworkJitter"];
            }
        }
        return null;
    ...
    * Average jitter for the stream computed as specified in [RFC 3550][], denoted in [ISO 8601][] format. For example, 1 second is denoted as 'PT1S', where 'P' is the duration designator, 'T' is the time designator, and 'S' is the second designator.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Duration $val The value to assign to the averageAudioNetworkJitter
    *
    * @return MediaStream The MediaStream
    */
    ...
    * Average jitter for the stream computed as specified in [RFC 3550][], denoted in [ISO 8601][] format. For example, 1 second is denoted as 'PT1S', where 'P' is the duration designator, 'T' is the time designator, and 'S' is the second designator.
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Duration The averageJitter
    */
    public function getAverageJitter()
    {
        if (array_key_exists("averageJitter", $this->_propDict)) {
            if (is_a($this->_propDict["averageJitter"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Duration")) {
                return $this->_propDict["averageJitter"];
            } else {
                $this->_propDict["averageJitter"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Duration($this->_propDict["averageJitter"]);
                return $this->_propDict["averageJitter"];
            }
        }
        return null;
    ...
    * Average jitter for the stream computed as specified in [RFC 3550][], denoted in [ISO 8601][] format. For example, 1 second is denoted as 'PT1S', where 'P' is the duration designator, 'T' is the time designator, and 'S' is the second designator.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Duration $val The value to assign to the averageJitter
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The averagePacketLossRate
    */
    public function getAveragePacketLossRate()
    {
        if (array_key_exists("averagePacketLossRate", $this->_propDict)) {
            if (is_a($this->_propDict["averagePacketLossRate"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["averagePacketLossRate"];
            } else {
                $this->_propDict["averagePacketLossRate"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["averagePacketLossRate"]);
                return $this->_propDict["averagePacketLossRate"];
            }
        }
        return null;
    ...
    * Average packet loss rate for stream.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the averagePacketLossRate
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The averageRatioOfConcealedSamples
    */
    public function getAverageRatioOfConcealedSamples()
    {
        if (array_key_exists("averageRatioOfConcealedSamples", $this->_propDict)) {
            if (is_a($this->_propDict["averageRatioOfConcealedSamples"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["averageRatioOfConcealedSamples"];
            } else {
                $this->_propDict["averageRatioOfConcealedSamples"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["averageRatioOfConcealedSamples"]);
                return $this->_propDict["averageRatioOfConcealedSamples"];
            }
        }
        return null;
    ...
    * Ratio of the number of audio frames with samples generated by packet loss concealment to the total number of audio frames.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the averageRatioOfConcealedSamples
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The averageReceivedFrameRate
    */
    public function getAverageReceivedFrameRate()
    {
        if (array_key_exists("averageReceivedFrameRate", $this->_propDict)) {
            if (is_a($this->_propDict["averageReceivedFrameRate"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["averageReceivedFrameRate"];
            } else {
                $this->_propDict["averageReceivedFrameRate"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["averageReceivedFrameRate"]);
                return $this->_propDict["averageReceivedFrameRate"];
            }
        }
        return null;
    ...
    * Average frames per second received for all video streams computed over the duration of the session.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the averageReceivedFrameRate
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Duration The averageRoundTripTime
    */
    public function getAverageRoundTripTime()
    {
        if (array_key_exists("averageRoundTripTime", $this->_propDict)) {
            if (is_a($this->_propDict["averageRoundTripTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Duration")) {
                return $this->_propDict["averageRoundTripTime"];
            } else {
                $this->_propDict["averageRoundTripTime"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Duration($this->_propDict["averageRoundTripTime"]);
                return $this->_propDict["averageRoundTripTime"];
            }
        }
        return null;
    ...
    * Average network propagation round-trip time computed as specified in [RFC 3550][], denoted in [ISO 8601][] format. For example, 1 second is denoted as 'PT1S', where 'P' is the duration designator, 'T' is the time designator, and 'S' is the second designator.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Duration $val The value to assign to the averageRoundTripTime
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The averageVideoFrameLossPercentage
    */
    public function getAverageVideoFrameLossPercentage()
    {
        if (array_key_exists("averageVideoFrameLossPercentage", $this->_propDict)) {
            if (is_a($this->_propDict["averageVideoFrameLossPercentage"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["averageVideoFrameLossPercentage"];
            } else {
                $this->_propDict["averageVideoFrameLossPercentage"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["averageVideoFrameLossPercentage"]);
                return $this->_propDict["averageVideoFrameLossPercentage"];
            }
        }
        return null;
    ...
    * Average percentage of video frames lost as displayed to the user.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the averageVideoFrameLossPercentage
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The averageVideoFrameRate
    */
    public function getAverageVideoFrameRate()
    {
        if (array_key_exists("averageVideoFrameRate", $this->_propDict)) {
            if (is_a($this->_propDict["averageVideoFrameRate"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["averageVideoFrameRate"];
            } else {
                $this->_propDict["averageVideoFrameRate"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["averageVideoFrameRate"]);
                return $this->_propDict["averageVideoFrameRate"];
            }
        }
        return null;
    ...
    * Average frames per second received for a video stream, computed over the duration of the session.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the averageVideoFrameRate
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The averageVideoPacketLossRate
    */
    public function getAverageVideoPacketLossRate()
    {
        if (array_key_exists("averageVideoPacketLossRate", $this->_propDict)) {
            if (is_a($this->_propDict["averageVideoPacketLossRate"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["averageVideoPacketLossRate"];
            } else {
                $this->_propDict["averageVideoPacketLossRate"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["averageVideoPacketLossRate"]);
                return $this->_propDict["averageVideoPacketLossRate"];
            }
        }
        return null;
    ...
    * Average fraction of packets lost, as specified in [RFC 3550][], computed over the duration of the session.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the averageVideoPacketLossRate
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The lowFrameRateRatio
    */
    public function getLowFrameRateRatio()
    {
        if (array_key_exists("lowFrameRateRatio", $this->_propDict)) {
            if (is_a($this->_propDict["lowFrameRateRatio"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["lowFrameRateRatio"];
            } else {
                $this->_propDict["lowFrameRateRatio"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["lowFrameRateRatio"]);
                return $this->_propDict["lowFrameRateRatio"];
            }
        }
        return null;
    ...
    * Fraction of the call where frame rate is less than 7.5 frames per second.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the lowFrameRateRatio
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The lowVideoProcessingCapabilityRatio
    */
    public function getLowVideoProcessingCapabilityRatio()
    {
        if (array_key_exists("lowVideoProcessingCapabilityRatio", $this->_propDict)) {
            if (is_a($this->_propDict["lowVideoProcessingCapabilityRatio"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["lowVideoProcessingCapabilityRatio"];
            } else {
                $this->_propDict["lowVideoProcessingCapabilityRatio"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["lowVideoProcessingCapabilityRatio"]);
                return $this->_propDict["lowVideoProcessingCapabilityRatio"];
            }
        }
        return null;
    ...
    * Fraction of the call that the client is running less than 70% expected video processing capability.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the lowVideoProcessingCapabilityRatio
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Duration The maxAudioNetworkJitter
    */
    public function getMaxAudioNetworkJitter()
    {
        if (array_key_exists("maxAudioNetworkJitter", $this->_propDict)) {
            if (is_a($this->_propDict["maxAudioNetworkJitter"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Duration")) {
                return $this->_propDict["maxAudioNetworkJitter"];
            } else {
                $this->_propDict["maxAudioNetworkJitter"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Duration($this->_propDict["maxAudioNetworkJitter"]);
                return $this->_propDict["maxAudioNetworkJitter"];
            }
        }
        return null;
    ...
    * Maximum of audio network jitter computed over each of the 20 second windows during the session, denoted in [ISO 8601][] format. For example, 1 second is denoted as 'PT1S', where 'P' is the duration designator, 'T' is the time designator, and 'S' is the second designator.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Duration $val The value to assign to the maxAudioNetworkJitter
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Duration The maxJitter
    */
    public function getMaxJitter()
    {
        if (array_key_exists("maxJitter", $this->_propDict)) {
            if (is_a($this->_propDict["maxJitter"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Duration")) {
                return $this->_propDict["maxJitter"];
            } else {
                $this->_propDict["maxJitter"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Duration($this->_propDict["maxJitter"]);
                return $this->_propDict["maxJitter"];
            }
        }
        return null;
    ...
    * Maximum jitter for the stream computed as specified in RFC 3550, denoted in [ISO 8601][] format. For example, 1 second is denoted as 'PT1S', where 'P' is the duration designator, 'T' is the time designator, and 'S' is the second designator.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Duration $val The value to assign to the maxJitter
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The maxPacketLossRate
    */
    public function getMaxPacketLossRate()
    {
        if (array_key_exists("maxPacketLossRate", $this->_propDict)) {
            if (is_a($this->_propDict["maxPacketLossRate"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["maxPacketLossRate"];
            } else {
                $this->_propDict["maxPacketLossRate"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["maxPacketLossRate"]);
                return $this->_propDict["maxPacketLossRate"];
            }
        }
        return null;
    ...
    * Maximum packet loss rate for the stream.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the maxPacketLossRate
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The maxRatioOfConcealedSamples
    */
    public function getMaxRatioOfConcealedSamples()
    {
        if (array_key_exists("maxRatioOfConcealedSamples", $this->_propDict)) {
            if (is_a($this->_propDict["maxRatioOfConcealedSamples"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["maxRatioOfConcealedSamples"];
            } else {
                $this->_propDict["maxRatioOfConcealedSamples"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["maxRatioOfConcealedSamples"]);
                return $this->_propDict["maxRatioOfConcealedSamples"];
            }
        }
        return null;
    ...
    * Maximum ratio of packets concealed by the healer.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the maxRatioOfConcealedSamples
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Duration The maxRoundTripTime
    */
    public function getMaxRoundTripTime()
    {
        if (array_key_exists("maxRoundTripTime", $this->_propDict)) {
            if (is_a($this->_propDict["maxRoundTripTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Duration")) {
                return $this->_propDict["maxRoundTripTime"];
            } else {
                $this->_propDict["maxRoundTripTime"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Duration($this->_propDict["maxRoundTripTime"]);
                return $this->_propDict["maxRoundTripTime"];
            }
        }
        return null;
    ...
    * Maximum network propagation round-trip time computed as specified in [RFC 3550][], denoted in [ISO 8601][] format. For example, 1 second is denoted as 'PT1S', where 'P' is the duration designator, 'T' is the time designator, and 'S' is the second designator.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Duration $val The value to assign to the maxRoundTripTime
    *
    * @return MediaStream The MediaStream
    */
    ...
    *
    * @return Solid_Backups\Strauss\Microsoft\Graph\Model\Single The postForwardErrorCorrectionPacketLossRate
    */
    public function getPostForwardErrorCorrectionPacketLossRate()
    {
        if (array_key_exists("postForwardErrorCorrectionPacketLossRate", $this->_propDict)) {
            if (is_a($this->_propDict["postForwardErrorCorrectionPacketLossRate"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Single")) {
                return $this->_propDict["postForwardErrorCorrectionPacketLossRate"];
            } else {
                $this->_propDict["postForwardErrorCorrectionPacketLossRate"] = new \Solid_Backups\Strauss\Microsoft\Graph\Model\Single($this->_propDict["postForwardErrorCorrectionPacketLossRate"]);
                return $this->_propDict["postForwardErrorCorrectionPacketLossRate"];
            }
        }
        return null;
    ...
    * Packet loss rate after FEC has been applied aggregated across all video streams and codecs.
    *
    * @param Solid_Backups\Strauss\Microsoft\Graph\Model\Single $val The value to assign to the postForwardErrorCorrectionPacketLossRate
    *
    * @return MediaStream The MediaStream
    */
    ...
    */
    public function getStreamDirection()
    {
        if (array_key_exists("streamDirection", $this->_propDict)) {
            if (is_a($this->_propDict["streamDirection"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\MediaStreamDirection")) {
