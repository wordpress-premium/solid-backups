...
* @link      https://graph.microsoft.com
*/
class Media extends \Solid_Backups\Strauss\Microsoft\Graph\Model\Entity
{
    ...
    */
    public function getCalleeDevice()
    {
        if (array_key_exists("calleeDevice", $this->_propDict)) {
            if (is_a($this->_propDict["calleeDevice"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\DeviceInfo")) {
    ...
    */
    public function getCalleeNetwork()
    {
        if (array_key_exists("calleeNetwork", $this->_propDict)) {
            if (is_a($this->_propDict["calleeNetwork"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\NetworkInfo")) {
    ...
    */
    public function getCallerDevice()
    {
        if (array_key_exists("callerDevice", $this->_propDict)) {
            if (is_a($this->_propDict["callerDevice"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\DeviceInfo")) {
    ...
    */
    public function getCallerNetwork()
    {
        if (array_key_exists("callerNetwork", $this->_propDict)) {
            if (is_a($this->_propDict["callerNetwork"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\NetworkInfo")) {
    ...
    */
    public function getStreams()
    {
        if (array_key_exists("streams", $this->_propDict)) {
            if (is_a($this->_propDict["streams"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\MediaStream")) {
