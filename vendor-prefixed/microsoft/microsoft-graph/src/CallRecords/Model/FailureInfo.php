...
* @link      https://graph.microsoft.com
*/
class FailureInfo extends \Solid_Backups\Strauss\Microsoft\Graph\Model\Entity
{
    /**
    * Gets the reason
    ...
    */
    public function getStage()
    {
        if (array_key_exists("stage", $this->_propDict)) {
            if (is_a($this->_propDict["stage"], "Solid_Backups\Strauss\Microsoft\Graph\CallRecords\Model\FailureStage")) {
