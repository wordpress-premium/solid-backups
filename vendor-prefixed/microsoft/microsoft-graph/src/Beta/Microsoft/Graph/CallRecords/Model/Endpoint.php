...
* @link      https://graph.microsoft.com
*/
class Endpoint extends \Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Entity
{
    ...
    */
    public function getUserAgent()
    {
        if (array_key_exists("userAgent", $this->_propDict)) {
            if (is_a($this->_propDict["userAgent"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\CallRecords\Model\UserAgent")) {
