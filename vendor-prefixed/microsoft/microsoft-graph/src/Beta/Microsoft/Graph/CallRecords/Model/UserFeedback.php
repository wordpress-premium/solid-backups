...
* @link      https://graph.microsoft.com
*/
class UserFeedback extends \Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Entity
{
    ...
    */
    public function getRating()
    {
        if (array_key_exists("rating", $this->_propDict)) {
            if (is_a($this->_propDict["rating"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\CallRecords\Model\UserFeedbackRating")) {
    ...
    */
    public function getTokens()
    {
        if (array_key_exists("tokens", $this->_propDict)) {
            if (is_a($this->_propDict["tokens"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\CallRecords\Model\FeedbackTokenSet")) {
