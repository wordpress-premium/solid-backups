    ...
    */
    public function getPlatform()
    {
        if (array_key_exists("platform", $this->_propDict)) {
            if (is_a($this->_propDict["platform"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\CallRecords\Model\ClientPlatform")) {
    ...
    */
    public function getProductFamily()
    {
        if (array_key_exists("productFamily", $this->_propDict)) {
            if (is_a($this->_propDict["productFamily"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\CallRecords\Model\ProductFamily")) {
