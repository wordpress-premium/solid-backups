    ...
    */
    public function getExportOptions()
    {
        if (array_key_exists("exportOptions", $this->_propDict)) {
            if (is_a($this->_propDict["exportOptions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Ediscovery\Model\ExportOptions")) {
    ...
    */
    public function getExportStructure()
    {
        if (array_key_exists("exportStructure", $this->_propDict)) {
            if (is_a($this->_propDict["exportStructure"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Ediscovery\Model\ExportFileStructure")) {
    ...
    */
    public function getReviewSet()
    {
        if (array_key_exists("reviewSet", $this->_propDict)) {
            if (is_a($this->_propDict["reviewSet"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Ediscovery\Model\ReviewSet")) {
