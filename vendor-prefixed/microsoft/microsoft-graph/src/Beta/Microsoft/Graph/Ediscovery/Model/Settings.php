...
* @link      https://graph.microsoft.com
*/
class Settings extends \Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Entity
{
    /**
    * Gets the ocr
    *
    ...
    */
    public function getOcr()
    {
        if (array_key_exists("ocr", $this->_propDict)) {
            if (is_a($this->_propDict["ocr"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Ediscovery\Model\OcrSettings")) {
    ...
    */
    public function getRedundancyDetection()
    {
        if (array_key_exists("redundancyDetection", $this->_propDict)) {
            if (is_a($this->_propDict["redundancyDetection"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Ediscovery\Model\RedundancyDetectionSettings")) {
    ...
    */
    public function getTopicModeling()
    {
        if (array_key_exists("topicModeling", $this->_propDict)) {
            if (is_a($this->_propDict["topicModeling"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Ediscovery\Model\TopicModelingSettings")) {
