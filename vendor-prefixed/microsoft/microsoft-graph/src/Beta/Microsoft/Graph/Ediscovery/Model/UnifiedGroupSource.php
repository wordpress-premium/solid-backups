...
class UnifiedGroupSource extends DataSource
{
    ...
    */
    public function getIncludedSources()
    {
        if (array_key_exists("includedSources", $this->_propDict)) {
            if (is_a($this->_propDict["includedSources"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Ediscovery\Model\SourceType")) {
    ...
    * Gets the group
    *
    * @return Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Group The group
    */
    public function getGroup()
    {
        if (array_key_exists("group", $this->_propDict)) {
            if (is_a($this->_propDict["group"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Group")) {
                ...
                $this->_propDict["group"] = new \Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Group($this->_propDict["group"]);
                return $this->_propDict["group"];
            }
        }
        return null;
    ...
    * Sets the group
    *
    * @param Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Group $val The group
    *
    * @return UnifiedGroupSource
    */
