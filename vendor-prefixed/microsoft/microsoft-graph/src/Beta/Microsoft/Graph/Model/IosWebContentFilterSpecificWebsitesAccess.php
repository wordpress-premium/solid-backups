    ...
    */
    public function getSpecificWebsitesOnly()
    {
        if (array_key_exists("specificWebsitesOnly", $this->_propDict)) {
            if (is_a($this->_propDict["specificWebsitesOnly"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IosBookmark")) {
    ...
    */
    public function getWebsiteList()
    {
        if (array_key_exists("websiteList", $this->_propDict)) {
            if (is_a($this->_propDict["websiteList"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IosBookmark")) {
