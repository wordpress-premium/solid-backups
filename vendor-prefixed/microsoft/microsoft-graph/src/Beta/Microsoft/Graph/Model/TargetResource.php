    ...
    */
    public function getGroupType()
    {
        if (array_key_exists("groupType", $this->_propDict)) {
            if (is_a($this->_propDict["groupType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\GroupType")) {
    ...
    */
    public function getModifiedProperties()
    {
        if (array_key_exists("modifiedProperties", $this->_propDict)) {
            if (is_a($this->_propDict["modifiedProperties"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ModifiedProperty")) {
