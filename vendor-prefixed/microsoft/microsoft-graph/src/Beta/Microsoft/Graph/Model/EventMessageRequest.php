    ...
    */
    public function getPreviousEndDateTime()
    {
        if (array_key_exists("previousEndDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["previousEndDateTime"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DateTimeTimeZone")) {
    ...
    */
    public function getPreviousLocation()
    {
        if (array_key_exists("previousLocation", $this->_propDict)) {
            if (is_a($this->_propDict["previousLocation"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Location")) {
    ...
    */
    public function getPreviousStartDateTime()
    {
        if (array_key_exists("previousStartDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["previousStartDateTime"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DateTimeTimeZone")) {
