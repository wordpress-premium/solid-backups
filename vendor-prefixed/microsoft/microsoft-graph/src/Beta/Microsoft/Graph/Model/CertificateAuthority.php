...
class CertificateAuthority extends Entity
{
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The certificate
    */
    public function getCertificate()
    {
        if (array_key_exists("certificate", $this->_propDict)) {
            if (is_a($this->_propDict["certificate"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["certificate"];
            } else {
                $this->_propDict["certificate"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["certificate"]);
                return $this->_propDict["certificate"];
            }
        }
        return null;
    ...
    * Required. The base64 encoded string representing the public certificate.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The value to assign to the certificate
    *
