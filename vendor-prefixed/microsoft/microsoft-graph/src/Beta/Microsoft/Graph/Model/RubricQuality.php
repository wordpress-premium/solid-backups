    ...
    */
    public function getCriteria()
    {
        if (array_key_exists("criteria", $this->_propDict)) {
            if (is_a($this->_propDict["criteria"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RubricCriterion")) {
    ...
    */
    public function getWeight()
    {
        if (array_key_exists("weight", $this->_propDict)) {
            if (is_a($this->_propDict["weight"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Single")) {
