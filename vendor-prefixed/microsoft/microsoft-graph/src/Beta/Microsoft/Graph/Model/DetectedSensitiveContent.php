    ...
    */
    public function getClassificationAttributes()
    {
        if (array_key_exists("classificationAttributes", $this->_propDict)) {
            if (is_a($this->_propDict["classificationAttributes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ClassificationAttribute")) {
    ...
    */
    public function getClassificationMethod()
    {
        if (array_key_exists("classificationMethod", $this->_propDict)) {
            if (is_a($this->_propDict["classificationMethod"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ClassificationMethod")) {
    ...
    */
    public function getMatches()
    {
        if (array_key_exists("matches", $this->_propDict)) {
            if (is_a($this->_propDict["matches"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SensitiveContentLocation")) {
    ...
    */
    public function getScope()
    {
        if (array_key_exists("scope", $this->_propDict)) {
            if (is_a($this->_propDict["scope"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SensitiveTypeScope")) {
    ...
    */
    public function getSensitiveTypeSource()
    {
        if (array_key_exists("sensitiveTypeSource", $this->_propDict)) {
            if (is_a($this->_propDict["sensitiveTypeSource"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SensitiveTypeSource")) {
