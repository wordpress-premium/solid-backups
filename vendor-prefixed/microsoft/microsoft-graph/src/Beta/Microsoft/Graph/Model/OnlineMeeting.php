...
class OnlineMeeting extends Entity
{
    ...
    */
    public function getAccessLevel()
    {
        if (array_key_exists("accessLevel", $this->_propDict)) {
            if (is_a($this->_propDict["accessLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessLevel")) {
    ...
    */
    public function getAllowedPresenters()
    {
        if (array_key_exists("allowedPresenters", $this->_propDict)) {
            if (is_a($this->_propDict["allowedPresenters"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\OnlineMeetingPresenters")) {
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The alternativeRecording
    */
    public function getAlternativeRecording()
    {
        if (array_key_exists("alternativeRecording", $this->_propDict)) {
            if (is_a($this->_propDict["alternativeRecording"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["alternativeRecording"];
            } else {
                $this->_propDict["alternativeRecording"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["alternativeRecording"]);
                return $this->_propDict["alternativeRecording"];
            }
        }
        return null;
    ...
    * The content stream of the alternative recording of a live event. Read-only.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The alternativeRecording
    *
    * @return OnlineMeeting
    */
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The attendeeReport
    */
    public function getAttendeeReport()
    {
        if (array_key_exists("attendeeReport", $this->_propDict)) {
            if (is_a($this->_propDict["attendeeReport"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["attendeeReport"];
            } else {
                $this->_propDict["attendeeReport"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["attendeeReport"]);
                return $this->_propDict["attendeeReport"];
            }
        }
        return null;
    ...
    * The content stream of the attendee report of a live event. Read-only.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The attendeeReport
    *
    * @return OnlineMeeting
    */
    ...
    */
    public function getAudioConferencing()
    {
        if (array_key_exists("audioConferencing", $this->_propDict)) {
            if (is_a($this->_propDict["audioConferencing"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AudioConferencing")) {
    ...
    */
    public function getBroadcastSettings()
    {
        if (array_key_exists("broadcastSettings", $this->_propDict)) {
            if (is_a($this->_propDict["broadcastSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\BroadcastMeetingSettings")) {
    ...
    */
    public function getChatInfo()
    {
        if (array_key_exists("chatInfo", $this->_propDict)) {
            if (is_a($this->_propDict["chatInfo"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ChatInfo")) {
    ...
    */
    public function getJoinInformation()
    {
        if (array_key_exists("joinInformation", $this->_propDict)) {
            if (is_a($this->_propDict["joinInformation"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ItemBody")) {
    ...
    */
    public function getLobbyBypassSettings()
    {
        if (array_key_exists("lobbyBypassSettings", $this->_propDict)) {
            if (is_a($this->_propDict["lobbyBypassSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\LobbyBypassSettings")) {
    ...
    */
    public function getParticipants()
    {
        if (array_key_exists("participants", $this->_propDict)) {
            if (is_a($this->_propDict["participants"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MeetingParticipants")) {
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The recording
    */
    public function getRecording()
    {
        if (array_key_exists("recording", $this->_propDict)) {
            if (is_a($this->_propDict["recording"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["recording"];
            } else {
                $this->_propDict["recording"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["recording"]);
                return $this->_propDict["recording"];
            }
        }
        return null;
    ...
    * The content stream of the recording of a live event. Read-only.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The recording
    *
    * @return OnlineMeeting
    */
