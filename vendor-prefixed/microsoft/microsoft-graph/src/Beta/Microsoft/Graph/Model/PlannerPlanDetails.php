    ...
    */
    public function getCategoryDescriptions()
    {
        if (array_key_exists("categoryDescriptions", $this->_propDict)) {
            if (is_a($this->_propDict["categoryDescriptions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PlannerCategoryDescriptions")) {
    ...
    */
    public function getContextDetails()
    {
        if (array_key_exists("contextDetails", $this->_propDict)) {
            if (is_a($this->_propDict["contextDetails"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PlannerPlanContextDetailsCollection")) {
    ...
    */
    public function getSharedWith()
    {
        if (array_key_exists("sharedWith", $this->_propDict)) {
            if (is_a($this->_propDict["sharedWith"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PlannerUserIds")) {
