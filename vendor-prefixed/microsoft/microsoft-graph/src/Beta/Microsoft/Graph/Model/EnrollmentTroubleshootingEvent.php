    ...
    */
    public function getEnrollmentType()
    {
        if (array_key_exists("enrollmentType", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceEnrollmentType")) {
    ...
    */
    public function getFailureCategory()
    {
        if (array_key_exists("failureCategory", $this->_propDict)) {
            if (is_a($this->_propDict["failureCategory"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceEnrollmentFailureReason")) {
