    ...
    */
    public function getAlertType()
    {
        if (array_key_exists("alertType", $this->_propDict)) {
            if (is_a($this->_propDict["alertType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IosNotificationAlertType")) {
    ...
    */
    public function getPreviewVisibility()
    {
        if (array_key_exists("previewVisibility", $this->_propDict)) {
            if (is_a($this->_propDict["previewVisibility"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IosNotificationPreviewVisibility")) {
