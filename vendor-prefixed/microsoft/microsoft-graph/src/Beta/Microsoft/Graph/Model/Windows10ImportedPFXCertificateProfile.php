...
* 
* Windows10ImportedPFXCertificateProfile File
* PHP version 7
*
* @category  Library
...
/**
* Windows10ImportedPFXCertificateProfile class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class Windows10ImportedPFXCertificateProfile extends WindowsCertificateProfileBase
{
    /**
    ...
    */
    public function getIntendedPurpose()
    {
        if (array_key_exists("intendedPurpose", $this->_propDict)) {
            if (is_a($this->_propDict["intendedPurpose"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IntendedPurpose")) {
