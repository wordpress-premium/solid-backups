    ...
    */
    public function getSettings()
    {
        if (array_key_exists("settings", $this->_propDict)) {
            if (is_a($this->_propDict["settings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PrintSettings")) {
    ...
    */
    public function getReports()
    {
        if (array_key_exists("reports", $this->_propDict)) {
            if (is_a($this->_propDict["reports"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ReportRoot")) {
