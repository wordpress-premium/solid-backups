...
class OfficeSuiteApp extends MobileApp
{
    ...
    */
    public function getExcludedApps()
    {
        if (array_key_exists("excludedApps", $this->_propDict)) {
            if (is_a($this->_propDict["excludedApps"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ExcludedApps")) {
    ...
    */
    public function getInstallProgressDisplayLevel()
    {
        if (array_key_exists("installProgressDisplayLevel", $this->_propDict)) {
            if (is_a($this->_propDict["installProgressDisplayLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\OfficeSuiteInstallProgressDisplayLevel")) {
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The officeConfigurationXml
    */
    public function getOfficeConfigurationXml()
    {
        if (array_key_exists("officeConfigurationXml", $this->_propDict)) {
            if (is_a($this->_propDict["officeConfigurationXml"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["officeConfigurationXml"];
            } else {
                $this->_propDict["officeConfigurationXml"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["officeConfigurationXml"]);
                return $this->_propDict["officeConfigurationXml"];
            }
        }
        return null;
    ...
    * The property to represent the XML configuration file that can be specified for Office ProPlus Apps. Takes precedence over all other properties. When present, the XML configuration file will be used to create the app.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The officeConfigurationXml
    *
    * @return OfficeSuiteApp
    */
    ...
    */
    public function getOfficePlatformArchitecture()
    {
        if (array_key_exists("officePlatformArchitecture", $this->_propDict)) {
            if (is_a($this->_propDict["officePlatformArchitecture"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsArchitecture")) {
    ...
    */
    public function getUpdateChannel()
    {
        if (array_key_exists("updateChannel", $this->_propDict)) {
            if (is_a($this->_propDict["updateChannel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\OfficeUpdateChannel")) {
