    ...
    */
    public function getFeedback()
    {
        if (array_key_exists("feedback", $this->_propDict)) {
            if (is_a($this->_propDict["feedback"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\EducationFeedback")) {
    ...
    */
    public function getPublishedFeedback()
    {
        if (array_key_exists("publishedFeedback", $this->_propDict)) {
            if (is_a($this->_propDict["publishedFeedback"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\EducationFeedback")) {
