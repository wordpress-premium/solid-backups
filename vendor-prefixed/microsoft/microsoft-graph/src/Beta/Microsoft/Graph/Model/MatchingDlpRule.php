    ...
    */
    public function getActions()
    {
        if (array_key_exists("actions", $this->_propDict)) {
            if (is_a($this->_propDict["actions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DlpActionInfo")) {
    ...
    */
    public function getRuleMode()
    {
        if (array_key_exists("ruleMode", $this->_propDict)) {
            if (is_a($this->_propDict["ruleMode"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RuleMode")) {
