    ...
    */
    public function getAttendee()
    {
        if (array_key_exists("attendee", $this->_propDict)) {
            if (is_a($this->_propDict["attendee"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AttendeeBase")) {
    ...
    */
    public function getAvailability()
    {
        if (array_key_exists("availability", $this->_propDict)) {
            if (is_a($this->_propDict["availability"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\FreeBusyStatus")) {
