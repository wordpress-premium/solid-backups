    ...
    */
    public function getSetupStatus()
    {
        if (array_key_exists("setupStatus", $this->_propDict)) {
            if (is_a($this->_propDict["setupStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SetupStatus")) {
    ...
    */
    public function getDefaultRolesSettings()
    {
        if (array_key_exists("defaultRolesSettings", $this->_propDict)) {
            if (is_a($this->_propDict["defaultRolesSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PrivilegedRoleSettings")) {
