...
class WindowsInformationProtectionAppLockerFile extends Entity
{
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The file
    */
    public function getFile()
    {
        if (array_key_exists("file", $this->_propDict)) {
            if (is_a($this->_propDict["file"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["file"];
            } else {
                $this->_propDict["file"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["file"]);
                return $this->_propDict["file"];
            }
        }
        return null;
    ...
    * File as a byte array
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The file
    *
    * @return WindowsInformationProtectionAppLockerFile
    */
