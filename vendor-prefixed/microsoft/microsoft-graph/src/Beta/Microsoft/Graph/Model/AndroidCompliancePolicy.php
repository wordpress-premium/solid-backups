...
class AndroidCompliancePolicy extends DeviceCompliancePolicy
{
    ...
    */
    public function getAdvancedThreatProtectionRequiredSecurityLevel()
    {
        if (array_key_exists("advancedThreatProtectionRequiredSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["advancedThreatProtectionRequiredSecurityLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceThreatProtectionLevel")) {
    ...
    */
    ...
    /**
    * Gets the conditionStatementId
    * Condition statement id.
    *
    * @return string The conditionStatementId
    */
    public function getConditionStatementId()
    {
        if (array_key_exists("conditionStatementId", $this->_propDict)) {
            return $this->_propDict["conditionStatementId"];
        } else {
            return null;
        }
    }
    ...
    /**
    * Sets the conditionStatementId
    * Condition statement id.
    *
    * @param string $val The conditionStatementId
    *
    * @return AndroidCompliancePolicy
    */
    ...
    */
    public function getDeviceThreatProtectionRequiredSecurityLevel()
    {
        if (array_key_exists("deviceThreatProtectionRequiredSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["deviceThreatProtectionRequiredSecurityLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceThreatProtectionLevel")) {
    ...
    */
    public function getPasswordRequiredType()
    {
        if (array_key_exists("passwordRequiredType", $this->_propDict)) {
            if (is_a($this->_propDict["passwordRequiredType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidRequiredPasswordType")) {
    ...
    */
    public function getRequiredPasswordComplexity()
    {
        if (array_key_exists("requiredPasswordComplexity", $this->_propDict)) {
            if (is_a($this->_propDict["requiredPasswordComplexity"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidRequiredPasswordComplexity")) {
    ...
    */
    ...
    /**
    * Gets the securityBlockDeviceAdministratorManagedDevices
    * Block device administrator managed devices.
    *
    * @return bool The securityBlockDeviceAdministratorManagedDevices
    */
    public function getSecurityBlockDeviceAdministratorManagedDevices()
    {
        if (array_key_exists("securityBlockDeviceAdministratorManagedDevices", $this->_propDict)) {
            return $this->_propDict["securityBlockDeviceAdministratorManagedDevices"];
        } else {
            return null;
        }
    }
    ...
    /**
    * Sets the securityBlockDeviceAdministratorManagedDevices
    * Block device administrator managed devices.
    *
    * @param bool $val The securityBlockDeviceAdministratorManagedDevices
    *
    * @return AndroidCompliancePolicy
    */
    public function setSecurityBlockDeviceAdministratorManagedDevices($val)
    {
        $this->_propDict["securityBlockDeviceAdministratorManagedDevices"] = boolval($val);
        return $this;
    }
