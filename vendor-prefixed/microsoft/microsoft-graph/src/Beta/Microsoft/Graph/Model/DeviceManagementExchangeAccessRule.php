    ...
    */
    public function getAccessLevel()
    {
        if (array_key_exists("accessLevel", $this->_propDict)) {
            if (is_a($this->_propDict["accessLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementExchangeAccessLevel")) {
    ...
    */
    public function getDeviceClass()
    {
        if (array_key_exists("deviceClass", $this->_propDict)) {
            if (is_a($this->_propDict["deviceClass"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementExchangeDeviceClass")) {
