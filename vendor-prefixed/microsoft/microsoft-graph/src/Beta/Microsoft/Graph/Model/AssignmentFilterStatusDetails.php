    ...
    */
    public function getDeviceProperties()
    {
        if (array_key_exists("deviceProperties", $this->_propDict)) {
            if (is_a($this->_propDict["deviceProperties"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\KeyValuePair")) {
    ...
    */
    public function getEvalutionSummaries()
    {
        if (array_key_exists("evalutionSummaries", $this->_propDict)) {
            if (is_a($this->_propDict["evalutionSummaries"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AssignmentFilterEvaluationSummary")) {
