    ...
    */
    public function getDirectory()
    {
        if (array_key_exists("directory", $this->_propDict)) {
            if (is_a($this->_propDict["directory"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RbacApplication")) {
    ...
    */
    public function getEntitlementManagement()
    {
        if (array_key_exists("entitlementManagement", $this->_propDict)) {
            if (is_a($this->_propDict["entitlementManagement"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RbacApplication")) {
    ...
    */
    public function getDeviceManagement()
    {
        if (array_key_exists("deviceManagement", $this->_propDict)) {
            if (is_a($this->_propDict["deviceManagement"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RbacApplicationMultiple")) {
