    ...
    */
    public function getApiExpressions()
    {
        if (array_key_exists("apiExpressions", $this->_propDict)) {
            if (is_a($this->_propDict["apiExpressions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\StringKeyStringValuePair")) {
    ...
    */
    public function getMetadata()
    {
        if (array_key_exists("metadata", $this->_propDict)) {
            if (is_a($this->_propDict["metadata"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MetadataEntry")) {
    ...
    */
    public function getMutability()
    {
        if (array_key_exists("mutability", $this->_propDict)) {
            if (is_a($this->_propDict["mutability"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Mutability")) {
    ...
    */
    public function getReferencedObjects()
    {
        if (array_key_exists("referencedObjects", $this->_propDict)) {
            if (is_a($this->_propDict["referencedObjects"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ReferencedObject")) {
    ...
    */
    public function getType()
    {
        if (array_key_exists("type", $this->_propDict)) {
            if (is_a($this->_propDict["type"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AttributeType")) {
