    ...
    */
    public function getDecisionMakerCriteria()
    {
        if (array_key_exists("decisionMakerCriteria", $this->_propDict)) {
            if (is_a($this->_propDict["decisionMakerCriteria"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\GovernanceCriteria")) {
    ...
    */
    public function getNotificationPolicy()
    {
        if (array_key_exists("notificationPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["notificationPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\GovernanceNotificationPolicy")) {
