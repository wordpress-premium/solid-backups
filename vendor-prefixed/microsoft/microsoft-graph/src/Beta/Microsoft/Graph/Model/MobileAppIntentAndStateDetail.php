    ...
    */
    public function getMobileAppIntent()
    {
        if (array_key_exists("mobileAppIntent", $this->_propDict)) {
            if (is_a($this->_propDict["mobileAppIntent"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MobileAppIntent")) {
    ...
    */
    public function getSupportedDeviceTypes()
    {
        if (array_key_exists("supportedDeviceTypes", $this->_propDict)) {
            if (is_a($this->_propDict["supportedDeviceTypes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MobileAppSupportedDeviceType")) {
