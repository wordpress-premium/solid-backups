    ...
    */
    public function getMovieRating()
    {
        if (array_key_exists("movieRating", $this->_propDict)) {
            if (is_a($this->_propDict["movieRating"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RatingNewZealandMoviesType")) {
    ...
    */
    public function getTvRating()
    {
        if (array_key_exists("tvRating", $this->_propDict)) {
            if (is_a($this->_propDict["tvRating"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RatingNewZealandTelevisionType")) {
