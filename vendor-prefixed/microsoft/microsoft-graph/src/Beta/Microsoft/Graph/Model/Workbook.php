    ...
    */
    public function getApplication()
    {
        if (array_key_exists("application", $this->_propDict)) {
            if (is_a($this->_propDict["application"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WorkbookApplication")) {
    ...
    */
    public function getFunctions()
    {
        if (array_key_exists("functions", $this->_propDict)) {
            if (is_a($this->_propDict["functions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WorkbookFunctions")) {
