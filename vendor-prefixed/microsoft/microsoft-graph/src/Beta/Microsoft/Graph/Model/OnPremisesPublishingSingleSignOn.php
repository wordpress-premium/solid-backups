    ...
    */
    public function getKerberosSignOnSettings()
    {
        if (array_key_exists("kerberosSignOnSettings", $this->_propDict)) {
            if (is_a($this->_propDict["kerberosSignOnSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\KerberosSignOnSettings")) {
    ...
    */
    public function getSingleSignOnMode()
    {
        if (array_key_exists("singleSignOnMode", $this->_propDict)) {
            if (is_a($this->_propDict["singleSignOnMode"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SingleSignOnMode")) {
