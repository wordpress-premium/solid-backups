    ...
    */
    public function getEnd()
    {
        if (array_key_exists("end", $this->_propDict)) {
            if (is_a($this->_propDict["end"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOfDay")) {
    ...
    */
    public function getStart()
    {
        if (array_key_exists("start", $this->_propDict)) {
            if (is_a($this->_propDict["start"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOfDay")) {
