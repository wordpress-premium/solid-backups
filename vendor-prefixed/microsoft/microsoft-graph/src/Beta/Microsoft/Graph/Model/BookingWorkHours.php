    ...
    */
    public function getDay()
    {
        if (array_key_exists("day", $this->_propDict)) {
            if (is_a($this->_propDict["day"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DayOfWeek")) {
    ...
    */
    public function getTimeSlots()
    {
        if (array_key_exists("timeSlots", $this->_propDict)) {
            if (is_a($this->_propDict["timeSlots"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\BookingWorkTimeSlot")) {
