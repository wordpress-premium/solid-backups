    ...
    */
    public function getDeviceStateSummary()
    {
        if (array_key_exists("deviceStateSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deviceStateSummary"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementIntentDeviceStateSummary")) {
    ...
    */
    public function getUserStateSummary()
    {
        if (array_key_exists("userStateSummary", $this->_propDict)) {
            if (is_a($this->_propDict["userStateSummary"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementIntentUserStateSummary")) {
