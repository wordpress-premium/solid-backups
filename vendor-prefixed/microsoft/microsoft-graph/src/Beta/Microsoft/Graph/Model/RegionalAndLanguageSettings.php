    ...
    */
    public function getDefaultDisplayLanguage()
    {
        if (array_key_exists("defaultDisplayLanguage", $this->_propDict)) {
            if (is_a($this->_propDict["defaultDisplayLanguage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\LocaleInfo")) {
    ...
    */
    public function getDefaultRegionalFormat()
    {
        if (array_key_exists("defaultRegionalFormat", $this->_propDict)) {
            if (is_a($this->_propDict["defaultRegionalFormat"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\LocaleInfo")) {
    ...
    */
    public function getDefaultSpeechInputLanguage()
    {
        if (array_key_exists("defaultSpeechInputLanguage", $this->_propDict)) {
            if (is_a($this->_propDict["defaultSpeechInputLanguage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\LocaleInfo")) {
    ...
    */
    public function getDefaultTranslationLanguage()
    {
        if (array_key_exists("defaultTranslationLanguage", $this->_propDict)) {
            if (is_a($this->_propDict["defaultTranslationLanguage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\LocaleInfo")) {
    ...
    */
    public function getRegionalFormatOverrides()
    {
        if (array_key_exists("regionalFormatOverrides", $this->_propDict)) {
            if (is_a($this->_propDict["regionalFormatOverrides"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RegionalFormatOverrides")) {
    ...
    */
    public function getTranslationPreferences()
    {
        if (array_key_exists("translationPreferences", $this->_propDict)) {
            if (is_a($this->_propDict["translationPreferences"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TranslationPreferences")) {
