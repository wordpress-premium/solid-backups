    ...
    */
    public function getConnectorGroupType()
    {
        if (array_key_exists("connectorGroupType", $this->_propDict)) {
            if (is_a($this->_propDict["connectorGroupType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConnectorGroupType")) {
    ...
    */
    public function getRegion()
    {
        if (array_key_exists("region", $this->_propDict)) {
            if (is_a($this->_propDict["region"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConnectorGroupRegion")) {
