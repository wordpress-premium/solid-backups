    ...
    */
    public function getFill()
    {
        if (array_key_exists("fill", $this->_propDict)) {
            if (is_a($this->_propDict["fill"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WorkbookRangeFill")) {
    ...
    */
    public function getFont()
    {
        if (array_key_exists("font", $this->_propDict)) {
            if (is_a($this->_propDict["font"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WorkbookRangeFont")) {
    ...
    */
    public function getProtection()
    {
        if (array_key_exists("protection", $this->_propDict)) {
            if (is_a($this->_propDict["protection"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WorkbookFormatProtection")) {
