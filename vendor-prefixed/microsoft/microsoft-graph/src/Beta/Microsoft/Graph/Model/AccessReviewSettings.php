    ...
    */
    public function getAutoReviewSettings()
    {
        if (array_key_exists("autoReviewSettings", $this->_propDict)) {
            if (is_a($this->_propDict["autoReviewSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AutoReviewSettings")) {
    ...
    */
    public function getRecurrenceSettings()
    {
        if (array_key_exists("recurrenceSettings", $this->_propDict)) {
            if (is_a($this->_propDict["recurrenceSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessReviewRecurrenceSettings")) {
