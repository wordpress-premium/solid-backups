    ...
    */
    public function getRestrictionAction()
    {
        if (array_key_exists("restrictionAction", $this->_propDict)) {
            if (is_a($this->_propDict["restrictionAction"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RestrictionAction")) {
    ...
    */
    public function getTriggers()
    {
        if (array_key_exists("triggers", $this->_propDict)) {
            if (is_a($this->_propDict["triggers"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RestrictionTrigger")) {
