    ...
    */
    public function getLinks()
    {
        if (array_key_exists("links", $this->_propDict)) {
            if (is_a($this->_propDict["links"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SectionLinks")) {
    ...
    */
    public function getParentSectionGroup()
    {
        if (array_key_exists("parentSectionGroup", $this->_propDict)) {
            if (is_a($this->_propDict["parentSectionGroup"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SectionGroup")) {
