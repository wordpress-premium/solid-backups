...
* 
* AdvancedThreatProtectionOnboardingDeviceSettingState File
* PHP version 7
*
* @category  Library
    ...
    */
    public function getPlatformType()
    {
        if (array_key_exists("platformType", $this->_propDict)) {
            if (is_a($this->_propDict["platformType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceType")) {
    ...
    */
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ComplianceStatus")) {
