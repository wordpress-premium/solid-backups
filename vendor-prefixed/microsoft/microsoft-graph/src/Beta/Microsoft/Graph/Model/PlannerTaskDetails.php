    ...
    */
    public function getChecklist()
    {
        if (array_key_exists("checklist", $this->_propDict)) {
            if (is_a($this->_propDict["checklist"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PlannerChecklistItems")) {
    ...
    */
    public function getReferences()
    {
        if (array_key_exists("references", $this->_propDict)) {
            if (is_a($this->_propDict["references"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PlannerExternalReferences")) {
