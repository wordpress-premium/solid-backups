    ...
    */
    public function getOperand()
    {
        if (array_key_exists("operand", $this->_propDict)) {
            if (is_a($this->_propDict["operand"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ManagementConditionExpressionModel")) {
    ...
    */
    public function getOperator()
    {
        if (array_key_exists("operator", $this->_propDict)) {
            if (is_a($this->_propDict["operator"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UnaryManagementConditionExpressionOperatorType")) {
