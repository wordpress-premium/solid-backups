    ...
    */
    public function getDraftOpenShift()
    {
        if (array_key_exists("draftOpenShift", $this->_propDict)) {
            if (is_a($this->_propDict["draftOpenShift"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\OpenShiftItem")) {
    ...
    */
    public function getSharedOpenShift()
    {
        if (array_key_exists("sharedOpenShift", $this->_propDict)) {
            if (is_a($this->_propDict["sharedOpenShift"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\OpenShiftItem")) {
