    ...
    */
    public function getFavoritePlanReferences()
    {
        if (array_key_exists("favoritePlanReferences", $this->_propDict)) {
            if (is_a($this->_propDict["favoritePlanReferences"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PlannerFavoritePlanReferenceCollection")) {
    ...
    */
    public function getRecentPlanReferences()
    {
        if (array_key_exists("recentPlanReferences", $this->_propDict)) {
            if (is_a($this->_propDict["recentPlanReferences"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PlannerRecentPlanReferenceCollection")) {
