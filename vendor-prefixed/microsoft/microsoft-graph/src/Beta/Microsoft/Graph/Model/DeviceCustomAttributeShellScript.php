...
class DeviceCustomAttributeShellScript extends Entity
{
    ...
    */
    public function getCustomAttributeType()
    {
        if (array_key_exists("customAttributeType", $this->_propDict)) {
            if (is_a($this->_propDict["customAttributeType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceCustomAttributeValueType")) {
    ...
    * The script content.
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The scriptContent
    */
    public function getScriptContent()
    {
        if (array_key_exists("scriptContent", $this->_propDict)) {
            if (is_a($this->_propDict["scriptContent"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["scriptContent"];
            } else {
                $this->_propDict["scriptContent"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["scriptContent"]);
                return $this->_propDict["scriptContent"];
            }
        }
        return null;
    ...
    * The script content.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The scriptContent
    *
    * @return DeviceCustomAttributeShellScript
    */
    ...
    */
    public function getRunSummary()
    {
        if (array_key_exists("runSummary", $this->_propDict)) {
            if (is_a($this->_propDict["runSummary"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementScriptRunSummary")) {
