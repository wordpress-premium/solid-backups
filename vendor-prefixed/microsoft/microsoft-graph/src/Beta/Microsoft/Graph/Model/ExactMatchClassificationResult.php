    ...
    */
    public function getClassification()
    {
        if (array_key_exists("classification", $this->_propDict)) {
            if (is_a($this->_propDict["classification"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ExactMatchDetectedSensitiveContent")) {
    ...
    */
    public function getErrors()
    {
        if (array_key_exists("errors", $this->_propDict)) {
            if (is_a($this->_propDict["errors"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ClassificationError")) {
