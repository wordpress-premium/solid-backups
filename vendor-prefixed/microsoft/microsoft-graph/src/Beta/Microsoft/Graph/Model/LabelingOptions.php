    ...
    */
    public function getAssignmentMethod()
    {
        if (array_key_exists("assignmentMethod", $this->_propDict)) {
            if (is_a($this->_propDict["assignmentMethod"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AssignmentMethod")) {
    ...
    */
    public function getDowngradeJustification()
    {
        if (array_key_exists("downgradeJustification", $this->_propDict)) {
            if (is_a($this->_propDict["downgradeJustification"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DowngradeJustification")) {
    ...
    */
    public function getExtendedProperties()
    {
        if (array_key_exists("extendedProperties", $this->_propDict)) {
            if (is_a($this->_propDict["extendedProperties"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\KeyValuePair")) {
