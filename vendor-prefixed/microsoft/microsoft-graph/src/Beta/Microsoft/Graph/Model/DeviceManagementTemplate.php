    ...
    */
    public function getPlatformType()
    {
        if (array_key_exists("platformType", $this->_propDict)) {
            if (is_a($this->_propDict["platformType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PolicyPlatformType")) {
    ...
    */
    public function getTemplateSubtype()
    {
        if (array_key_exists("templateSubtype", $this->_propDict)) {
            if (is_a($this->_propDict["templateSubtype"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementTemplateSubtype")) {
    ...
    */
    public function getTemplateType()
    {
        if (array_key_exists("templateType", $this->_propDict)) {
            if (is_a($this->_propDict["templateType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementTemplateType")) {
