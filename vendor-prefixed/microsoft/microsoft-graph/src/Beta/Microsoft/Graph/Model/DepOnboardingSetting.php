    ...
    */
    public function getTokenType()
    {
        if (array_key_exists("tokenType", $this->_propDict)) {
            if (is_a($this->_propDict["tokenType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DepTokenType")) {
    ...
    */
    public function getDefaultIosEnrollmentProfile()
    {
        if (array_key_exists("defaultIosEnrollmentProfile", $this->_propDict)) {
            if (is_a($this->_propDict["defaultIosEnrollmentProfile"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DepIOSEnrollmentProfile")) {
    ...
    */
    public function getDefaultMacOsEnrollmentProfile()
    {
        if (array_key_exists("defaultMacOsEnrollmentProfile", $this->_propDict)) {
            if (is_a($this->_propDict["defaultMacOsEnrollmentProfile"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DepMacOSEnrollmentProfile")) {
