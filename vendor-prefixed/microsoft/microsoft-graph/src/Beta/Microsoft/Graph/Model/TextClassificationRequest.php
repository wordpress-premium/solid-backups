    ...
    */
    public function getMatchTolerancesToInclude()
    {
        if (array_key_exists("matchTolerancesToInclude", $this->_propDict)) {
            if (is_a($this->_propDict["matchTolerancesToInclude"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MlClassificationMatchTolerance")) {
    ...
    */
    public function getScopesToRun()
    {
        if (array_key_exists("scopesToRun", $this->_propDict)) {
            if (is_a($this->_propDict["scopesToRun"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SensitiveTypeScope")) {
