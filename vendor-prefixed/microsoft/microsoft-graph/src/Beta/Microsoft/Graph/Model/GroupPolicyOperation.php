    ...
    */
    public function getOperationStatus()
    {
        if (array_key_exists("operationStatus", $this->_propDict)) {
            if (is_a($this->_propDict["operationStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\GroupPolicyOperationStatus")) {
    ...
    */
    public function getOperationType()
    {
        if (array_key_exists("operationType", $this->_propDict)) {
            if (is_a($this->_propDict["operationType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\GroupPolicyOperationType")) {
