    ...
    */
    public function getPostAttributeCollection()
    {
        if (array_key_exists("postAttributeCollection", $this->_propDict)) {
            if (is_a($this->_propDict["postAttributeCollection"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentityApiConnector")) {
    ...
    */
    public function getPostFederationSignup()
    {
        if (array_key_exists("postFederationSignup", $this->_propDict)) {
            if (is_a($this->_propDict["postFederationSignup"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentityApiConnector")) {
