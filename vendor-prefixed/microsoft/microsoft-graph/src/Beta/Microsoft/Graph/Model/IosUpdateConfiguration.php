    ...
    */
    public function getActiveHoursEnd()
    {
        if (array_key_exists("activeHoursEnd", $this->_propDict)) {
            if (is_a($this->_propDict["activeHoursEnd"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOfDay")) {
    ...
    */
    public function getActiveHoursStart()
    {
        if (array_key_exists("activeHoursStart", $this->_propDict)) {
            if (is_a($this->_propDict["activeHoursStart"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOfDay")) {
    ...
    */
    public function getUpdateScheduleType()
    {
        if (array_key_exists("updateScheduleType", $this->_propDict)) {
            if (is_a($this->_propDict["updateScheduleType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IosSoftwareUpdateScheduleType")) {
