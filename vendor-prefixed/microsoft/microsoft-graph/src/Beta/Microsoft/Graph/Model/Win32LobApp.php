    ...
    */
    public function getApplicableArchitectures()
    {
        if (array_key_exists("applicableArchitectures", $this->_propDict)) {
            if (is_a($this->_propDict["applicableArchitectures"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsArchitecture")) {
    ...
    */
    public function getInstallExperience()
    {
        if (array_key_exists("installExperience", $this->_propDict)) {
            if (is_a($this->_propDict["installExperience"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Win32LobAppInstallExperience")) {
    ...
    */
    public function getMinimumSupportedOperatingSystem()
    {
        if (array_key_exists("minimumSupportedOperatingSystem", $this->_propDict)) {
            if (is_a($this->_propDict["minimumSupportedOperatingSystem"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsMinimumOperatingSystem")) {
    ...
    */
    public function getMsiInformation()
    {
        if (array_key_exists("msiInformation", $this->_propDict)) {
            if (is_a($this->_propDict["msiInformation"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Win32LobAppMsiInformation")) {
