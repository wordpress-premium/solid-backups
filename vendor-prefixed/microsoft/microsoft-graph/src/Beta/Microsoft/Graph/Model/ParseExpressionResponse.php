    ...
    */
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PublicError")) {
    ...
    */
    public function getParsedExpression()
    {
        if (array_key_exists("parsedExpression", $this->_propDict)) {
            if (is_a($this->_propDict["parsedExpression"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AttributeMappingSource")) {
