    ...
    */
    public function getDetail()
    {
        if (array_key_exists("detail", $this->_propDict)) {
            if (is_a($this->_propDict["detail"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PositionDetail")) {
    ...
    */
    public function getManager()
    {
        if (array_key_exists("manager", $this->_propDict)) {
            if (is_a($this->_propDict["manager"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RelatedPerson")) {
