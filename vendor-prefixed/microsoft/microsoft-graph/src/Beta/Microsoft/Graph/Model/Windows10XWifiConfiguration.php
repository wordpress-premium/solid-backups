...
* 
* Windows10XWifiConfiguration File
* PHP version 7
*
* @category  Library
...
/**
* Windows10XWifiConfiguration class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class Windows10XWifiConfiguration extends DeviceManagementResourceAccessProfileBase
{
    /**
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The customXml
    */
    public function getCustomXml()
    {
        if (array_key_exists("customXml", $this->_propDict)) {
            if (is_a($this->_propDict["customXml"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["customXml"];
            } else {
                $this->_propDict["customXml"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["customXml"]);
                return $this->_propDict["customXml"];
            }
        }
        return null;
    ...
    * Custom XML commands that configures the VPN connection. (UTF8 byte encoding)
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The customXml
    *
    * @return Windows10XWifiConfiguration
    */
