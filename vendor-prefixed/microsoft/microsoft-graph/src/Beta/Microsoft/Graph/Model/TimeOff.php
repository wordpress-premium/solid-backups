    ...
    */
    public function getDraftTimeOff()
    {
        if (array_key_exists("draftTimeOff", $this->_propDict)) {
            if (is_a($this->_propDict["draftTimeOff"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOffItem")) {
    ...
    */
    public function getSharedTimeOff()
    {
        if (array_key_exists("sharedTimeOff", $this->_propDict)) {
            if (is_a($this->_propDict["sharedTimeOff"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOffItem")) {
