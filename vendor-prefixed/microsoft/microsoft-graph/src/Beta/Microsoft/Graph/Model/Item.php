    ...
    */
    public function getInventory()
    {
        if (array_key_exists("inventory", $this->_propDict)) {
            if (is_a($this->_propDict["inventory"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Decimal")) {
    ...
    */
    public function getItemCategory()
    {
        if (array_key_exists("itemCategory", $this->_propDict)) {
            if (is_a($this->_propDict["itemCategory"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ItemCategory")) {
