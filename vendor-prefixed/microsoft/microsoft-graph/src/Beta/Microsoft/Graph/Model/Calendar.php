    ...
    */
    public function getColor()
    {
        if (array_key_exists("color", $this->_propDict)) {
            if (is_a($this->_propDict["color"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CalendarColor")) {
    ...
    */
    public function getDefaultOnlineMeetingProvider()
    {
        if (array_key_exists("defaultOnlineMeetingProvider", $this->_propDict)) {
            if (is_a($this->_propDict["defaultOnlineMeetingProvider"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\OnlineMeetingProviderType")) {
    ...
    */
    public function getOwner()
    {
        if (array_key_exists("owner", $this->_propDict)) {
            if (is_a($this->_propDict["owner"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\EmailAddress")) {
