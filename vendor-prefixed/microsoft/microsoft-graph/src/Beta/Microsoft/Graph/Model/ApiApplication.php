    ...
    */
    public function getOauth2PermissionScopes()
    {
        if (array_key_exists("oauth2PermissionScopes", $this->_propDict)) {
            if (is_a($this->_propDict["oauth2PermissionScopes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PermissionScope")) {
    ...
    */
    public function getPreAuthorizedApplications()
    {
        if (array_key_exists("preAuthorizedApplications", $this->_propDict)) {
            if (is_a($this->_propDict["preAuthorizedApplications"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PreAuthorizedApplication")) {
