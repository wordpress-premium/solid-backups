    ...
    */
    public function getPhoneType()
    {
        if (array_key_exists("phoneType", $this->_propDict)) {
            if (is_a($this->_propDict["phoneType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AuthenticationPhoneType")) {
    ...
    */
    public function getSmsSignInState()
    {
        if (array_key_exists("smsSignInState", $this->_propDict)) {
            if (is_a($this->_propDict["smsSignInState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AuthenticationMethodSignInState")) {
