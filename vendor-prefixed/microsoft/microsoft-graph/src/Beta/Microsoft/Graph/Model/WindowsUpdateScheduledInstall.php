    ...
    */
    public function getScheduledInstallDay()
    {
        if (array_key_exists("scheduledInstallDay", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledInstallDay"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WeeklySchedule")) {
    ...
    */
    public function getScheduledInstallTime()
    {
        if (array_key_exists("scheduledInstallTime", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledInstallTime"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOfDay")) {
