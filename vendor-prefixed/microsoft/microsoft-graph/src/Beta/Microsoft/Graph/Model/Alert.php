    ...
    */
    public function getFeedback()
    {
        if (array_key_exists("feedback", $this->_propDict)) {
            if (is_a($this->_propDict["feedback"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AlertFeedback")) {
    ...
    */
    public function getSeverity()
    {
        if (array_key_exists("severity", $this->_propDict)) {
            if (is_a($this->_propDict["severity"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AlertSeverity")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AlertStatus")) {
    ...
    */
    public function getVendorInformation()
    {
        if (array_key_exists("vendorInformation", $this->_propDict)) {
            if (is_a($this->_propDict["vendorInformation"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SecurityVendorInformation")) {
