    ...
    */
    public function getAuthenticationMethodsPolicy()
    {
        if (array_key_exists("authenticationMethodsPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationMethodsPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AuthenticationMethodsPolicy")) {
    ...
    */
    public function getAuthenticationFlowsPolicy()
    {
        if (array_key_exists("authenticationFlowsPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationFlowsPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AuthenticationFlowsPolicy")) {
    ...
    */
    public function getB2cAuthenticationMethodsPolicy()
    {
        if (array_key_exists("b2cAuthenticationMethodsPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["b2cAuthenticationMethodsPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\B2cAuthenticationMethodsPolicy")) {
    ...
    */
    public function getAdminConsentRequestPolicy()
    {
        if (array_key_exists("adminConsentRequestPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["adminConsentRequestPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AdminConsentRequestPolicy")) {
    ...
    */
    public function getDirectoryRoleAccessReviewPolicy()
    {
        if (array_key_exists("directoryRoleAccessReviewPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["directoryRoleAccessReviewPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DirectoryRoleAccessReviewPolicy")) {
    ...
    */
    public function getIdentitySecurityDefaultsEnforcementPolicy()
    {
        if (array_key_exists("identitySecurityDefaultsEnforcementPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["identitySecurityDefaultsEnforcementPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentitySecurityDefaultsEnforcementPolicy")) {
    ...
    */
    public function jsonSerialize()
    {
        ...
        foreach ($serializableProperties as $property => $val) {
            ...
            } else if (is_a($val, "\Solid_Backups\Strauss\Microsoft\Graph\Core\Enum")) {
