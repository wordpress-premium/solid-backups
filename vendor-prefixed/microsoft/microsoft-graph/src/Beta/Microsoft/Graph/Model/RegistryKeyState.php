    ...
    */
    public function getHive()
    {
        if (array_key_exists("hive", $this->_propDict)) {
            if (is_a($this->_propDict["hive"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RegistryHive")) {
    ...
    */
    public function getOperation()
    {
        if (array_key_exists("operation", $this->_propDict)) {
            if (is_a($this->_propDict["operation"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RegistryOperation")) {
    ...
    */
    public function getValueType()
    {
        if (array_key_exists("valueType", $this->_propDict)) {
            if (is_a($this->_propDict["valueType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RegistryValueType")) {
