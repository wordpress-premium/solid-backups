    ...
    */
    public function getDayofWeek()
    {
        if (array_key_exists("dayofWeek", $this->_propDict)) {
            if (is_a($this->_propDict["dayofWeek"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DayOfWeek")) {
    ...
    */
    public function getRecurrence()
    {
        if (array_key_exists("recurrence", $this->_propDict)) {
            if (is_a($this->_propDict["recurrence"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Windows10AppsUpdateRecurrence")) {
