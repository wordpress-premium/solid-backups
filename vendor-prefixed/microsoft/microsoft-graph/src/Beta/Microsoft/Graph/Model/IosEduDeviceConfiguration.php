    ...
    */
    public function getDeviceCertificateSettings()
    {
        if (array_key_exists("deviceCertificateSettings", $this->_propDict)) {
            if (is_a($this->_propDict["deviceCertificateSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IosEduCertificateSettings")) {
    ...
    */
    public function getStudentCertificateSettings()
    {
        if (array_key_exists("studentCertificateSettings", $this->_propDict)) {
            if (is_a($this->_propDict["studentCertificateSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IosEduCertificateSettings")) {
    ...
    */
    public function getTeacherCertificateSettings()
    {
        if (array_key_exists("teacherCertificateSettings", $this->_propDict)) {
            if (is_a($this->_propDict["teacherCertificateSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IosEduCertificateSettings")) {
