    ...
    */
    public function getFlowBehavior()
    {
        if (array_key_exists("flowBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["flowBehavior"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AttributeFlowBehavior")) {
    ...
    */
    public function getFlowType()
    {
        if (array_key_exists("flowType", $this->_propDict)) {
            if (is_a($this->_propDict["flowType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AttributeFlowType")) {
    ...
    */
    public function getSource()
    {
        if (array_key_exists("source", $this->_propDict)) {
            if (is_a($this->_propDict["source"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AttributeMappingSource")) {
