    ...
    */
    public function getElevationDuration()
    {
        if (array_key_exists("elevationDuration", $this->_propDict)) {
            if (is_a($this->_propDict["elevationDuration"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Duration")) {
    ...
    */
    public function getMaxElavationDuration()
    {
        if (array_key_exists("maxElavationDuration", $this->_propDict)) {
            if (is_a($this->_propDict["maxElavationDuration"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Duration")) {
    ...
    */
    public function getMinElevationDuration()
    {
        if (array_key_exists("minElevationDuration", $this->_propDict)) {
            if (is_a($this->_propDict["minElevationDuration"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Duration")) {
