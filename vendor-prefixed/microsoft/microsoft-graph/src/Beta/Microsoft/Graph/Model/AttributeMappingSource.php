    ...
    */
    public function getParameters()
    {
        if (array_key_exists("parameters", $this->_propDict)) {
            if (is_a($this->_propDict["parameters"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\StringKeyAttributeMappingSourceValuePair")) {
    ...
    */
    public function getType()
    {
        if (array_key_exists("type", $this->_propDict)) {
            if (is_a($this->_propDict["type"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AttributeMappingSourceType")) {
