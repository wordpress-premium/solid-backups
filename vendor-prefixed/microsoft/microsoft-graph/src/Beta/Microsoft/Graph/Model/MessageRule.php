    ...
    */
    public function getActions()
    {
        if (array_key_exists("actions", $this->_propDict)) {
            if (is_a($this->_propDict["actions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MessageRuleActions")) {
    ...
    */
    public function getConditions()
    {
        if (array_key_exists("conditions", $this->_propDict)) {
            if (is_a($this->_propDict["conditions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MessageRulePredicates")) {
    ...
    */
    public function getExceptions()
    {
        if (array_key_exists("exceptions", $this->_propDict)) {
            if (is_a($this->_propDict["exceptions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MessageRulePredicates")) {
