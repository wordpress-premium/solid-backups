    ...
    */
    public function getEapFastConfiguration()
    {
        if (array_key_exists("eapFastConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["eapFastConfiguration"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\EapFastConfiguration")) {
    ...
    */
    public function getNetworkInterface()
    {
        if (array_key_exists("networkInterface", $this->_propDict)) {
            if (is_a($this->_propDict["networkInterface"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WiredNetworkInterface")) {
    ...
    */
    public function getNonEapAuthenticationMethodForEapTtls()
    {
        if (array_key_exists("nonEapAuthenticationMethodForEapTtls", $this->_propDict)) {
            if (is_a($this->_propDict["nonEapAuthenticationMethodForEapTtls"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\NonEapAuthenticationMethodForEapTtlsType")) {
    ...
    */
    public function getIdentityCertificateForClientAuthentication()
    {
        if (array_key_exists("identityCertificateForClientAuthentication", $this->_propDict)) {
            if (is_a($this->_propDict["identityCertificateForClientAuthentication"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MacOSCertificateProfileBase")) {
    ...
    */
    public function getRootCertificateForServerValidation()
    {
        if (array_key_exists("rootCertificateForServerValidation", $this->_propDict)) {
            if (is_a($this->_propDict["rootCertificateForServerValidation"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MacOSTrustedRootCertificate")) {
