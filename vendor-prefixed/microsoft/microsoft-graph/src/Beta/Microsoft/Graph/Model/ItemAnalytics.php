    ...
    */
    public function getAllTime()
    {
        if (array_key_exists("allTime", $this->_propDict)) {
            if (is_a($this->_propDict["allTime"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ItemActivityStat")) {
    ...
    */
    public function getLastSevenDays()
    {
        if (array_key_exists("lastSevenDays", $this->_propDict)) {
            if (is_a($this->_propDict["lastSevenDays"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ItemActivityStat")) {
