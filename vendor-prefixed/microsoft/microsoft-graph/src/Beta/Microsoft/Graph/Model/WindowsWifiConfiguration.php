    ...
    */
    public function getMeteredConnectionLimit()
    {
        if (array_key_exists("meteredConnectionLimit", $this->_propDict)) {
            if (is_a($this->_propDict["meteredConnectionLimit"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MeteredConnectionLimitType")) {
    ...
    */
    public function getProxySetting()
    {
        if (array_key_exists("proxySetting", $this->_propDict)) {
            if (is_a($this->_propDict["proxySetting"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WiFiProxySetting")) {
    ...
    */
    public function getWifiSecurityType()
    {
        if (array_key_exists("wifiSecurityType", $this->_propDict)) {
            if (is_a($this->_propDict["wifiSecurityType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WiFiSecurityType")) {
