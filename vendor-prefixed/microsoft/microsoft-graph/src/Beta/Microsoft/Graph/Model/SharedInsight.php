    ...
    */
    public function getLastShared()
    {
        if (array_key_exists("lastShared", $this->_propDict)) {
            if (is_a($this->_propDict["lastShared"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SharingDetail")) {
    ...
    */
    public function getResourceReference()
    {
        if (array_key_exists("resourceReference", $this->_propDict)) {
            if (is_a($this->_propDict["resourceReference"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ResourceReference")) {
    ...
    */
    public function getResourceVisualization()
    {
        if (array_key_exists("resourceVisualization", $this->_propDict)) {
            if (is_a($this->_propDict["resourceVisualization"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ResourceVisualization")) {
    ...
    */
    public function getLastSharedMethod()
    {
        if (array_key_exists("lastSharedMethod", $this->_propDict)) {
            if (is_a($this->_propDict["lastSharedMethod"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Entity")) {
    ...
    */
    public function getResource()
    {
        if (array_key_exists("resource", $this->_propDict)) {
            if (is_a($this->_propDict["resource"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Entity")) {
