    ...
    */
    public function getDeploySummary()
    {
        if (array_key_exists("deploySummary", $this->_propDict)) {
            if (is_a($this->_propDict["deploySummary"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsDefenderApplicationControlSupplementalPolicyDeploymentSummary")) {
