    ...
    */
    public function getDeliveryOptimizationPriority()
    {
        if (array_key_exists("deliveryOptimizationPriority", $this->_propDict)) {
            if (is_a($this->_propDict["deliveryOptimizationPriority"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Win32LobAppDeliveryOptimizationPriority")) {
    ...
    */
    public function getInstallTimeSettings()
    {
        if (array_key_exists("installTimeSettings", $this->_propDict)) {
            if (is_a($this->_propDict["installTimeSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MobileAppInstallTimeSettings")) {
    ...
    */
    public function getNotifications()
    {
        if (array_key_exists("notifications", $this->_propDict)) {
            if (is_a($this->_propDict["notifications"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Win32LobAppNotification")) {
    ...
    */
    public function getRestartSettings()
    {
        if (array_key_exists("restartSettings", $this->_propDict)) {
            if (is_a($this->_propDict["restartSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Win32LobAppRestartSettings")) {
