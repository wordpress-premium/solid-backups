    ...
    */
    public function getDetectionType()
    {
        if (array_key_exists("detectionType", $this->_propDict)) {
            if (is_a($this->_propDict["detectionType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Win32LobAppFileSystemDetectionType")) {
    ...
    */
    public function getOperator()
    {
        if (array_key_exists("operator", $this->_propDict)) {
            if (is_a($this->_propDict["operator"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Win32LobAppDetectionOperator")) {
