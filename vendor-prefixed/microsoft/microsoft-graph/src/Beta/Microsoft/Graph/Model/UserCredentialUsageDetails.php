    ...
    */
    public function getAuthMethod()
    {
        if (array_key_exists("authMethod", $this->_propDict)) {
            if (is_a($this->_propDict["authMethod"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UsageAuthMethod")) {
    ...
    */
    public function getFeature()
    {
        if (array_key_exists("feature", $this->_propDict)) {
            if (is_a($this->_propDict["feature"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\FeatureType")) {
