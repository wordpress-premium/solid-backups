    ...
    */
    public function getUserRegistrationMethodCounts()
    {
        if (array_key_exists("userRegistrationMethodCounts", $this->_propDict)) {
            if (is_a($this->_propDict["userRegistrationMethodCounts"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UserRegistrationMethodCount")) {
    ...
    */
    public function getUserRoles()
    {
        if (array_key_exists("userRoles", $this->_propDict)) {
            if (is_a($this->_propDict["userRoles"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IncludedUserRoles")) {
    ...
    */
    public function getUserTypes()
    {
        if (array_key_exists("userTypes", $this->_propDict)) {
            if (is_a($this->_propDict["userTypes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IncludedUserTypes")) {
