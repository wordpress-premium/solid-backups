    ...
    */
    public function getClassifyAs()
    {
        if (array_key_exists("classifyAs", $this->_propDict)) {
            if (is_a($this->_propDict["classifyAs"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\InferenceClassificationType")) {
    ...
    */
    public function getSenderEmailAddress()
    {
        if (array_key_exists("senderEmailAddress", $this->_propDict)) {
            if (is_a($this->_propDict["senderEmailAddress"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\EmailAddress")) {
