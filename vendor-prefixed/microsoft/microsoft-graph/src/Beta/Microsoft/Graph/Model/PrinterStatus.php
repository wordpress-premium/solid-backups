    ...
    */
    public function getDetails()
    {
        if (array_key_exists("details", $this->_propDict)) {
            if (is_a($this->_propDict["details"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PrinterProcessingStateDetail")) {
    ...
    */
    public function getProcessingState()
    {
        if (array_key_exists("processingState", $this->_propDict)) {
            if (is_a($this->_propDict["processingState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PrinterProcessingState")) {
    ...
    */
    public function getProcessingStateReasons()
    {
        if (array_key_exists("processingStateReasons", $this->_propDict)) {
            if (is_a($this->_propDict["processingStateReasons"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PrinterProcessingStateReason")) {
    ...
    */
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PrinterProcessingState")) {
