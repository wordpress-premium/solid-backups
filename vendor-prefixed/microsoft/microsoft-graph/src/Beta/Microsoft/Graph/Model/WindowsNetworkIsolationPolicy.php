    ...
    */
    public function getEnterpriseCloudResources()
    {
        if (array_key_exists("enterpriseCloudResources", $this->_propDict)) {
            if (is_a($this->_propDict["enterpriseCloudResources"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ProxiedDomain")) {
    ...
    */
    public function getEnterpriseIPRanges()
    {
        if (array_key_exists("enterpriseIPRanges", $this->_propDict)) {
            if (is_a($this->_propDict["enterpriseIPRanges"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IpRange")) {
