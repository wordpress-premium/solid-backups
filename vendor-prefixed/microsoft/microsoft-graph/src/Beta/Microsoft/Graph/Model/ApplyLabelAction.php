    ...
    */
    public function getActions()
    {
        if (array_key_exists("actions", $this->_propDict)) {
            if (is_a($this->_propDict["actions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\InformationProtectionAction")) {
    ...
    */
    public function getActionSource()
    {
        if (array_key_exists("actionSource", $this->_propDict)) {
            if (is_a($this->_propDict["actionSource"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ActionSource")) {
    ...
    */
    public function getLabel()
    {
        if (array_key_exists("label", $this->_propDict)) {
            if (is_a($this->_propDict["label"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\LabelDetails")) {
