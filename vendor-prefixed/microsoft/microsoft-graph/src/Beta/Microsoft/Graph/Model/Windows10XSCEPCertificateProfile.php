    ...
    */
    public function getCertificateStore()
    {
        if (array_key_exists("certificateStore", $this->_propDict)) {
            if (is_a($this->_propDict["certificateStore"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CertificateStore")) {
    ...
    */
    public function getKeySize()
    {
        if (array_key_exists("keySize", $this->_propDict)) {
            if (is_a($this->_propDict["keySize"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\KeySize")) {
    ...
    */
    public function getKeyStorageProvider()
    {
        if (array_key_exists("keyStorageProvider", $this->_propDict)) {
            if (is_a($this->_propDict["keyStorageProvider"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\KeyStorageProviderOption")) {
    ...
    */
    public function getKeyUsage()
    {
        if (array_key_exists("keyUsage", $this->_propDict)) {
            if (is_a($this->_propDict["keyUsage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\KeyUsages")) {
