    ...
    */
    public function getLanguageOverrides()
    {
        if (array_key_exists("languageOverrides", $this->_propDict)) {
            if (is_a($this->_propDict["languageOverrides"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TranslationLanguageOverride")) {
    ...
    */
    public function getTranslationBehavior()
    {
        if (array_key_exists("translationBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["translationBehavior"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TranslationBehavior")) {
