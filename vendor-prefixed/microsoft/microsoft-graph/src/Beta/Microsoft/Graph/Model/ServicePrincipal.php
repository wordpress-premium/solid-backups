    ...
    */
    public function getPasswordSingleSignOnSettings()
    {
        if (array_key_exists("passwordSingleSignOnSettings", $this->_propDict)) {
            if (is_a($this->_propDict["passwordSingleSignOnSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PasswordSingleSignOnSettings")) {
    ...
    */
    public function getSamlSingleSignOnSettings()
    {
        if (array_key_exists("samlSingleSignOnSettings", $this->_propDict)) {
            if (is_a($this->_propDict["samlSingleSignOnSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SamlSingleSignOnSettings")) {
