...
class FileEncryptionInfo extends Entity
{
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The encryptionKey
    */
    public function getEncryptionKey()
    {
        if (array_key_exists("encryptionKey", $this->_propDict)) {
            if (is_a($this->_propDict["encryptionKey"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["encryptionKey"];
            } else {
                $this->_propDict["encryptionKey"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["encryptionKey"]);
                return $this->_propDict["encryptionKey"];
            }
        }
        return null;
    ...
    * The key used to encrypt the file content.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The value to assign to the encryptionKey
    *
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The fileDigest
    */
    public function getFileDigest()
    {
        if (array_key_exists("fileDigest", $this->_propDict)) {
            if (is_a($this->_propDict["fileDigest"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["fileDigest"];
            } else {
                $this->_propDict["fileDigest"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["fileDigest"]);
                return $this->_propDict["fileDigest"];
            }
        }
        return null;
    ...
    * The file digest prior to encryption.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The value to assign to the fileDigest
    *
    * @return FileEncryptionInfo The FileEncryptionInfo
    */
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The initializationVector
    */
    public function getInitializationVector()
    {
        if (array_key_exists("initializationVector", $this->_propDict)) {
            if (is_a($this->_propDict["initializationVector"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["initializationVector"];
            } else {
                $this->_propDict["initializationVector"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["initializationVector"]);
                return $this->_propDict["initializationVector"];
            }
        }
        return null;
    ...
    * The initialization vector used for the encryption algorithm.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The value to assign to the initializationVector
    *
    * @return FileEncryptionInfo The FileEncryptionInfo
    */
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The mac
    */
    public function getMac()
    {
        if (array_key_exists("mac", $this->_propDict)) {
            if (is_a($this->_propDict["mac"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["mac"];
            } else {
                $this->_propDict["mac"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["mac"]);
                return $this->_propDict["mac"];
            }
        }
        return null;
    ...
    * The hash of the encrypted file content + IV (content hash).
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The value to assign to the mac
    *
    * @return FileEncryptionInfo The FileEncryptionInfo
    */
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The macKey
    */
    public function getMacKey()
    {
        if (array_key_exists("macKey", $this->_propDict)) {
            if (is_a($this->_propDict["macKey"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["macKey"];
            } else {
                $this->_propDict["macKey"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["macKey"]);
                return $this->_propDict["macKey"];
            }
        }
        return null;
    ...
    * The key used to get mac.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The value to assign to the macKey
    *
    * @return FileEncryptionInfo The FileEncryptionInfo
    */
