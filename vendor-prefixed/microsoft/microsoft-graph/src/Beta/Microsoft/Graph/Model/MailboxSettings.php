    ...
    */
    public function getAutomaticRepliesSetting()
    {
        if (array_key_exists("automaticRepliesSetting", $this->_propDict)) {
            if (is_a($this->_propDict["automaticRepliesSetting"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AutomaticRepliesSetting")) {
    ...
    */
    public function getDelegateMeetingMessageDeliveryOptions()
    {
        if (array_key_exists("delegateMeetingMessageDeliveryOptions", $this->_propDict)) {
            if (is_a($this->_propDict["delegateMeetingMessageDeliveryOptions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DelegateMeetingMessageDeliveryOptions")) {
    ...
    */
    public function getLanguage()
    {
        if (array_key_exists("language", $this->_propDict)) {
            if (is_a($this->_propDict["language"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\LocaleInfo")) {
    ...
    */
    public function getUserPurpose()
    {
        if (array_key_exists("userPurpose", $this->_propDict)) {
            if (is_a($this->_propDict["userPurpose"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UserPurpose")) {
    ...
    */
    public function getUserPurposeV2()
    {
        if (array_key_exists("userPurposeV2", $this->_propDict)) {
            if (is_a($this->_propDict["userPurposeV2"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MailboxRecipientType")) {
    ...
    */
    public function getWorkingHours()
    {
        if (array_key_exists("workingHours", $this->_propDict)) {
            if (is_a($this->_propDict["workingHours"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WorkingHours")) {
