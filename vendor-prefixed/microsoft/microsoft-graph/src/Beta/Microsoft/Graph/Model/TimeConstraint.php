    ...
    */
    public function getActivityDomain()
    {
        if (array_key_exists("activityDomain", $this->_propDict)) {
            if (is_a($this->_propDict["activityDomain"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ActivityDomain")) {
    ...
    */
    public function getTimeSlots()
    {
        if (array_key_exists("timeSlots", $this->_propDict)) {
            if (is_a($this->_propDict["timeSlots"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeSlot")) {
