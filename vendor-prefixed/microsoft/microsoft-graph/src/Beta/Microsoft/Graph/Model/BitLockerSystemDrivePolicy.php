    ...
    */
    public function getEncryptionMethod()
    {
        if (array_key_exists("encryptionMethod", $this->_propDict)) {
            if (is_a($this->_propDict["encryptionMethod"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\BitLockerEncryptionMethod")) {
    ...
    */
    public function getRecoveryOptions()
    {
        if (array_key_exists("recoveryOptions", $this->_propDict)) {
            if (is_a($this->_propDict["recoveryOptions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\BitLockerRecoveryOptions")) {
    ...
    */
    public function getStartupAuthenticationTpmKeyUsage()
    {
        if (array_key_exists("startupAuthenticationTpmKeyUsage", $this->_propDict)) {
            if (is_a($this->_propDict["startupAuthenticationTpmKeyUsage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConfigurationUsage")) {
    ...
    */
    public function getStartupAuthenticationTpmPinAndKeyUsage()
    {
        if (array_key_exists("startupAuthenticationTpmPinAndKeyUsage", $this->_propDict)) {
            if (is_a($this->_propDict["startupAuthenticationTpmPinAndKeyUsage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConfigurationUsage")) {
    ...
    */
    public function getStartupAuthenticationTpmPinUsage()
    {
        if (array_key_exists("startupAuthenticationTpmPinUsage", $this->_propDict)) {
            if (is_a($this->_propDict["startupAuthenticationTpmPinUsage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConfigurationUsage")) {
    ...
    */
    public function getStartupAuthenticationTpmUsage()
    {
        if (array_key_exists("startupAuthenticationTpmUsage", $this->_propDict)) {
            if (is_a($this->_propDict["startupAuthenticationTpmUsage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConfigurationUsage")) {
