    ...
    */
    public function getLicenseAssigned()
    {
        if (array_key_exists("licenseAssigned", $this->_propDict)) {
            if (is_a($this->_propDict["licenseAssigned"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AzureADLicenseType")) {
    ...
    */
    public function getLicenseRecommended()
    {
        if (array_key_exists("licenseRecommended", $this->_propDict)) {
            if (is_a($this->_propDict["licenseRecommended"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AzureADLicenseType")) {
