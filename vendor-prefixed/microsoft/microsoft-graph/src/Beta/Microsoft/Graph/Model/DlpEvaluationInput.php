    ...
    */
    public function getAccessScope()
    {
        if (array_key_exists("accessScope", $this->_propDict)) {
            if (is_a($this->_propDict["accessScope"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessScope")) {
    ...
    */
    public function getCurrentLabel()
    {
        if (array_key_exists("currentLabel", $this->_propDict)) {
            if (is_a($this->_propDict["currentLabel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CurrentLabel")) {
    ...
    */
    public function getDiscoveredSensitiveTypes()
    {
        if (array_key_exists("discoveredSensitiveTypes", $this->_propDict)) {
            if (is_a($this->_propDict["discoveredSensitiveTypes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DiscoveredSensitiveType")) {
