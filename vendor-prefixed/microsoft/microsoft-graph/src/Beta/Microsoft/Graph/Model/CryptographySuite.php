    ...
    */
    public function getAuthenticationTransformConstants()
    {
        if (array_key_exists("authenticationTransformConstants", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationTransformConstants"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AuthenticationTransformConstant")) {
    ...
    */
    public function getCipherTransformConstants()
    {
        if (array_key_exists("cipherTransformConstants", $this->_propDict)) {
            if (is_a($this->_propDict["cipherTransformConstants"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnEncryptionAlgorithmType")) {
    ...
    */
    public function getDhGroup()
    {
        if (array_key_exists("dhGroup", $this->_propDict)) {
            if (is_a($this->_propDict["dhGroup"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DiffieHellmanGroup")) {
    ...
    */
    public function getEncryptionMethod()
    {
        if (array_key_exists("encryptionMethod", $this->_propDict)) {
            if (is_a($this->_propDict["encryptionMethod"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnEncryptionAlgorithmType")) {
    ...
    */
    public function getIntegrityCheckMethod()
    {
        if (array_key_exists("integrityCheckMethod", $this->_propDict)) {
            if (is_a($this->_propDict["integrityCheckMethod"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnIntegrityAlgorithmType")) {
    ...
    */
    public function getPfsGroup()
    {
        if (array_key_exists("pfsGroup", $this->_propDict)) {
            if (is_a($this->_propDict["pfsGroup"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PerfectForwardSecrecyGroup")) {
