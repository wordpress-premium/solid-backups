    ...
    */
    public function getAuthenticationMethod()
    {
        if (array_key_exists("authenticationMethod", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationMethod"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WiFiAuthenticationMethod")) {
    ...
    */
    public function getEapType()
    {
        if (array_key_exists("eapType", $this->_propDict)) {
            if (is_a($this->_propDict["eapType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidEapType")) {
    ...
    */
    public function getInnerAuthenticationProtocolForEapTtls()
    {
        if (array_key_exists("innerAuthenticationProtocolForEapTtls", $this->_propDict)) {
            if (is_a($this->_propDict["innerAuthenticationProtocolForEapTtls"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\NonEapAuthenticationMethodForEapTtlsType")) {
    ...
    */
    public function getInnerAuthenticationProtocolForPeap()
    {
        if (array_key_exists("innerAuthenticationProtocolForPeap", $this->_propDict)) {
            if (is_a($this->_propDict["innerAuthenticationProtocolForPeap"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\NonEapAuthenticationMethodForPeap")) {
    ...
    */
    public function getIdentityCertificateForClientAuthentication()
    {
        if (array_key_exists("identityCertificateForClientAuthentication", $this->_propDict)) {
            if (is_a($this->_propDict["identityCertificateForClientAuthentication"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidDeviceOwnerCertificateProfileBase")) {
    ...
    */
    public function getRootCertificateForServerValidation()
    {
        if (array_key_exists("rootCertificateForServerValidation", $this->_propDict)) {
            if (is_a($this->_propDict["rootCertificateForServerValidation"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidDeviceOwnerTrustedRootCertificate")) {
