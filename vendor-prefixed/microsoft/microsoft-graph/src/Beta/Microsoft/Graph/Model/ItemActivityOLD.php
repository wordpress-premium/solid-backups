    ...
    */
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ItemActionSet")) {
    ...
    */
    public function getActor()
    {
        if (array_key_exists("actor", $this->_propDict)) {
            if (is_a($this->_propDict["actor"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getTimes()
    {
        if (array_key_exists("times", $this->_propDict)) {
            if (is_a($this->_propDict["times"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ItemActivityTimeSet")) {
