    ...
    */
    public function getEnrollmentMode()
    {
        if (array_key_exists("enrollmentMode", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentMode"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidDeviceOwnerEnrollmentMode")) {
    ...
    */
    public function getEnrollmentTokenType()
    {
        if (array_key_exists("enrollmentTokenType", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentTokenType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidDeviceOwnerEnrollmentTokenType")) {
    ...
    */
    public function getQrCodeImage()
    {
        if (array_key_exists("qrCodeImage", $this->_propDict)) {
            if (is_a($this->_propDict["qrCodeImage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MimeContent")) {
