    ...
    */
    public function getPinLowercaseCharactersUsage()
    {
        if (array_key_exists("pinLowercaseCharactersUsage", $this->_propDict)) {
            if (is_a($this->_propDict["pinLowercaseCharactersUsage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConfigurationUsage")) {
    ...
    */
    public function getPinSpecialCharactersUsage()
    {
        if (array_key_exists("pinSpecialCharactersUsage", $this->_propDict)) {
            if (is_a($this->_propDict["pinSpecialCharactersUsage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConfigurationUsage")) {
    ...
    */
    public function getPinUppercaseCharactersUsage()
    {
        if (array_key_exists("pinUppercaseCharactersUsage", $this->_propDict)) {
            if (is_a($this->_propDict["pinUppercaseCharactersUsage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConfigurationUsage")) {
