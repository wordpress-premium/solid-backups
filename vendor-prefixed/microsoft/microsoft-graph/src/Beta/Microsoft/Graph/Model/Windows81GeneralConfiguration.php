    ...
    */
    public function getBrowserInternetSecurityLevel()
    {
        if (array_key_exists("browserInternetSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserInternetSecurityLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\InternetSiteSecurityLevel")) {
    ...
    */
    public function getBrowserIntranetSecurityLevel()
    {
        if (array_key_exists("browserIntranetSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserIntranetSecurityLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SiteSecurityLevel")) {
    ...
    */
    public function getBrowserTrustedSitesSecurityLevel()
    {
        if (array_key_exists("browserTrustedSitesSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserTrustedSitesSecurityLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SiteSecurityLevel")) {
    ...
    */
    public function getMinimumAutoInstallClassification()
    {
        if (array_key_exists("minimumAutoInstallClassification", $this->_propDict)) {
            if (is_a($this->_propDict["minimumAutoInstallClassification"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UpdateClassification")) {
    ...
    */
    public function getUpdatesMinimumAutoInstallClassification()
    {
        if (array_key_exists("updatesMinimumAutoInstallClassification", $this->_propDict)) {
            if (is_a($this->_propDict["updatesMinimumAutoInstallClassification"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UpdateClassification")) {
    ...
    */
    public function getUserAccountControlSettings()
    {
        if (array_key_exists("userAccountControlSettings", $this->_propDict)) {
            if (is_a($this->_propDict["userAccountControlSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsUserAccountControlSettings")) {
