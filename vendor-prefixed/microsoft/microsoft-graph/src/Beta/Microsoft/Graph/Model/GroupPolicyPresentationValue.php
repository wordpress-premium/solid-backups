    ...
    */
    public function getDefinitionValue()
    {
        if (array_key_exists("definitionValue", $this->_propDict)) {
            if (is_a($this->_propDict["definitionValue"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\GroupPolicyDefinitionValue")) {
    ...
    */
    public function getPresentation()
    {
        if (array_key_exists("presentation", $this->_propDict)) {
            if (is_a($this->_propDict["presentation"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\GroupPolicyPresentation")) {
