    ...
    */
    public function getAppType()
    {
        if (array_key_exists("appType", $this->_propDict)) {
            if (is_a($this->_propDict["appType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsKioskAppType")) {
    ...
    */
    public function getStartLayoutTileSize()
    {
        if (array_key_exists("startLayoutTileSize", $this->_propDict)) {
            if (is_a($this->_propDict["startLayoutTileSize"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsAppStartLayoutTileSize")) {
