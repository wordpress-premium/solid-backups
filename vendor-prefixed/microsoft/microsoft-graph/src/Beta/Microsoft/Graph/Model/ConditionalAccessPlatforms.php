    ...
    */
    public function getExcludePlatforms()
    {
        if (array_key_exists("excludePlatforms", $this->_propDict)) {
            if (is_a($this->_propDict["excludePlatforms"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConditionalAccessDevicePlatform")) {
    ...
    */
    public function getIncludePlatforms()
    {
        if (array_key_exists("includePlatforms", $this->_propDict)) {
            if (is_a($this->_propDict["includePlatforms"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConditionalAccessDevicePlatform")) {
