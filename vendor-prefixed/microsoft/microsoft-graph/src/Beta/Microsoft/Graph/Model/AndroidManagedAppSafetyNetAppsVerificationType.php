...
* 
* AndroidManagedAppSafetyNetAppsVerificationType File
* PHP version 7
*
* @category  Library
...
/**
* AndroidManagedAppSafetyNetAppsVerificationType class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
{
    /**
    * The Enum AndroidManagedAppSafetyNetAppsVerificationType
    */
    const NONE = "none";
