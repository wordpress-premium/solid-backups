    ...
    */
    public function getReviewedEntity()
    {
        if (array_key_exists("reviewedEntity", $this->_propDict)) {
            if (is_a($this->_propDict["reviewedEntity"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Identity")) {
    ...
    */
    public function getSettings()
    {
        if (array_key_exists("settings", $this->_propDict)) {
            if (is_a($this->_propDict["settings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessReviewSettings")) {
