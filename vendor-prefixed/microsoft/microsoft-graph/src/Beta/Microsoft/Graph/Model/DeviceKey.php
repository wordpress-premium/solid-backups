...
class DeviceKey extends Entity
{
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The keyMaterial
    */
    public function getKeyMaterial()
    {
        if (array_key_exists("keyMaterial", $this->_propDict)) {
            if (is_a($this->_propDict["keyMaterial"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["keyMaterial"];
            } else {
                $this->_propDict["keyMaterial"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["keyMaterial"]);
                return $this->_propDict["keyMaterial"];
            }
        }
        return null;
    ...
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The value to assign to the keyMaterial
    *
