    ...
    */
    public function getPublishingState()
    {
        if (array_key_exists("publishingState", $this->_propDict)) {
            if (is_a($this->_propDict["publishingState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TeamsAppPublishingState")) {
    ...
    */
    public function getBot()
    {
        if (array_key_exists("bot", $this->_propDict)) {
            if (is_a($this->_propDict["bot"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TeamworkBot")) {
