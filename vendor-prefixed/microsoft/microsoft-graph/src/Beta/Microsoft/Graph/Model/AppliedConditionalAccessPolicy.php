    ...
    */
    public function getConditionsNotSatisfied()
    {
        if (array_key_exists("conditionsNotSatisfied", $this->_propDict)) {
            if (is_a($this->_propDict["conditionsNotSatisfied"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConditionalAccessConditions")) {
    ...
    */
    public function getConditionsSatisfied()
    {
        if (array_key_exists("conditionsSatisfied", $this->_propDict)) {
            if (is_a($this->_propDict["conditionsSatisfied"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConditionalAccessConditions")) {
    ...
    */
    public function getResult()
    {
        if (array_key_exists("result", $this->_propDict)) {
            if (is_a($this->_propDict["result"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AppliedConditionalAccessPolicyResult")) {
