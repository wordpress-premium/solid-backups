    ...
    */
    public function getAttendees()
    {
        if (array_key_exists("attendees", $this->_propDict)) {
            if (is_a($this->_propDict["attendees"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MeetingParticipantInfo")) {
    ...
    */
    public function getContributors()
    {
        if (array_key_exists("contributors", $this->_propDict)) {
            if (is_a($this->_propDict["contributors"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MeetingParticipantInfo")) {
    ...
    */
    public function getOrganizer()
    {
        if (array_key_exists("organizer", $this->_propDict)) {
            if (is_a($this->_propDict["organizer"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MeetingParticipantInfo")) {
    ...
    */
    public function getProducers()
    {
        if (array_key_exists("producers", $this->_propDict)) {
            if (is_a($this->_propDict["producers"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MeetingParticipantInfo")) {
