    ...
    */
    public function getAttendeeAvailability()
    {
        if (array_key_exists("attendeeAvailability", $this->_propDict)) {
            if (is_a($this->_propDict["attendeeAvailability"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AttendeeAvailability")) {
    ...
    */
    public function getLocations()
    {
        if (array_key_exists("locations", $this->_propDict)) {
            if (is_a($this->_propDict["locations"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Location")) {
    ...
    */
    public function getMeetingTimeSlot()
    {
        if (array_key_exists("meetingTimeSlot", $this->_propDict)) {
            if (is_a($this->_propDict["meetingTimeSlot"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeSlot")) {
    ...
    */
    public function getOrganizerAvailability()
    {
        if (array_key_exists("organizerAvailability", $this->_propDict)) {
            if (is_a($this->_propDict["organizerAvailability"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\FreeBusyStatus")) {
