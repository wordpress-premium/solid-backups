    ...
    */
    public function getFormat()
    {
        if (array_key_exists("format", $this->_propDict)) {
            if (is_a($this->_propDict["format"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WorkbookRangeFormat")) {
    ...
    */
    public function getSort()
    {
        if (array_key_exists("sort", $this->_propDict)) {
            if (is_a($this->_propDict["sort"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WorkbookRangeSort")) {
