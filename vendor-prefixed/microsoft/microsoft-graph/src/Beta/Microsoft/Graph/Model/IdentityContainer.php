    ...
    */
    public function getConditionalAccess()
    {
        if (array_key_exists("conditionalAccess", $this->_propDict)) {
            if (is_a($this->_propDict["conditionalAccess"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConditionalAccessRoot")) {
    ...
    */
    public function getContinuousAccessEvaluationPolicy()
    {
        if (array_key_exists("continuousAccessEvaluationPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["continuousAccessEvaluationPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ContinuousAccessEvaluationPolicy")) {
