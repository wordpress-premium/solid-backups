    ...
    */
    public function getDetectionState()
    {
        if (array_key_exists("detectionState", $this->_propDict)) {
            if (is_a($this->_propDict["detectionState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RunState")) {
    ...
    */
    public function getRemediationState()
    {
        if (array_key_exists("remediationState", $this->_propDict)) {
            if (is_a($this->_propDict["remediationState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RemediationState")) {
    ...
    */
    public function getManagedDevice()
    {
        if (array_key_exists("managedDevice", $this->_propDict)) {
            if (is_a($this->_propDict["managedDevice"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ManagedDevice")) {
