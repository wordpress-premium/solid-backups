    ...
    */
    public function getApplicationEnforcedRestrictions()
    {
        if (array_key_exists("applicationEnforcedRestrictions", $this->_propDict)) {
            if (is_a($this->_propDict["applicationEnforcedRestrictions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ApplicationEnforcedRestrictionsSessionControl")) {
    ...
    */
    public function getCloudAppSecurity()
    {
        if (array_key_exists("cloudAppSecurity", $this->_propDict)) {
            if (is_a($this->_propDict["cloudAppSecurity"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CloudAppSecuritySessionControl")) {
    ...
    */
    public function getPersistentBrowser()
    {
        if (array_key_exists("persistentBrowser", $this->_propDict)) {
            if (is_a($this->_propDict["persistentBrowser"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PersistentBrowserSessionControl")) {
    ...
    */
    public function getSignInFrequency()
    {
        if (array_key_exists("signInFrequency", $this->_propDict)) {
            if (is_a($this->_propDict["signInFrequency"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SignInFrequencySessionControl")) {
