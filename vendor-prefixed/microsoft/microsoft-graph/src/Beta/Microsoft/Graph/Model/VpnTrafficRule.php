    ...
    */
    public function getAppType()
    {
        if (array_key_exists("appType", $this->_propDict)) {
            if (is_a($this->_propDict["appType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnTrafficRuleAppType")) {
    ...
    */
    public function getLocalAddressRanges()
    {
        if (array_key_exists("localAddressRanges", $this->_propDict)) {
            if (is_a($this->_propDict["localAddressRanges"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IPv4Range")) {
    ...
    */
    public function getLocalPortRanges()
    {
        if (array_key_exists("localPortRanges", $this->_propDict)) {
            if (is_a($this->_propDict["localPortRanges"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\NumberRange")) {
    ...
    */
    public function getRemoteAddressRanges()
    {
        if (array_key_exists("remoteAddressRanges", $this->_propDict)) {
            if (is_a($this->_propDict["remoteAddressRanges"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IPv4Range")) {
    ...
    */
    public function getRemotePortRanges()
    {
        if (array_key_exists("remotePortRanges", $this->_propDict)) {
            if (is_a($this->_propDict["remotePortRanges"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\NumberRange")) {
    ...
    */
    public function getRoutingPolicyType()
    {
        if (array_key_exists("routingPolicyType", $this->_propDict)) {
            if (is_a($this->_propDict["routingPolicyType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnTrafficRuleRoutingPolicyType")) {
