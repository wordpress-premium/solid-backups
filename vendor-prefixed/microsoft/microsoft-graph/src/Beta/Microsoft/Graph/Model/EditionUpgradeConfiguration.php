    ...
    */
    public function getLicenseType()
    {
        if (array_key_exists("licenseType", $this->_propDict)) {
            if (is_a($this->_propDict["licenseType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\EditionUpgradeLicenseType")) {
    ...
    */
    public function getTargetEdition()
    {
        if (array_key_exists("targetEdition", $this->_propDict)) {
            if (is_a($this->_propDict["targetEdition"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Windows10EditionType")) {
    ...
    */
    public function getWindowsSMode()
    {
        if (array_key_exists("windowsSMode", $this->_propDict)) {
            if (is_a($this->_propDict["windowsSMode"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsSModeConfiguration")) {
