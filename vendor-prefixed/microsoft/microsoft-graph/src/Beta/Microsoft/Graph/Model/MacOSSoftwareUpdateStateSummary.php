    ...
    */
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MacOSSoftwareUpdateState")) {
    ...
    */
    public function getUpdateCategory()
    {
        if (array_key_exists("updateCategory", $this->_propDict)) {
            if (is_a($this->_propDict["updateCategory"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MacOSSoftwareUpdateCategory")) {
