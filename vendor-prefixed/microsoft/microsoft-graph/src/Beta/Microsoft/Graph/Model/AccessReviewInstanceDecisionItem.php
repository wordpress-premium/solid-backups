    ...
    */
    public function getAppliedBy()
    {
        if (array_key_exists("appliedBy", $this->_propDict)) {
            if (is_a($this->_propDict["appliedBy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UserIdentity")) {
    ...
    */
    public function getReviewedBy()
    {
        if (array_key_exists("reviewedBy", $this->_propDict)) {
            if (is_a($this->_propDict["reviewedBy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UserIdentity")) {
    ...
    */
    public function getTarget()
    {
        if (array_key_exists("target", $this->_propDict)) {
            if (is_a($this->_propDict["target"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessReviewInstanceDecisionItemTarget")) {
