    ...
    */
    public function getSecurityEncryptionAlgorithm()
    {
        if (array_key_exists("securityEncryptionAlgorithm", $this->_propDict)) {
            if (is_a($this->_propDict["securityEncryptionAlgorithm"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnEncryptionAlgorithmType")) {
    ...
    */
    public function getSecurityIntegrityAlgorithm()
    {
        if (array_key_exists("securityIntegrityAlgorithm", $this->_propDict)) {
            if (is_a($this->_propDict["securityIntegrityAlgorithm"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnIntegrityAlgorithmType")) {
