    ...
    */
    public function getBalanceDue()
    {
        if (array_key_exists("balanceDue", $this->_propDict)) {
            if (is_a($this->_propDict["balanceDue"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Decimal")) {
    ...
    */
    public function getCurrentAmount()
    {
        if (array_key_exists("currentAmount", $this->_propDict)) {
            if (is_a($this->_propDict["currentAmount"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Decimal")) {
    ...
    */
    public function getPeriod1Amount()
    {
        if (array_key_exists("period1Amount", $this->_propDict)) {
            if (is_a($this->_propDict["period1Amount"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Decimal")) {
    ...
    */
    public function getPeriod2Amount()
    {
        if (array_key_exists("period2Amount", $this->_propDict)) {
            if (is_a($this->_propDict["period2Amount"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Decimal")) {
    ...
    */
    public function getPeriod3Amount()
    {
        if (array_key_exists("period3Amount", $this->_propDict)) {
            if (is_a($this->_propDict["period3Amount"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Decimal")) {
