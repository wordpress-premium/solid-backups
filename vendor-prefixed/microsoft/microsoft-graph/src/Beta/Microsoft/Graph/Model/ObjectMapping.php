    ...
    */
    public function getAttributeMappings()
    {
        if (array_key_exists("attributeMappings", $this->_propDict)) {
            if (is_a($this->_propDict["attributeMappings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AttributeMapping")) {
    ...
    */
    public function getFlowTypes()
    {
        if (array_key_exists("flowTypes", $this->_propDict)) {
            if (is_a($this->_propDict["flowTypes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ObjectFlowTypes")) {
    ...
    */
    public function getScope()
    {
        if (array_key_exists("scope", $this->_propDict)) {
            if (is_a($this->_propDict["scope"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Filter")) {
