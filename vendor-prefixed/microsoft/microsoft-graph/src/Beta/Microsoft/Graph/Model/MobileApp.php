    ...
    */
    public function getLargeIcon()
    {
        if (array_key_exists("largeIcon", $this->_propDict)) {
            if (is_a($this->_propDict["largeIcon"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MimeContent")) {
    ...
    */
    public function getPublishingState()
    {
        if (array_key_exists("publishingState", $this->_propDict)) {
            if (is_a($this->_propDict["publishingState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MobileAppPublishingState")) {
    ...
    */
    public function getInstallSummary()
    {
        if (array_key_exists("installSummary", $this->_propDict)) {
            if (is_a($this->_propDict["installSummary"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MobileAppInstallSummary")) {
