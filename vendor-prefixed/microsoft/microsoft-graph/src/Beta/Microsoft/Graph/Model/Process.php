    ...
    */
    public function getFileHash()
    {
        if (array_key_exists("fileHash", $this->_propDict)) {
            if (is_a($this->_propDict["fileHash"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\FileHash")) {
    ...
    */
    public function getIntegrityLevel()
    {
        if (array_key_exists("integrityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["integrityLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ProcessIntegrityLevel")) {
