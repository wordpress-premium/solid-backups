    ...
    */
    public function getTopPrinters()
    {
        if (array_key_exists("topPrinters", $this->_propDict)) {
            if (is_a($this->_propDict["topPrinters"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PrinterUsageSummary")) {
    ...
    */
    public function getTopUsers()
    {
        if (array_key_exists("topUsers", $this->_propDict)) {
            if (is_a($this->_propDict["topUsers"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UserPrintUsageSummary")) {
