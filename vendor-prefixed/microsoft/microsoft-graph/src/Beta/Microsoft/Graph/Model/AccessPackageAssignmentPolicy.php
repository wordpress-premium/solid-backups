    ...
    */
    public function getAccessReviewSettings()
    {
        if (array_key_exists("accessReviewSettings", $this->_propDict)) {
            if (is_a($this->_propDict["accessReviewSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AssignmentReviewSettings")) {
    ...
    */
    public function getRequestApprovalSettings()
    {
        if (array_key_exists("requestApprovalSettings", $this->_propDict)) {
            if (is_a($this->_propDict["requestApprovalSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ApprovalSettings")) {
    ...
    */
    public function getRequestorSettings()
    {
        if (array_key_exists("requestorSettings", $this->_propDict)) {
            if (is_a($this->_propDict["requestorSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RequestorSettings")) {
    ...
    */
    public function getAccessPackage()
    {
        if (array_key_exists("accessPackage", $this->_propDict)) {
            if (is_a($this->_propDict["accessPackage"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessPackage")) {
    ...
    */
    public function getAccessPackageCatalog()
    {
        if (array_key_exists("accessPackageCatalog", $this->_propDict)) {
            if (is_a($this->_propDict["accessPackageCatalog"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessPackageCatalog")) {
