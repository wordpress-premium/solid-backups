    ...
    */
    public function getEndTime()
    {
        if (array_key_exists("endTime", $this->_propDict)) {
            if (is_a($this->_propDict["endTime"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOfDay")) {
    ...
    */
    public function getStartTime()
    {
        if (array_key_exists("startTime", $this->_propDict)) {
            if (is_a($this->_propDict["startTime"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOfDay")) {
    ...
    */
    public function getTimeZone()
    {
        if (array_key_exists("timeZone", $this->_propDict)) {
            if (is_a($this->_propDict["timeZone"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeZoneBase")) {
