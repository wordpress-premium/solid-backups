...
* 
* MacOsVppAppRevokeLicensesActionResult File
* PHP version 7
*
* @category  Library
...
/**
* MacOsVppAppRevokeLicensesActionResult class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
    ...
    */
    public function getActionFailureReason()
    {
        if (array_key_exists("actionFailureReason", $this->_propDict)) {
            if (is_a($this->_propDict["actionFailureReason"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VppTokenActionFailureReason")) {
    ...
    */
    public function getActionState()
    {
        if (array_key_exists("actionState", $this->_propDict)) {
            if (is_a($this->_propDict["actionState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ActionState")) {
