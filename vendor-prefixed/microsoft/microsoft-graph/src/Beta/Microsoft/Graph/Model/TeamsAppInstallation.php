    ...
    */
    public function getTeamsApp()
    {
        if (array_key_exists("teamsApp", $this->_propDict)) {
            if (is_a($this->_propDict["teamsApp"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TeamsApp")) {
    ...
    */
    public function getTeamsAppDefinition()
    {
        if (array_key_exists("teamsAppDefinition", $this->_propDict)) {
            if (is_a($this->_propDict["teamsAppDefinition"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TeamsAppDefinition")) {
