...
class AndroidGeneralDeviceConfiguration extends DeviceConfiguration
{
    ...
    */
    public function getDateAndTimeBlockChanges()
    {
        if (array_key_exists("dateAndTimeBlockChanges", $this->_propDict)) {
            return $this->_propDict["dateAndTimeBlockChanges"];
        } else {
            return null;
        }
    }
    ...
    * @return AndroidGeneralDeviceConfiguration
    */
    public function setDateAndTimeBlockChanges($val)
    {
    ...
    */
    public function getWebBrowserCookieSettings()
    {
        if (array_key_exists("webBrowserCookieSettings", $this->_propDict)) {
            if (is_a($this->_propDict["webBrowserCookieSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WebBrowserCookieSettings")) {
