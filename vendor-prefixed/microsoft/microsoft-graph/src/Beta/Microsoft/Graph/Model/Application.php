...
class Application extends DirectoryObject
{
    ...
    */
    public function getApi()
    {
        if (array_key_exists("api", $this->_propDict)) {
            if (is_a($this->_propDict["api"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ApiApplication")) {
    ...
    */
    public function getInfo()
    {
        if (array_key_exists("info", $this->_propDict)) {
            if (is_a($this->_propDict["info"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\InformationalUrl")) {
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The logo
    */
    public function getLogo()
    {
        if (array_key_exists("logo", $this->_propDict)) {
            if (is_a($this->_propDict["logo"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["logo"];
            } else {
                $this->_propDict["logo"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["logo"]);
                return $this->_propDict["logo"];
            }
        }
        return null;
    ...
    * The main logo for the application. Not nullable.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The logo
    *
    * @return Application
    */
    ...
    */
    public function getOptionalClaims()
    {
        if (array_key_exists("optionalClaims", $this->_propDict)) {
            if (is_a($this->_propDict["optionalClaims"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\OptionalClaims")) {
    ...
    */
    public function getParentalControlSettings()
    {
        if (array_key_exists("parentalControlSettings", $this->_propDict)) {
            if (is_a($this->_propDict["parentalControlSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ParentalControlSettings")) {
    ...
    */
    public function getPublicClient()
    {
        if (array_key_exists("publicClient", $this->_propDict)) {
            if (is_a($this->_propDict["publicClient"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PublicClientApplication")) {
    ...
    */
    public function getSpa()
    {
        if (array_key_exists("spa", $this->_propDict)) {
            if (is_a($this->_propDict["spa"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SpaApplication")) {
    ...
    */
    public function getWeb()
    {
        if (array_key_exists("web", $this->_propDict)) {
            if (is_a($this->_propDict["web"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WebApplication")) {
    ...
    */
    public function getOnPremisesPublishing()
    {
        if (array_key_exists("onPremisesPublishing", $this->_propDict)) {
            if (is_a($this->_propDict["onPremisesPublishing"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\OnPremisesPublishing")) {
    ...
    */
    public function getCreatedOnBehalfOf()
    {
        if (array_key_exists("createdOnBehalfOf", $this->_propDict)) {
            if (is_a($this->_propDict["createdOnBehalfOf"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DirectoryObject")) {
    ...
    */
    public function getConnectorGroup()
    {
        if (array_key_exists("connectorGroup", $this->_propDict)) {
            if (is_a($this->_propDict["connectorGroup"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ConnectorGroup")) {
    ...
    */
    public function getSynchronization()
    {
        if (array_key_exists("synchronization", $this->_propDict)) {
            if (is_a($this->_propDict["synchronization"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Synchronization")) {
