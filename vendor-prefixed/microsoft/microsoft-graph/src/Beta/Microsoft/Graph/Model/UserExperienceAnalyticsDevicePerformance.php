    ...
    */
    public function getDiskType()
    {
        if (array_key_exists("diskType", $this->_propDict)) {
            if (is_a($this->_propDict["diskType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DiskType")) {
    ...
    */
    public function getHealthStatus()
    {
        if (array_key_exists("healthStatus", $this->_propDict)) {
            if (is_a($this->_propDict["healthStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UserExperienceAnalyticsHealthState")) {
