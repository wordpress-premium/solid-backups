    ...
    */
    public function getConnectionType()
    {
        if (array_key_exists("connectionType", $this->_propDict)) {
            if (is_a($this->_propDict["connectionType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsVpnConnectionType")) {
    ...
    */
    public function getProxyServer()
    {
        if (array_key_exists("proxyServer", $this->_propDict)) {
            if (is_a($this->_propDict["proxyServer"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Windows81VpnProxyServer")) {
