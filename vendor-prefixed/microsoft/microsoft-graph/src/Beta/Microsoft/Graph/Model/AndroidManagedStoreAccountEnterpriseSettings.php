    ...
    */
    public function getBindStatus()
    {
        if (array_key_exists("bindStatus", $this->_propDict)) {
            if (is_a($this->_propDict["bindStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidManagedStoreAccountBindStatus")) {
    ...
    */
    public function getEnrollmentTarget()
    {
        if (array_key_exists("enrollmentTarget", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentTarget"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidManagedStoreAccountEnrollmentTarget")) {
    ...
    */
    public function getLastAppSyncStatus()
    {
        if (array_key_exists("lastAppSyncStatus", $this->_propDict)) {
            if (is_a($this->_propDict["lastAppSyncStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidManagedStoreAccountAppSyncStatus")) {
