    ...
    */
    public function getRequiredAzureAdTrustType()
    {
        if (array_key_exists("requiredAzureAdTrustType", $this->_propDict)) {
            if (is_a($this->_propDict["requiredAzureAdTrustType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementConfigurationAzureAdTrustType")) {
    ...
    */
    public function getWindowsSkus()
    {
        if (array_key_exists("windowsSkus", $this->_propDict)) {
            if (is_a($this->_propDict["windowsSkus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementConfigurationWindowsSkus")) {
