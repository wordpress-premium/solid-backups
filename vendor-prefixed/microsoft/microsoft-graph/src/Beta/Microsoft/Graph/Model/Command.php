    ...
    */
    public function getPayload()
    {
        if (array_key_exists("payload", $this->_propDict)) {
            if (is_a($this->_propDict["payload"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PayloadRequest")) {
    ...
    */
    public function getResponsepayload()
    {
        if (array_key_exists("responsepayload", $this->_propDict)) {
            if (is_a($this->_propDict["responsepayload"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PayloadResponse")) {
