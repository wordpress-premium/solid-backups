    ...
    */
    public function getInvitedUserMessageInfo()
    {
        if (array_key_exists("invitedUserMessageInfo", $this->_propDict)) {
            if (is_a($this->_propDict["invitedUserMessageInfo"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\InvitedUserMessageInfo")) {
    ...
    */
    public function getInvitedUser()
    {
        if (array_key_exists("invitedUser", $this->_propDict)) {
            if (is_a($this->_propDict["invitedUser"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\User")) {
