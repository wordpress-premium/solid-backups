...
class MacOSCustomAppConfiguration extends DeviceConfiguration
{
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The configurationXml
    */
    public function getConfigurationXml()
    {
        if (array_key_exists("configurationXml", $this->_propDict)) {
            if (is_a($this->_propDict["configurationXml"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["configurationXml"];
            } else {
                $this->_propDict["configurationXml"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["configurationXml"]);
                return $this->_propDict["configurationXml"];
            }
        }
        return null;
    ...
    * Configuration xml. (UTF8 encoded byte array)
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The configurationXml
    *
    * @return MacOSCustomAppConfiguration
    */
