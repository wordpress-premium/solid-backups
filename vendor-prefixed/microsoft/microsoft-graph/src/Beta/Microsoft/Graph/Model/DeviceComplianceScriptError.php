    ...
    */
    public function getCode()
    {
        if (array_key_exists("code", $this->_propDict)) {
            if (is_a($this->_propDict["code"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Code")) {
    ...
    */
    public function getDeviceComplianceScriptRulesValidationError()
    {
        if (array_key_exists("deviceComplianceScriptRulesValidationError", $this->_propDict)) {
            if (is_a($this->_propDict["deviceComplianceScriptRulesValidationError"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceComplianceScriptRulesValidationError")) {
