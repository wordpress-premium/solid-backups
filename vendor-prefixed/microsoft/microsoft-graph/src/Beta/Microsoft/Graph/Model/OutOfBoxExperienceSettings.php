    ...
    */
    public function getDeviceUsageType()
    {
        if (array_key_exists("deviceUsageType", $this->_propDict)) {
            if (is_a($this->_propDict["deviceUsageType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsDeviceUsageType")) {
    ...
    */
    public function getUserType()
    {
        if (array_key_exists("userType", $this->_propDict)) {
            if (is_a($this->_propDict["userType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsUserType")) {
