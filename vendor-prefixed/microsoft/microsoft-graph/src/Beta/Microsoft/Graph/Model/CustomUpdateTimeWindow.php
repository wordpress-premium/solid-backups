    ...
    */
    public function getEndDay()
    {
        if (array_key_exists("endDay", $this->_propDict)) {
            if (is_a($this->_propDict["endDay"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DayOfWeek")) {
    ...
    */
    public function getStartDay()
    {
        if (array_key_exists("startDay", $this->_propDict)) {
            if (is_a($this->_propDict["startDay"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DayOfWeek")) {
