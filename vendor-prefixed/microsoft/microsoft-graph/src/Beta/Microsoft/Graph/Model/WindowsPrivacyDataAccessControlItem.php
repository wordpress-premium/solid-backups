    ...
    */
    public function getAccessLevel()
    {
        if (array_key_exists("accessLevel", $this->_propDict)) {
            if (is_a($this->_propDict["accessLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsPrivacyDataAccessLevel")) {
    ...
    */
    public function getDataCategory()
    {
        if (array_key_exists("dataCategory", $this->_propDict)) {
            if (is_a($this->_propDict["dataCategory"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsPrivacyDataCategory")) {
