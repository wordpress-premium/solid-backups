    ...
    */
    public function getInstitution()
    {
        if (array_key_exists("institution", $this->_propDict)) {
            if (is_a($this->_propDict["institution"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\InstitutionData")) {
    ...
    */
    public function getProgram()
    {
        if (array_key_exists("program", $this->_propDict)) {
            if (is_a($this->_propDict["program"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\EducationalActivityDetail")) {
