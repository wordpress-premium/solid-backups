    ...
    */
    public function getUpdateWindowEndTime()
    {
        if (array_key_exists("updateWindowEndTime", $this->_propDict)) {
            if (is_a($this->_propDict["updateWindowEndTime"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOfDay")) {
    ...
    */
    public function getUpdateWindowStartTime()
    {
        if (array_key_exists("updateWindowStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["updateWindowStartTime"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeOfDay")) {
