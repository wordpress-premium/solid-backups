    ...
    */
    public function getPermission()
    {
        if (array_key_exists("permission", $this->_propDict)) {
            if (is_a($this->_propDict["permission"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ReferenceAttachmentPermission")) {
    ...
    */
    public function getProviderType()
    {
        if (array_key_exists("providerType", $this->_propDict)) {
            if (is_a($this->_propDict["providerType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ReferenceAttachmentProvider")) {
