    ...
    */
    public function getAccessReviews()
    {
        if (array_key_exists("accessReviews", $this->_propDict)) {
            if (is_a($this->_propDict["accessReviews"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessReviewSet")) {
    ...
    */
    public function getAppConsent()
    {
        if (array_key_exists("appConsent", $this->_propDict)) {
            if (is_a($this->_propDict["appConsent"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AppConsentApprovalRoute")) {
    ...
    */
    public function getTermsOfUse()
    {
        if (array_key_exists("termsOfUse", $this->_propDict)) {
            if (is_a($this->_propDict["termsOfUse"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TermsOfUseContainer")) {
    ...
    */
    public function getEntitlementManagement()
    {
        if (array_key_exists("entitlementManagement", $this->_propDict)) {
            if (is_a($this->_propDict["entitlementManagement"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\EntitlementManagement")) {
