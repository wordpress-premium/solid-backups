    ...
    */
    public function getList()
    {
        if (array_key_exists("list", $this->_propDict)) {
            if (is_a($this->_propDict["list"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ListInfo")) {
    ...
    */
    public function getSystem()
    {
        if (array_key_exists("system", $this->_propDict)) {
            if (is_a($this->_propDict["system"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SystemFacet")) {
