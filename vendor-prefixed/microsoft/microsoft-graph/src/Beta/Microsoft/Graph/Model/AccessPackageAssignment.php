    ...
    */
    public function getSchedule()
    {
        if (array_key_exists("schedule", $this->_propDict)) {
            if (is_a($this->_propDict["schedule"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RequestSchedule")) {
    ...
    */
    public function getAccessPackageAssignmentPolicy()
    {
        if (array_key_exists("accessPackageAssignmentPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["accessPackageAssignmentPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessPackageAssignmentPolicy")) {
    ...
    */
    public function getTarget()
    {
        if (array_key_exists("target", $this->_propDict)) {
            if (is_a($this->_propDict["target"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessPackageSubject")) {
