    ...
    */
    public function getUserFlowType()
    {
        if (array_key_exists("userFlowType", $this->_propDict)) {
            if (is_a($this->_propDict["userFlowType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UserFlowType")) {
    ...
    */
    public function getUserFlowTypeVersion()
    {
        if (array_key_exists("userFlowTypeVersion", $this->_propDict)) {
            if (is_a($this->_propDict["userFlowTypeVersion"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Single")) {
