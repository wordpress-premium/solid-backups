    ...
    */
    public function getDraftShift()
    {
        if (array_key_exists("draftShift", $this->_propDict)) {
            if (is_a($this->_propDict["draftShift"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ShiftItem")) {
    ...
    */
    public function getSharedShift()
    {
        if (array_key_exists("sharedShift", $this->_propDict)) {
            if (is_a($this->_propDict["sharedShift"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ShiftItem")) {
