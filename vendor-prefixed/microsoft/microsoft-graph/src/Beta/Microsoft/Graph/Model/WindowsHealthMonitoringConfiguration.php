    ...
    */
    public function getAllowDeviceHealthMonitoring()
    {
        if (array_key_exists("allowDeviceHealthMonitoring", $this->_propDict)) {
            if (is_a($this->_propDict["allowDeviceHealthMonitoring"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Enablement")) {
    ...
    */
    public function getConfigDeviceHealthMonitoringScope()
    {
        if (array_key_exists("configDeviceHealthMonitoringScope", $this->_propDict)) {
            if (is_a($this->_propDict["configDeviceHealthMonitoringScope"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsHealthMonitoringScope")) {
