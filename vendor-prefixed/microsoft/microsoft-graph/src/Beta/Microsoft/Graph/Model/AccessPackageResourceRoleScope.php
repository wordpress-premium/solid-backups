    ...
    */
    public function getAccessPackageResourceRole()
    {
        if (array_key_exists("accessPackageResourceRole", $this->_propDict)) {
            if (is_a($this->_propDict["accessPackageResourceRole"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessPackageResourceRole")) {
    ...
    */
    public function getAccessPackageResourceScope()
    {
        if (array_key_exists("accessPackageResourceScope", $this->_propDict)) {
            if (is_a($this->_propDict["accessPackageResourceScope"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessPackageResourceScope")) {
