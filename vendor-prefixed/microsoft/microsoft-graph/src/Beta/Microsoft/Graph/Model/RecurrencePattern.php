    ...
    */
    public function getDaysOfWeek()
    {
        if (array_key_exists("daysOfWeek", $this->_propDict)) {
            if (is_a($this->_propDict["daysOfWeek"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DayOfWeek")) {
    ...
    */
    public function getFirstDayOfWeek()
    {
        if (array_key_exists("firstDayOfWeek", $this->_propDict)) {
            if (is_a($this->_propDict["firstDayOfWeek"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DayOfWeek")) {
    ...
    */
    public function getIndex()
    {
        if (array_key_exists("index", $this->_propDict)) {
            if (is_a($this->_propDict["index"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WeekIndex")) {
    ...
    */
    public function getType()
    {
        if (array_key_exists("type", $this->_propDict)) {
            if (is_a($this->_propDict["type"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RecurrencePatternType")) {
