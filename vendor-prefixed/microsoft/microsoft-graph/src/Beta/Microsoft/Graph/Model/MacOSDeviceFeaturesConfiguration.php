    ...
    */
    public function getContentCachingClientPolicy()
    {
        if (array_key_exists("contentCachingClientPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["contentCachingClientPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MacOSContentCachingClientPolicy")) {
    ...
    */
    public function getContentCachingParentSelectionPolicy()
    {
        if (array_key_exists("contentCachingParentSelectionPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["contentCachingParentSelectionPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MacOSContentCachingParentSelectionPolicy")) {
    ...
    */
    public function getContentCachingPeerPolicy()
    {
        if (array_key_exists("contentCachingPeerPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["contentCachingPeerPolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MacOSContentCachingPeerPolicy")) {
    ...
    */
    public function getContentCachingType()
    {
        if (array_key_exists("contentCachingType", $this->_propDict)) {
            if (is_a($this->_propDict["contentCachingType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MacOSContentCachingType")) {
    ...
    */
    public function getMacOSSingleSignOnExtension()
    {
        if (array_key_exists("macOSSingleSignOnExtension", $this->_propDict)) {
            if (is_a($this->_propDict["macOSSingleSignOnExtension"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MacOSSingleSignOnExtension")) {
    ...
    */
    public function getSingleSignOnExtensionPkinitCertificate()
    {
        if (array_key_exists("singleSignOnExtensionPkinitCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["singleSignOnExtensionPkinitCertificate"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MacOSCertificateProfileBase")) {
