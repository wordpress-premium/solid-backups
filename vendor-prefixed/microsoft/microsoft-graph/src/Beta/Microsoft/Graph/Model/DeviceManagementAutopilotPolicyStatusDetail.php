    ...
    */
    public function getComplianceStatus()
    {
        if (array_key_exists("complianceStatus", $this->_propDict)) {
            if (is_a($this->_propDict["complianceStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementAutopilotPolicyComplianceStatus")) {
    ...
    */
    public function getPolicyType()
    {
        if (array_key_exists("policyType", $this->_propDict)) {
            if (is_a($this->_propDict["policyType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementAutopilotPolicyType")) {
