    ...
    */
    public function getApplication()
    {
        if (array_key_exists("application", $this->_propDict)) {
            if (is_a($this->_propDict["application"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Identity")) {
    ...
    */
    public function getDevice()
    {
        if (array_key_exists("device", $this->_propDict)) {
            if (is_a($this->_propDict["device"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Identity")) {
    ...
    */
    public function getUser()
    {
        if (array_key_exists("user", $this->_propDict)) {
            if (is_a($this->_propDict["user"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Identity")) {
