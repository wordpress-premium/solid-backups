    ...
    */
    public function getResponsiblePolicy()
    {
        if (array_key_exists("responsiblePolicy", $this->_propDict)) {
            if (is_a($this->_propDict["responsiblePolicy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ResponsiblePolicy")) {
    ...
    */
    public function getResponsibleSensitiveTypes()
    {
        if (array_key_exists("responsibleSensitiveTypes", $this->_propDict)) {
            if (is_a($this->_propDict["responsibleSensitiveTypes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ResponsibleSensitiveType")) {
    ...
    */
    public function getSensitivityLabel()
    {
        if (array_key_exists("sensitivityLabel", $this->_propDict)) {
            if (is_a($this->_propDict["sensitivityLabel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MatchingLabel")) {
