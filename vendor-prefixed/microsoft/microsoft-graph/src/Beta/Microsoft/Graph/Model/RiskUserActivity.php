    ...
    */
    public function getDetail()
    {
        if (array_key_exists("detail", $this->_propDict)) {
            if (is_a($this->_propDict["detail"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RiskDetail")) {
    ...
    */
    public function getEventTypes()
    {
        if (array_key_exists("eventTypes", $this->_propDict)) {
            if (is_a($this->_propDict["eventTypes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RiskEventType")) {
