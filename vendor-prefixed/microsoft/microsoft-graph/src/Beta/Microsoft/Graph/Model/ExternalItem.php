    ...
    */
    public function getContent()
    {
        if (array_key_exists("content", $this->_propDict)) {
            if (is_a($this->_propDict["content"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ExternalItemContent")) {
    ...
    */
    public function getExternalItemProperties()
    {
        if (array_key_exists("properties", $this->_propDict)) {
            if (is_a($this->_propDict["properties"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Properties")) {
