    ...
    */
    public function getOsEditionTypes()
    {
        if (array_key_exists("osEditionTypes", $this->_propDict)) {
            if (is_a($this->_propDict["osEditionTypes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Windows10EditionType")) {
    ...
    */
    public function getRuleType()
    {
        if (array_key_exists("ruleType", $this->_propDict)) {
            if (is_a($this->_propDict["ruleType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementApplicabilityRuleType")) {
