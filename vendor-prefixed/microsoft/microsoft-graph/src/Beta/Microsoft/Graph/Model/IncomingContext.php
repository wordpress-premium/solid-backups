    ...
    */
    public function getOnBehalfOf()
    {
        if (array_key_exists("onBehalfOf", $this->_propDict)) {
            if (is_a($this->_propDict["onBehalfOf"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getTransferor()
    {
        if (array_key_exists("transferor", $this->_propDict)) {
            if (is_a($this->_propDict["transferor"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentitySet")) {
