    ...
    */
    public function getDeploymentProfileAssignmentDetailedStatus()
    {
        if (array_key_exists("deploymentProfileAssignmentDetailedStatus", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentProfileAssignmentDetailedStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsAutopilotProfileAssignmentDetailedStatus")) {
    ...
    */
    public function getDeploymentProfileAssignmentStatus()
    {
        if (array_key_exists("deploymentProfileAssignmentStatus", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentProfileAssignmentStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsAutopilotProfileAssignmentStatus")) {
    ...
    */
    public function getDeploymentProfile()
    {
        if (array_key_exists("deploymentProfile", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentProfile"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsAutopilotDeploymentProfile")) {
    ...
    */
    public function getIntendedDeploymentProfile()
    {
        if (array_key_exists("intendedDeploymentProfile", $this->_propDict)) {
            if (is_a($this->_propDict["intendedDeploymentProfile"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsAutopilotDeploymentProfile")) {
