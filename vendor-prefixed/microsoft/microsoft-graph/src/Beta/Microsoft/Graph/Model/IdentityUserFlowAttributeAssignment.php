    ...
    */
    public function getUserInputType()
    {
        if (array_key_exists("userInputType", $this->_propDict)) {
            if (is_a($this->_propDict["userInputType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentityUserFlowAttributeInputType")) {
    ...
    */
    public function getUserAttribute()
    {
        if (array_key_exists("userAttribute", $this->_propDict)) {
            if (is_a($this->_propDict["userAttribute"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentityUserFlowAttribute")) {
