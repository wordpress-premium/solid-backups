    ...
    */
    public function getAssignmentFilterPlatform()
    {
        if (array_key_exists("assignmentFilterPlatform", $this->_propDict)) {
            if (is_a($this->_propDict["assignmentFilterPlatform"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DevicePlatformType")) {
    ...
    */
    public function getAssignmentFilterType()
    {
        if (array_key_exists("assignmentFilterType", $this->_propDict)) {
            if (is_a($this->_propDict["assignmentFilterType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceAndAppManagementAssignmentFilterType")) {
    ...
    */
    public function getEvaluationResult()
    {
        if (array_key_exists("evaluationResult", $this->_propDict)) {
            if (is_a($this->_propDict["evaluationResult"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AssignmentFilterEvaluationResult")) {
