    ...
    */
    public function getMdmSupportedState()
    {
        if (array_key_exists("mdmSupportedState", $this->_propDict)) {
            if (is_a($this->_propDict["mdmSupportedState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MdmSupportedState")) {
    ...
    */
    public function getSettingScope()
    {
        if (array_key_exists("settingScope", $this->_propDict)) {
            if (is_a($this->_propDict["settingScope"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\GroupPolicySettingScope")) {
    ...
    */
    public function getSettingType()
    {
        if (array_key_exists("settingType", $this->_propDict)) {
            if (is_a($this->_propDict["settingType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\GroupPolicySettingType")) {
