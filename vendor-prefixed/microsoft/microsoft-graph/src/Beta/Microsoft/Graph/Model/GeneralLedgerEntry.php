    ...
    */
    public function getCreditAmount()
    {
        if (array_key_exists("creditAmount", $this->_propDict)) {
            if (is_a($this->_propDict["creditAmount"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Decimal")) {
    ...
    */
    public function getDebitAmount()
    {
        if (array_key_exists("debitAmount", $this->_propDict)) {
            if (is_a($this->_propDict["debitAmount"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Decimal")) {
