...
class IosMobileAppConfiguration extends ManagedDeviceMobileAppConfiguration
{
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The encodedSettingXml
    */
    public function getEncodedSettingXml()
    {
        if (array_key_exists("encodedSettingXml", $this->_propDict)) {
            if (is_a($this->_propDict["encodedSettingXml"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["encodedSettingXml"];
            } else {
                $this->_propDict["encodedSettingXml"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["encodedSettingXml"]);
                return $this->_propDict["encodedSettingXml"];
            }
        }
        return null;
    ...
    * mdm app configuration Base64 binary.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The encodedSettingXml
    *
