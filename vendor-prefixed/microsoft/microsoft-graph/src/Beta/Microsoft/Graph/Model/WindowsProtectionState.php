    ...
    */
    public function getDeviceState()
    {
        if (array_key_exists("deviceState", $this->_propDict)) {
            if (is_a($this->_propDict["deviceState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsDeviceHealthState")) {
    ...
    */
    public function getProductStatus()
    {
        if (array_key_exists("productStatus", $this->_propDict)) {
            if (is_a($this->_propDict["productStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsDefenderProductStatus")) {
