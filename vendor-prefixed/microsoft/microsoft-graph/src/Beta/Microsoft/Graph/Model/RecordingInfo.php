    ...
    */
    public function getInitiatedBy()
    {
        if (array_key_exists("initiatedBy", $this->_propDict)) {
            if (is_a($this->_propDict["initiatedBy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ParticipantInfo")) {
    ...
    */
    public function getInitiator()
    {
        if (array_key_exists("initiator", $this->_propDict)) {
            if (is_a($this->_propDict["initiator"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getRecordingStatus()
    {
        if (array_key_exists("recordingStatus", $this->_propDict)) {
            if (is_a($this->_propDict["recordingStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RecordingStatus")) {
