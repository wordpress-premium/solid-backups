    ...
    */
    public function getComplianceState()
    {
        if (array_key_exists("complianceState", $this->_propDict)) {
            if (is_a($this->_propDict["complianceState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ComplianceStatus")) {
    ...
    */
    public function getOwnerType()
    {
        if (array_key_exists("ownerType", $this->_propDict)) {
            if (is_a($this->_propDict["ownerType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ManagedDeviceOwnerType")) {
