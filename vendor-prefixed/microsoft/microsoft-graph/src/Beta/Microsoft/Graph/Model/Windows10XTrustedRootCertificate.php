...
/**
* Windows10XTrustedRootCertificate class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class Windows10XTrustedRootCertificate extends DeviceManagementResourceAccessProfileBase
{
    /**
    ...
    */
    public function getDestinationStore()
    {
        if (array_key_exists("destinationStore", $this->_propDict)) {
            if (is_a($this->_propDict["destinationStore"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CertificateDestinationStore")) {
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The trustedRootCertificate
    */
    public function getTrustedRootCertificate()
    {
        if (array_key_exists("trustedRootCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["trustedRootCertificate"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["trustedRootCertificate"];
            } else {
                $this->_propDict["trustedRootCertificate"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["trustedRootCertificate"]);
                return $this->_propDict["trustedRootCertificate"];
            }
        }
        return null;
    ...
    * Trusted Root Certificate
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The trustedRootCertificate
    *
    * @return Windows10XTrustedRootCertificate
    */
