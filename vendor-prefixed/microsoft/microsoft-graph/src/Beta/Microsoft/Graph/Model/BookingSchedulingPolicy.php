    ...
    */
    public function getMaximumAdvance()
    {
        if (array_key_exists("maximumAdvance", $this->_propDict)) {
            if (is_a($this->_propDict["maximumAdvance"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Duration")) {
    ...
    */
    public function getMinimumLeadTime()
    {
        if (array_key_exists("minimumLeadTime", $this->_propDict)) {
            if (is_a($this->_propDict["minimumLeadTime"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Duration")) {
    ...
    */
    public function getTimeSlotInterval()
    {
        if (array_key_exists("timeSlotInterval", $this->_propDict)) {
            if (is_a($this->_propDict["timeSlotInterval"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Duration")) {
