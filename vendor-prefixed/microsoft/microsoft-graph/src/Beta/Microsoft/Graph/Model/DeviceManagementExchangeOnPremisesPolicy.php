...
class DeviceManagementExchangeOnPremisesPolicy extends Entity
{
    ...
    */
    public function getDefaultAccessLevel()
    {
        if (array_key_exists("defaultAccessLevel", $this->_propDict)) {
            if (is_a($this->_propDict["defaultAccessLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementExchangeAccessLevel")) {
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The notificationContent
    */
    public function getNotificationContent()
    {
        if (array_key_exists("notificationContent", $this->_propDict)) {
            if (is_a($this->_propDict["notificationContent"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["notificationContent"];
            } else {
                $this->_propDict["notificationContent"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["notificationContent"]);
                return $this->_propDict["notificationContent"];
            }
        }
        return null;
    ...
    * Notification text that will be sent to users quarantined by this policy. This is UTF8 encoded byte array HTML.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The notificationContent
    *
    * @return DeviceManagementExchangeOnPremisesPolicy
    */
