    ...
    */
    public function getRuleErrors()
    {
        if (array_key_exists("ruleErrors", $this->_propDict)) {
            if (is_a($this->_propDict["ruleErrors"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceComplianceScriptRuleError")) {
    ...
    */
    public function getRules()
    {
        if (array_key_exists("rules", $this->_propDict)) {
            if (is_a($this->_propDict["rules"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceComplianceScriptRule")) {
    ...
    */
    public function getScriptErrors()
    {
        if (array_key_exists("scriptErrors", $this->_propDict)) {
            if (is_a($this->_propDict["scriptErrors"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceComplianceScriptError")) {
