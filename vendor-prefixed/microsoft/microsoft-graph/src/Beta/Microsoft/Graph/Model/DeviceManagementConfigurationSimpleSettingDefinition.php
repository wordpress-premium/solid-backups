    ...
    */
    public function getDefaultValue()
    {
        if (array_key_exists("defaultValue", $this->_propDict)) {
            if (is_a($this->_propDict["defaultValue"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementConfigurationSettingValue")) {
    ...
    */
    public function getValueDefinition()
    {
        if (array_key_exists("valueDefinition", $this->_propDict)) {
            if (is_a($this->_propDict["valueDefinition"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeviceManagementConfigurationSettingValueDefinition")) {
