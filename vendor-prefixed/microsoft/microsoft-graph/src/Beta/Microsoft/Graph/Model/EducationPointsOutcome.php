    ...
    */
    public function getPoints()
    {
        if (array_key_exists("points", $this->_propDict)) {
            if (is_a($this->_propDict["points"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\EducationAssignmentPointsGrade")) {
    ...
    */
    public function getPublishedPoints()
    {
        if (array_key_exists("publishedPoints", $this->_propDict)) {
            if (is_a($this->_propDict["publishedPoints"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\EducationAssignmentPointsGrade")) {
