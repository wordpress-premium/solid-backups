    ...
    */
    public function getAllowInvitesFrom()
    {
        if (array_key_exists("allowInvitesFrom", $this->_propDict)) {
            if (is_a($this->_propDict["allowInvitesFrom"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AllowInvitesFrom")) {
    ...
    */
    public function getDefaultUserRolePermissions()
    {
        if (array_key_exists("defaultUserRolePermissions", $this->_propDict)) {
            if (is_a($this->_propDict["defaultUserRolePermissions"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DefaultUserRolePermissions")) {
