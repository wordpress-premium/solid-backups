    ...
    */
    public function getAllowedContentTypes()
    {
        if (array_key_exists("allowedContentTypes", $this->_propDict)) {
            if (is_a($this->_propDict["allowedContentTypes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ContentTypeInfo")) {
    ...
    */
    public function getDefaultContents()
    {
        if (array_key_exists("defaultContents", $this->_propDict)) {
            if (is_a($this->_propDict["defaultContents"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DocumentSetContent")) {
    ...
    */
    public function getSharedColumns()
    {
        if (array_key_exists("sharedColumns", $this->_propDict)) {
            if (is_a($this->_propDict["sharedColumns"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ColumnDefinition")) {
    ...
    */
    public function getWelcomePageColumns()
    {
        if (array_key_exists("welcomePageColumns", $this->_propDict)) {
            if (is_a($this->_propDict["welcomePageColumns"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ColumnDefinition")) {
