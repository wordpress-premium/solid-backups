    ...
    */
    public function getEvaluationInput()
    {
        if (array_key_exists("evaluationInput", $this->_propDict)) {
            if (is_a($this->_propDict["evaluationInput"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DlpEvaluationInput")) {
    ...
    */
    public function getNotificationInfo()
    {
        if (array_key_exists("notificationInfo", $this->_propDict)) {
            if (is_a($this->_propDict["notificationInfo"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DlpNotification")) {
