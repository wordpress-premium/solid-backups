    ...
    */
    public function getFirstOperand()
    {
        if (array_key_exists("firstOperand", $this->_propDict)) {
            if (is_a($this->_propDict["firstOperand"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ManagementConditionExpressionModel")) {
    ...
    */
    public function getOperator()
    {
        if (array_key_exists("operator", $this->_propDict)) {
            if (is_a($this->_propDict["operator"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\BinaryManagementConditionExpressionOperatorType")) {
    ...
    */
    public function getSecondOperand()
    {
        if (array_key_exists("secondOperand", $this->_propDict)) {
            if (is_a($this->_propDict["secondOperand"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ManagementConditionExpressionModel")) {
