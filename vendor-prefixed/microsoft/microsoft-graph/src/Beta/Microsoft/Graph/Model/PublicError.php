    ...
    */
    public function getDetails()
    {
        if (array_key_exists("details", $this->_propDict)) {
            if (is_a($this->_propDict["details"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PublicErrorDetail")) {
    ...
    */
    public function getInnerError()
    {
        if (array_key_exists("innerError", $this->_propDict)) {
            if (is_a($this->_propDict["innerError"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\PublicInnerError")) {
