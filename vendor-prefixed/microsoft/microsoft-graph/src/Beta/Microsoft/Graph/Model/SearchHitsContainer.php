    ...
    */
    public function getAggregations()
    {
        if (array_key_exists("aggregations", $this->_propDict)) {
            if (is_a($this->_propDict["aggregations"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SearchAggregation")) {
    ...
    */
    public function getHits()
    {
        if (array_key_exists("hits", $this->_propDict)) {
            if (is_a($this->_propDict["hits"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SearchHit")) {
