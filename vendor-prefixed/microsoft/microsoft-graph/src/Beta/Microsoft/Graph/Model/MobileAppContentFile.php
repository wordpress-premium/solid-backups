...
class MobileAppContentFile extends Entity
{
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The manifest
    */
    public function getManifest()
    {
        if (array_key_exists("manifest", $this->_propDict)) {
            if (is_a($this->_propDict["manifest"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["manifest"];
            } else {
                $this->_propDict["manifest"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["manifest"]);
                return $this->_propDict["manifest"];
            }
        }
        return null;
    ...
    * The manifest information.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The manifest
    *
    * @return MobileAppContentFile
    */
    ...
    */
    public function getUploadState()
    {
        if (array_key_exists("uploadState", $this->_propDict)) {
            if (is_a($this->_propDict["uploadState"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MobileAppContentFileUploadState")) {
