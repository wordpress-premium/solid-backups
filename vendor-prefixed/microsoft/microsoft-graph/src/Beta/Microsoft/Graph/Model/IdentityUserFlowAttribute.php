    ...
    */
    public function getDataType()
    {
        if (array_key_exists("dataType", $this->_propDict)) {
            if (is_a($this->_propDict["dataType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentityUserFlowAttributeDataType")) {
    ...
    */
    public function getUserFlowAttributeType()
    {
        if (array_key_exists("userFlowAttributeType", $this->_propDict)) {
            if (is_a($this->_propDict["userFlowAttributeType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentityUserFlowAttributeType")) {
