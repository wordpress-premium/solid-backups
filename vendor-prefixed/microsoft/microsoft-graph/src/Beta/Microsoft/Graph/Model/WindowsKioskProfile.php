    ...
    */
    public function getAppConfiguration()
    {
        if (array_key_exists("appConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["appConfiguration"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsKioskAppConfiguration")) {
    ...
    */
    public function getUserAccountsConfiguration()
    {
        if (array_key_exists("userAccountsConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["userAccountsConfiguration"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsKioskUser")) {
