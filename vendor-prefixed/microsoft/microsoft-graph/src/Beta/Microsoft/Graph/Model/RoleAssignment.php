    ...
    */
    public function getScopeType()
    {
        if (array_key_exists("scopeType", $this->_propDict)) {
            if (is_a($this->_propDict["scopeType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RoleAssignmentScopeType")) {
    ...
    */
    public function getRoleDefinition()
    {
        if (array_key_exists("roleDefinition", $this->_propDict)) {
            if (is_a($this->_propDict["roleDefinition"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RoleDefinition")) {
