    ...
    */
    public function getDlpAction()
    {
        if (array_key_exists("dlpAction", $this->_propDict)) {
            if (is_a($this->_propDict["dlpAction"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ChatMessagePolicyViolationDlpActionTypes")) {
    ...
    */
    public function getPolicyTip()
    {
        if (array_key_exists("policyTip", $this->_propDict)) {
            if (is_a($this->_propDict["policyTip"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ChatMessagePolicyViolationPolicyTip")) {
    ...
    */
    public function getUserAction()
    {
        if (array_key_exists("userAction", $this->_propDict)) {
            if (is_a($this->_propDict["userAction"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ChatMessagePolicyViolationUserActionTypes")) {
    ...
    */
    public function getVerdictDetails()
    {
        if (array_key_exists("verdictDetails", $this->_propDict)) {
            if (is_a($this->_propDict["verdictDetails"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ChatMessagePolicyViolationVerdictDetailsTypes")) {
