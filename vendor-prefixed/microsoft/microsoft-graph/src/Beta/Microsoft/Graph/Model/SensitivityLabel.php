    ...
    */
    public function getApplicableTo()
    {
        if (array_key_exists("applicableTo", $this->_propDict)) {
            if (is_a($this->_propDict["applicableTo"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SensitivityLabelTarget")) {
    ...
    */
    public function getApplicationMode()
    {
        if (array_key_exists("applicationMode", $this->_propDict)) {
            if (is_a($this->_propDict["applicationMode"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ApplicationMode")) {
    ...
    */
    public function getAutoLabeling()
    {
        if (array_key_exists("autoLabeling", $this->_propDict)) {
            if (is_a($this->_propDict["autoLabeling"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AutoLabeling")) {
