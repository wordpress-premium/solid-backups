    ...
    */
    public function getDataType()
    {
        if (array_key_exists("dataType", $this->_propDict)) {
            if (is_a($this->_propDict["dataType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AndroidManagedStoreAppConfigurationSchemaItemDataType")) {
    ...
    */
    public function getSelections()
    {
        if (array_key_exists("selections", $this->_propDict)) {
            if (is_a($this->_propDict["selections"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\KeyValuePair")) {
