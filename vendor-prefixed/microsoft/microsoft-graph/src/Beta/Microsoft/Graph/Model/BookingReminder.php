    ...
    */
    public function getOffset()
    {
        if (array_key_exists("offset", $this->_propDict)) {
            if (is_a($this->_propDict["offset"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Duration")) {
    ...
    */
    public function getRecipients()
    {
        if (array_key_exists("recipients", $this->_propDict)) {
            if (is_a($this->_propDict["recipients"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\BookingReminderRecipients")) {
