    ...
    */
    public function getAccountType()
    {
        if (array_key_exists("accountType", $this->_propDict)) {
            if (is_a($this->_propDict["accountType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\UserAccountSecurityType")) {
    ...
    */
    public function getLogonTypes()
    {
        if (array_key_exists("logonTypes", $this->_propDict)) {
            if (is_a($this->_propDict["logonTypes"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\LogonType")) {
