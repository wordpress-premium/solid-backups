...
class Windows10VpnConfiguration extends WindowsVpnConfiguration
{
    ...
    */
    public function getAuthenticationMethod()
    {
        if (array_key_exists("authenticationMethod", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationMethod"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Windows10VpnAuthenticationMethod")) {
    ...
    */
    public function getConnectionType()
    {
        if (array_key_exists("connectionType", $this->_propDict)) {
            if (is_a($this->_propDict["connectionType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Windows10VpnConnectionType")) {
    ...
    */
    public function getCryptographySuite()
    {
        if (array_key_exists("cryptographySuite", $this->_propDict)) {
            if (is_a($this->_propDict["cryptographySuite"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CryptographySuite")) {
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The eapXml
    */
    public function getEapXml()
    {
        if (array_key_exists("eapXml", $this->_propDict)) {
            if (is_a($this->_propDict["eapXml"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["eapXml"];
            } else {
                $this->_propDict["eapXml"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["eapXml"]);
                return $this->_propDict["eapXml"];
            }
        }
        return null;
    ...
    * Extensible Authentication Protocol (EAP) XML. (UTF8 encoded byte array)
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The eapXml
    *
    * @return Windows10VpnConfiguration
    */
    ...
    */
    public function getProfileTarget()
    {
        if (array_key_exists("profileTarget", $this->_propDict)) {
            if (is_a($this->_propDict["profileTarget"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Windows10VpnProfileTarget")) {
    ...
    */
    public function getProxyServer()
    {
        if (array_key_exists("proxyServer", $this->_propDict)) {
            if (is_a($this->_propDict["proxyServer"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Windows10VpnProxyServer")) {
    ...
    */
    public function getSingleSignOnEku()
    {
        if (array_key_exists("singleSignOnEku", $this->_propDict)) {
            if (is_a($this->_propDict["singleSignOnEku"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ExtendedKeyUsage")) {
    ...
    */
    public function getIdentityCertificate()
    {
        if (array_key_exists("identityCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["identityCertificate"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsCertificateProfileBase")) {
