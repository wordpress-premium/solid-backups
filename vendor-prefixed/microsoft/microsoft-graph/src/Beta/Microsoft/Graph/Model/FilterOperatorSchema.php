    ...
    */
    public function getArity()
    {
        if (array_key_exists("arity", $this->_propDict)) {
            if (is_a($this->_propDict["arity"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ScopeOperatorType")) {
    ...
    */
    public function getMultivaluedComparisonType()
    {
        if (array_key_exists("multivaluedComparisonType", $this->_propDict)) {
            if (is_a($this->_propDict["multivaluedComparisonType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ScopeOperatorMultiValuedComparisonType")) {
