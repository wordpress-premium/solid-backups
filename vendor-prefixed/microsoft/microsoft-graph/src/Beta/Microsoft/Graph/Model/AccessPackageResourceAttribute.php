    ...
    */
    public function getAttributeDestination()
    {
        if (array_key_exists("attributeDestination", $this->_propDict)) {
            if (is_a($this->_propDict["attributeDestination"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessPackageResourceAttributeDestination")) {
    ...
    */
    public function getAttributeSource()
    {
        if (array_key_exists("attributeSource", $this->_propDict)) {
            if (is_a($this->_propDict["attributeSource"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\AccessPackageResourceAttributeSource")) {
