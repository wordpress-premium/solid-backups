    ...
    */
    public function getHealthCheckStatus()
    {
        if (array_key_exists("healthCheckStatus", $this->_propDict)) {
            if (is_a($this->_propDict["healthCheckStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CloudPcOnPremisesConnectionStatus")) {
    ...
    */
    public function getHealthCheckStatusDetails()
    {
        if (array_key_exists("healthCheckStatusDetails", $this->_propDict)) {
            if (is_a($this->_propDict["healthCheckStatusDetails"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CloudPcOnPremisesConnectionStatusDetails")) {
