    ...
    */
    public function getBandwidthMode()
    {
        if (array_key_exists("bandwidthMode", $this->_propDict)) {
            if (is_a($this->_propDict["bandwidthMode"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeliveryOptimizationBandwidth")) {
    ...
    */
    public function getGroupIdSource()
    {
        if (array_key_exists("groupIdSource", $this->_propDict)) {
            if (is_a($this->_propDict["groupIdSource"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeliveryOptimizationGroupIdSource")) {
    ...
    */
    public function getMaximumCacheSize()
    {
        if (array_key_exists("maximumCacheSize", $this->_propDict)) {
            if (is_a($this->_propDict["maximumCacheSize"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeliveryOptimizationMaxCacheSize")) {
    ...
    */
    public function getRestrictPeerSelectionBy()
    {
        if (array_key_exists("restrictPeerSelectionBy", $this->_propDict)) {
            if (is_a($this->_propDict["restrictPeerSelectionBy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DeliveryOptimizationRestrictPeerSelectionByOptions")) {
    ...
    */
    public function getVpnPeerCaching()
    {
        if (array_key_exists("vpnPeerCaching", $this->_propDict)) {
            if (is_a($this->_propDict["vpnPeerCaching"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Enablement")) {
