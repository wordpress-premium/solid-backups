    ...
    */
    public function getAirPrintExceptionAction()
    {
        if (array_key_exists("airPrintExceptionAction", $this->_propDict)) {
            if (is_a($this->_propDict["airPrintExceptionAction"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnServiceExceptionAction")) {
    ...
    */
    public function getAllowedCaptiveNetworkPlugins()
    {
        if (array_key_exists("allowedCaptiveNetworkPlugins", $this->_propDict)) {
            if (is_a($this->_propDict["allowedCaptiveNetworkPlugins"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\SpecifiedCaptiveNetworkPlugins")) {
    ...
    */
    public function getCellularExceptionAction()
    {
        if (array_key_exists("cellularExceptionAction", $this->_propDict)) {
            if (is_a($this->_propDict["cellularExceptionAction"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnServiceExceptionAction")) {
    ...
    */
    public function getTunnelConfiguration()
    {
        if (array_key_exists("tunnelConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["tunnelConfiguration"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnTunnelConfigurationType")) {
    ...
    */
    public function getVoicemailExceptionAction()
    {
        if (array_key_exists("voicemailExceptionAction", $this->_propDict)) {
            if (is_a($this->_propDict["voicemailExceptionAction"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\VpnServiceExceptionAction")) {
