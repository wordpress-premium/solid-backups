    ...
    */
    public function getRanges()
    {
        if (array_key_exists("ranges", $this->_propDict)) {
            if (is_a($this->_propDict["ranges"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\BucketAggregationRange")) {
    ...
    */
    public function getSortBy()
    {
        if (array_key_exists("sortBy", $this->_propDict)) {
            if (is_a($this->_propDict["sortBy"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\BucketAggregationSortProperty")) {
