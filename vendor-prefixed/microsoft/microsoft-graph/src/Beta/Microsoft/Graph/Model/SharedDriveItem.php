    ...
    */
    public function getOwner()
    {
        if (array_key_exists("owner", $this->_propDict)) {
            if (is_a($this->_propDict["owner"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getDriveItem()
    {
        if (array_key_exists("driveItem", $this->_propDict)) {
            if (is_a($this->_propDict["driveItem"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DriveItem")) {
    ...
    */
    public function getList()
    {
        if (array_key_exists("list", $this->_propDict)) {
            if (is_a($this->_propDict["list"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\GraphList")) {
    ...
    */
    public function getPermission()
    {
        if (array_key_exists("permission", $this->_propDict)) {
            if (is_a($this->_propDict["permission"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Permission")) {
    ...
    */
    public function getRoot()
    {
        if (array_key_exists("root", $this->_propDict)) {
            if (is_a($this->_propDict["root"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\DriveItem")) {
    ...
    */
    public function getSite()
    {
        if (array_key_exists("site", $this->_propDict)) {
            if (is_a($this->_propDict["site"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Site")) {
