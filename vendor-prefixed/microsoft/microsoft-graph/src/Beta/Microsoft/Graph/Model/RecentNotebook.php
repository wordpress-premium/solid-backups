    ...
    */
    public function getLinks()
    {
        if (array_key_exists("links", $this->_propDict)) {
            if (is_a($this->_propDict["links"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\RecentNotebookLinks")) {
    ...
    */
    public function getSourceService()
    {
        if (array_key_exists("sourceService", $this->_propDict)) {
            if (is_a($this->_propDict["sourceService"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\OnenoteSourceService")) {
