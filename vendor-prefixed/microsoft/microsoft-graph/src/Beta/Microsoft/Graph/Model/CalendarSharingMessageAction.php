    ...
    */
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CalendarSharingAction")) {
    ...
    */
    public function getActionType()
    {
        if (array_key_exists("actionType", $this->_propDict)) {
            if (is_a($this->_propDict["actionType"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CalendarSharingActionType")) {
    ...
    */
    public function getImportance()
    {
        if (array_key_exists("importance", $this->_propDict)) {
            if (is_a($this->_propDict["importance"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\CalendarSharingActionImportance")) {
