    ...
    */
    public function getProvisionStatus()
    {
        if (array_key_exists("provisionStatus", $this->_propDict)) {
            if (is_a($this->_propDict["provisionStatus"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\OperationStatus")) {
    ...
    */
    public function getTimeClockSettings()
    {
        if (array_key_exists("timeClockSettings", $this->_propDict)) {
            if (is_a($this->_propDict["timeClockSettings"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\TimeClockSettings")) {
