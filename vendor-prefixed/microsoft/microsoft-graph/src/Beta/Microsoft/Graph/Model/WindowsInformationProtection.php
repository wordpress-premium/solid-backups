    ...
    */
    public function getDataRecoveryCertificate()
    {
        if (array_key_exists("dataRecoveryCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["dataRecoveryCertificate"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsInformationProtectionDataRecoveryCertificate")) {
    ...
    */
    public function getEnforcementLevel()
    {
        if (array_key_exists("enforcementLevel", $this->_propDict)) {
            if (is_a($this->_propDict["enforcementLevel"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\WindowsInformationProtectionEnforcementLevel")) {
