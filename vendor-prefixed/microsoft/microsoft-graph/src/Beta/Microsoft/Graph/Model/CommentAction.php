    ...
    */
    public function getParentAuthor()
    {
        if (array_key_exists("parentAuthor", $this->_propDict)) {
            if (is_a($this->_propDict["parentAuthor"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getParticipants()
    {
        if (array_key_exists("participants", $this->_propDict)) {
            if (is_a($this->_propDict["participants"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\IdentitySet")) {
