...
class Message extends OutlookItem
{
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The conversationIndex
    */
    public function getConversationIndex()
    {
        if (array_key_exists("conversationIndex", $this->_propDict)) {
            if (is_a($this->_propDict["conversationIndex"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["conversationIndex"];
            } else {
                $this->_propDict["conversationIndex"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["conversationIndex"]);
                return $this->_propDict["conversationIndex"];
            }
        }
        return null;
    ...
    * Indicates the position of the message within the conversation.
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The conversationIndex
    *
    * @return Message
    */
    ...
    */
    public function getFlag()
    {
        if (array_key_exists("flag", $this->_propDict)) {
            if (is_a($this->_propDict["flag"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\FollowupFlag")) {
    ...
    */
    public function getFrom()
    {
        if (array_key_exists("from", $this->_propDict)) {
            if (is_a($this->_propDict["from"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Recipient")) {
    ...
    */
    public function getInferenceClassification()
    {
        if (array_key_exists("inferenceClassification", $this->_propDict)) {
            if (is_a($this->_propDict["inferenceClassification"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\InferenceClassificationType")) {
    ...
    */
    public function getMentionsPreview()
    {
        if (array_key_exists("mentionsPreview", $this->_propDict)) {
            if (is_a($this->_propDict["mentionsPreview"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\MentionsPreview")) {
    ...
    */
    public function getSender()
    {
        if (array_key_exists("sender", $this->_propDict)) {
            if (is_a($this->_propDict["sender"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Recipient")) {
    ...
    */
    public function getUniqueBody()
    {
        if (array_key_exists("uniqueBody", $this->_propDict)) {
            if (is_a($this->_propDict["uniqueBody"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\ItemBody")) {
