...
* @link      https://graph.microsoft.com
*/
class Group extends \Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    */
    public function getScope()
    {
        if (array_key_exists("scope", $this->_propDict)) {
            if (is_a($this->_propDict["scope"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\TermStore\Model\TermGroupScope")) {
