...
* @link      https://graph.microsoft.com
*/
class Set extends \Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    * Custom properties for the set.
    *
    * @param Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\KeyValue $val The setProperties
    *
    * @return Set
    */
    ...
    */
    public function getParentGroup()
    {
        if (array_key_exists("parentGroup", $this->_propDict)) {
            if (is_a($this->_propDict["parentGroup"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\TermStore\Model\Group")) {
