...
*/
namespace Solid_Backups\Strauss\Beta\Microsoft\Graph\TermStore\Model;
...
* @link      https://graph.microsoft.com
*/
class Relation extends \Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    */
    public function getRelationship()
    {
        if (array_key_exists("relationship", $this->_propDict)) {
            if (is_a($this->_propDict["relationship"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\TermStore\Model\RelationType")) {
    ...
    */
    public function getFromTerm()
    {
        if (array_key_exists("fromTerm", $this->_propDict)) {
            if (is_a($this->_propDict["fromTerm"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\TermStore\Model\Term")) {
    ...
    */
    public function getSet()
    {
        if (array_key_exists("set", $this->_propDict)) {
            if (is_a($this->_propDict["set"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\TermStore\Model\Set")) {
    ...
    */
    public function getToTerm()
    {
        if (array_key_exists("toTerm", $this->_propDict)) {
            if (is_a($this->_propDict["toTerm"], "Solid_Backups\Strauss\Beta\Microsoft\Graph\TermStore\Model\Term")) {
