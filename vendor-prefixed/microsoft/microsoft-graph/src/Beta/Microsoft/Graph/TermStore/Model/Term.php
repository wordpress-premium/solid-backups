...
* @link      https://graph.microsoft.com
*/
class Term extends \Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    * Collection of properties on the term
    *
    * @param Solid_Backups\Strauss\Beta\Microsoft\Graph\Model\KeyValue $val The termProperties
    *
    * @return Term
    */
