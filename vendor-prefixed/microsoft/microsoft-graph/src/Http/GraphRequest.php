...
namespace Solid_Backups\Strauss\Microsoft\Graph\Http;

use Solid_Backups\Strauss\GuzzleHttp\Client;
use Solid_Backups\Strauss\Microsoft\Graph\Core\GraphConstants;
use Solid_Backups\Strauss\Microsoft\Graph\Exception\GraphException;
...
class GraphRequest
{
    ...
    */
    public function setReturnType($returnClass)
    {
        ...
        if ($this->returnType == "Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream") {
    ...
    */
    public function attachBody($obj)
    {
        ...
        if (is_string($obj) || is_a($obj, 'Solid_Backups\\Strauss\\GuzzleHttp\\Psr7\\Stream')) {
    ...
    public function upload($path, $client = null)
    {
        ...
        try {
            if (file_exists($path) && is_readable($path)) {
                $file = fopen($path, 'r');
                $stream = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($file);
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Client The new client
    */
