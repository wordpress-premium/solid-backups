    ...
    */
    public function getPasswordRequiredType()
    {
        if (array_key_exists("passwordRequiredType", $this->_propDict)) {
            if (is_a($this->_propDict["passwordRequiredType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AndroidWorkProfileRequiredPasswordType")) {
    ...
    */
    public function getWorkProfileDataSharingType()
    {
        if (array_key_exists("workProfileDataSharingType", $this->_propDict)) {
            if (is_a($this->_propDict["workProfileDataSharingType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AndroidWorkProfileCrossProfileDataSharingType")) {
    ...
    */
    public function getWorkProfileDefaultAppPermissionPolicy()
    {
        if (array_key_exists("workProfileDefaultAppPermissionPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["workProfileDefaultAppPermissionPolicy"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AndroidWorkProfileDefaultAppPermissionPolicyType")) {
    ...
    */
    public function getWorkProfilePasswordRequiredType()
    {
        if (array_key_exists("workProfilePasswordRequiredType", $this->_propDict)) {
            if (is_a($this->_propDict["workProfilePasswordRequiredType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AndroidWorkProfileRequiredPasswordType")) {
