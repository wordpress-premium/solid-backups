    ...
    */
    public function getEncryption()
    {
        if (array_key_exists("encryption", $this->_propDict)) {
            if (is_a($this->_propDict["encryption"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkforceIntegrationEncryption")) {
    ...
    */
    public function getSupportedEntities()
    {
        if (array_key_exists("supportedEntities", $this->_propDict)) {
            if (is_a($this->_propDict["supportedEntities"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkforceIntegrationSupportedEntities")) {
