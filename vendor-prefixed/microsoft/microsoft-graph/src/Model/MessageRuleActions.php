    ...
    */
    public function getForwardAsAttachmentTo()
    {
        if (array_key_exists("forwardAsAttachmentTo", $this->_propDict)) {
            if (is_a($this->_propDict["forwardAsAttachmentTo"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Recipient")) {
    ...
    */
    public function getForwardTo()
    {
        if (array_key_exists("forwardTo", $this->_propDict)) {
            if (is_a($this->_propDict["forwardTo"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Recipient")) {
    ...
    */
    public function getMarkImportance()
    {
        if (array_key_exists("markImportance", $this->_propDict)) {
            if (is_a($this->_propDict["markImportance"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Importance")) {
    ...
    */
    public function getRedirectTo()
    {
        if (array_key_exists("redirectTo", $this->_propDict)) {
            if (is_a($this->_propDict["redirectTo"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Recipient")) {
