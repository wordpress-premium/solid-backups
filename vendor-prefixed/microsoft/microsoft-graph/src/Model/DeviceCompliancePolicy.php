    ...
    */
    public function getDeviceStatusOverview()
    {
        if (array_key_exists("deviceStatusOverview", $this->_propDict)) {
            if (is_a($this->_propDict["deviceStatusOverview"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DeviceComplianceDeviceOverview")) {
    ...
    */
    public function getUserStatusOverview()
    {
        if (array_key_exists("userStatusOverview", $this->_propDict)) {
            if (is_a($this->_propDict["userStatusOverview"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DeviceComplianceUserOverview")) {
