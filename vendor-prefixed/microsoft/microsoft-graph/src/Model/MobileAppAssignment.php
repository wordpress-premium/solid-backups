    ...
    */
    public function getIntent()
    {
        if (array_key_exists("intent", $this->_propDict)) {
            if (is_a($this->_propDict["intent"], "Solid_Backups\Strauss\Microsoft\Graph\Model\InstallIntent")) {
    ...
    */
    public function getSettings()
    {
        if (array_key_exists("settings", $this->_propDict)) {
            if (is_a($this->_propDict["settings"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MobileAppAssignmentSettings")) {
    ...
    */
    public function getTarget()
    {
        if (array_key_exists("target", $this->_propDict)) {
            if (is_a($this->_propDict["target"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DeviceAndAppManagementAssignmentTarget")) {
