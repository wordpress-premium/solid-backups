    ...
    */
    public function getColorModes()
    {
        if (array_key_exists("colorModes", $this->_propDict)) {
            if (is_a($this->_propDict["colorModes"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrintColorMode")) {
    ...
    */
    public function getCopiesPerJob()
    {
        if (array_key_exists("copiesPerJob", $this->_propDict)) {
            if (is_a($this->_propDict["copiesPerJob"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IntegerRange")) {
    ...
    */
    public function getDuplexModes()
    {
        if (array_key_exists("duplexModes", $this->_propDict)) {
            if (is_a($this->_propDict["duplexModes"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrintDuplexMode")) {
    ...
    */
    public function getFeedOrientations()
    {
        if (array_key_exists("feedOrientations", $this->_propDict)) {
            if (is_a($this->_propDict["feedOrientations"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrinterFeedOrientation")) {
    ...
    */
    public function getMultipageLayouts()
    {
        if (array_key_exists("multipageLayouts", $this->_propDict)) {
            if (is_a($this->_propDict["multipageLayouts"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrintMultipageLayout")) {
    ...
    */
    public function getOrientations()
    {
        if (array_key_exists("orientations", $this->_propDict)) {
            if (is_a($this->_propDict["orientations"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrintOrientation")) {
    ...
    */
    public function getQualities()
    {
        if (array_key_exists("qualities", $this->_propDict)) {
            if (is_a($this->_propDict["qualities"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrintQuality")) {
    ...
    */
    public function getScalings()
    {
        if (array_key_exists("scalings", $this->_propDict)) {
            if (is_a($this->_propDict["scalings"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrintScaling")) {
