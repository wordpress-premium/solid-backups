    ...
    */
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "Solid_Backups\Strauss\Microsoft\Graph\Model\FreeBusyError")) {
    ...
    */
    public function getScheduleItems()
    {
        if (array_key_exists("scheduleItems", $this->_propDict)) {
            if (is_a($this->_propDict["scheduleItems"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ScheduleItem")) {
