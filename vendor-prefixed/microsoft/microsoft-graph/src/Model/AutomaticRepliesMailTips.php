    ...
    */
    public function getMessageLanguage()
    {
        if (array_key_exists("messageLanguage", $this->_propDict)) {
            if (is_a($this->_propDict["messageLanguage"], "Solid_Backups\Strauss\Microsoft\Graph\Model\LocaleInfo")) {
    ...
    */
    public function getScheduledEndTime()
    {
        if (array_key_exists("scheduledEndTime", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledEndTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DateTimeTimeZone")) {
    ...
    */
    public function getScheduledStartTime()
    {
        if (array_key_exists("scheduledStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledStartTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DateTimeTimeZone")) {
