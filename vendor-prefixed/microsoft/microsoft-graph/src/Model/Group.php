    ...
    */
    public function getLicenseProcessingState()
    {
        if (array_key_exists("licenseProcessingState", $this->_propDict)) {
            if (is_a($this->_propDict["licenseProcessingState"], "Solid_Backups\Strauss\Microsoft\Graph\Model\LicenseProcessingState")) {
    ...
    */
    public function getPlanner()
    {
        if (array_key_exists("planner", $this->_propDict)) {
            if (is_a($this->_propDict["planner"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PlannerGroup")) {
    ...
    */
    public function getTeam()
    {
        if (array_key_exists("team", $this->_propDict)) {
            if (is_a($this->_propDict["team"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Team")) {
