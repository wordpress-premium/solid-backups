    ...
    */
    public function getAccountManagerPolicy()
    {
        if (array_key_exists("accountManagerPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["accountManagerPolicy"], "Solid_Backups\Strauss\Microsoft\Graph\Model\SharedPCAccountManagerPolicy")) {
    ...
    */
    public function getAllowedAccounts()
    {
        if (array_key_exists("allowedAccounts", $this->_propDict)) {
            if (is_a($this->_propDict["allowedAccounts"], "Solid_Backups\Strauss\Microsoft\Graph\Model\SharedPCAllowedAccountType")) {
    ...
    */
    public function getMaintenanceStartTime()
    {
        if (array_key_exists("maintenanceStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["maintenanceStartTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\TimeOfDay")) {
