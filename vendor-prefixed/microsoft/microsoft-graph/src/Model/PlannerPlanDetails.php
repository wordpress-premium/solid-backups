    ...
    */
    public function getCategoryDescriptions()
    {
        if (array_key_exists("categoryDescriptions", $this->_propDict)) {
            if (is_a($this->_propDict["categoryDescriptions"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PlannerCategoryDescriptions")) {
    ...
    */
    public function getSharedWith()
    {
        if (array_key_exists("sharedWith", $this->_propDict)) {
            if (is_a($this->_propDict["sharedWith"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PlannerUserIds")) {
