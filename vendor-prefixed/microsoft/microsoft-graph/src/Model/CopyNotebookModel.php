    ...
    */
    public function getCreatedByIdentity()
    {
        if (array_key_exists("createdByIdentity", $this->_propDict)) {
            if (is_a($this->_propDict["createdByIdentity"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getLastModifiedByIdentity()
    {
        if (array_key_exists("lastModifiedByIdentity", $this->_propDict)) {
            if (is_a($this->_propDict["lastModifiedByIdentity"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getLinks()
    {
        if (array_key_exists("links", $this->_propDict)) {
            if (is_a($this->_propDict["links"], "Solid_Backups\Strauss\Microsoft\Graph\Model\NotebookLinks")) {
    ...
    */
    public function getUserRole()
    {
        if (array_key_exists("userRole", $this->_propDict)) {
            if (is_a($this->_propDict["userRole"], "Solid_Backups\Strauss\Microsoft\Graph\Model\OnenoteUserRole")) {
