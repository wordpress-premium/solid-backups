    ...
    */
    public function getConditions()
    {
        if (array_key_exists("conditions", $this->_propDict)) {
            if (is_a($this->_propDict["conditions"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ConditionalAccessConditionSet")) {
    ...
    */
    public function getGrantControls()
    {
        if (array_key_exists("grantControls", $this->_propDict)) {
            if (is_a($this->_propDict["grantControls"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ConditionalAccessGrantControls")) {
    ...
    */
    public function getSessionControls()
    {
        if (array_key_exists("sessionControls", $this->_propDict)) {
            if (is_a($this->_propDict["sessionControls"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ConditionalAccessSessionControls")) {
    ...
    */
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ConditionalAccessPolicyState")) {
