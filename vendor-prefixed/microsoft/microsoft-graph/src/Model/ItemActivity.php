    ...
    */
    public function getAccess()
    {
        if (array_key_exists("access", $this->_propDict)) {
            if (is_a($this->_propDict["access"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AccessAction")) {
    ...
    */
    public function getActor()
    {
        if (array_key_exists("actor", $this->_propDict)) {
            if (is_a($this->_propDict["actor"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet")) {
