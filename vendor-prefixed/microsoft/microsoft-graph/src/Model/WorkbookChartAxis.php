    ...
    */
    public function getFormat()
    {
        if (array_key_exists("format", $this->_propDict)) {
            if (is_a($this->_propDict["format"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkbookChartAxisFormat")) {
    ...
    */
    public function getMajorGridlines()
    {
        if (array_key_exists("majorGridlines", $this->_propDict)) {
            if (is_a($this->_propDict["majorGridlines"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkbookChartGridlines")) {
    ...
    */
    public function getMinorGridlines()
    {
        if (array_key_exists("minorGridlines", $this->_propDict)) {
            if (is_a($this->_propDict["minorGridlines"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkbookChartGridlines")) {
    ...
    */
    public function getTitle()
    {
        if (array_key_exists("title", $this->_propDict)) {
            if (is_a($this->_propDict["title"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkbookChartAxisTitle")) {
