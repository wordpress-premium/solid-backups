    ...
    */
    public function getApplicableArchitectures()
    {
        if (array_key_exists("applicableArchitectures", $this->_propDict)) {
            if (is_a($this->_propDict["applicableArchitectures"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WindowsArchitecture")) {
    ...
    */
    public function getApplicableDeviceTypes()
    {
        if (array_key_exists("applicableDeviceTypes", $this->_propDict)) {
            if (is_a($this->_propDict["applicableDeviceTypes"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WindowsDeviceType")) {
    ...
    */
    public function getMinimumSupportedOperatingSystem()
    {
        if (array_key_exists("minimumSupportedOperatingSystem", $this->_propDict)) {
            if (is_a($this->_propDict["minimumSupportedOperatingSystem"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WindowsMinimumOperatingSystem")) {
