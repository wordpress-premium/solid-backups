    ...
    */
    public function getFrom()
    {
        if (array_key_exists("from", $this->_propDict)) {
            if (is_a($this->_propDict["from"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getImportance()
    {
        if (array_key_exists("importance", $this->_propDict)) {
            if (is_a($this->_propDict["importance"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ChatMessageImportance")) {
    ...
    */
    public function getMessageType()
    {
        if (array_key_exists("messageType", $this->_propDict)) {
            if (is_a($this->_propDict["messageType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ChatMessageType")) {
    ...
    */
    public function getPolicyViolation()
    {
        if (array_key_exists("policyViolation", $this->_propDict)) {
            if (is_a($this->_propDict["policyViolation"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ChatMessagePolicyViolation")) {
