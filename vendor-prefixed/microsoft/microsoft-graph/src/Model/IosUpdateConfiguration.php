    ...
    */
    public function getActiveHoursEnd()
    {
        if (array_key_exists("activeHoursEnd", $this->_propDict)) {
            if (is_a($this->_propDict["activeHoursEnd"], "Solid_Backups\Strauss\Microsoft\Graph\Model\TimeOfDay")) {
    ...
    */
    public function getActiveHoursStart()
    {
        if (array_key_exists("activeHoursStart", $this->_propDict)) {
            if (is_a($this->_propDict["activeHoursStart"], "Solid_Backups\Strauss\Microsoft\Graph\Model\TimeOfDay")) {
