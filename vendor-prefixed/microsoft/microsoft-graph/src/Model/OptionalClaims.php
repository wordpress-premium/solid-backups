    ...
    */
    public function getAccessToken()
    {
        if (array_key_exists("accessToken", $this->_propDict)) {
            if (is_a($this->_propDict["accessToken"], "Solid_Backups\Strauss\Microsoft\Graph\Model\OptionalClaim")) {
    ...
    */
    public function getIdToken()
    {
        if (array_key_exists("idToken", $this->_propDict)) {
            if (is_a($this->_propDict["idToken"], "Solid_Backups\Strauss\Microsoft\Graph\Model\OptionalClaim")) {
    ...
    */
    public function getSaml2Token()
    {
        if (array_key_exists("saml2Token", $this->_propDict)) {
            if (is_a($this->_propDict["saml2Token"], "Solid_Backups\Strauss\Microsoft\Graph\Model\OptionalClaim")) {
