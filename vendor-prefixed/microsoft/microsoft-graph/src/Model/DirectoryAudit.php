    ...
    */
    public function getInitiatedBy()
    {
        if (array_key_exists("initiatedBy", $this->_propDict)) {
            if (is_a($this->_propDict["initiatedBy"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AuditActivityInitiator")) {
    ...
    */
    public function getResult()
    {
        if (array_key_exists("result", $this->_propDict)) {
            if (is_a($this->_propDict["result"], "Solid_Backups\Strauss\Microsoft\Graph\Model\OperationResult")) {
