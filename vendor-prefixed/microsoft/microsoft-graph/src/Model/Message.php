    ...
    */
    public function getFlag()
    {
        if (array_key_exists("flag", $this->_propDict)) {
            if (is_a($this->_propDict["flag"], "Solid_Backups\Strauss\Microsoft\Graph\Model\FollowupFlag")) {
    ...
    */
    public function getFrom()
    {
        if (array_key_exists("from", $this->_propDict)) {
            if (is_a($this->_propDict["from"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Recipient")) {
    ...
    */
    public function getInferenceClassification()
    {
        if (array_key_exists("inferenceClassification", $this->_propDict)) {
            if (is_a($this->_propDict["inferenceClassification"], "Solid_Backups\Strauss\Microsoft\Graph\Model\InferenceClassificationType")) {
    ...
    */
    public function getSender()
    {
        if (array_key_exists("sender", $this->_propDict)) {
            if (is_a($this->_propDict["sender"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Recipient")) {
    ...
    */
    public function getUniqueBody()
    {
        if (array_key_exists("uniqueBody", $this->_propDict)) {
            if (is_a($this->_propDict["uniqueBody"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ItemBody")) {
