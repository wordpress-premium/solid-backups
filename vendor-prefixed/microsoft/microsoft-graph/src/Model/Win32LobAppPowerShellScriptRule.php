    ...
    */
    public function getOperationType()
    {
        if (array_key_exists("operationType", $this->_propDict)) {
            if (is_a($this->_propDict["operationType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Win32LobAppPowerShellScriptRuleOperationType")) {
    ...
    */
    public function getOperator()
    {
        if (array_key_exists("operator", $this->_propDict)) {
            if (is_a($this->_propDict["operator"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Win32LobAppRuleOperator")) {
    ...
    */
    public function getRunAsAccount()
    {
        if (array_key_exists("runAsAccount", $this->_propDict)) {
            if (is_a($this->_propDict["runAsAccount"], "Solid_Backups\Strauss\Microsoft\Graph\Model\RunAsAccountType")) {
