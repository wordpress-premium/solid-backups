    ...
    */
    public function getInitiator()
    {
        if (array_key_exists("initiator", $this->_propDict)) {
            if (is_a($this->_propDict["initiator"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getRecordingStatus()
    {
        if (array_key_exists("recordingStatus", $this->_propDict)) {
            if (is_a($this->_propDict["recordingStatus"], "Solid_Backups\Strauss\Microsoft\Graph\Model\RecordingStatus")) {
