    ...
    */
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PublicError")) {
    ...
    */
    public function getSiteCollection()
    {
        if (array_key_exists("siteCollection", $this->_propDict)) {
            if (is_a($this->_propDict["siteCollection"], "Solid_Backups\Strauss\Microsoft\Graph\Model\SiteCollection")) {
