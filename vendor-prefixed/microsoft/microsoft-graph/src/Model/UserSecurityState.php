    ...
    */
    public function getEmailRole()
    {
        if (array_key_exists("emailRole", $this->_propDict)) {
            if (is_a($this->_propDict["emailRole"], "Solid_Backups\Strauss\Microsoft\Graph\Model\EmailRole")) {
    ...
    */
    public function getLogonType()
    {
        if (array_key_exists("logonType", $this->_propDict)) {
            if (is_a($this->_propDict["logonType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\LogonType")) {
    ...
    */
    public function getUserAccountType()
    {
        if (array_key_exists("userAccountType", $this->_propDict)) {
            if (is_a($this->_propDict["userAccountType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\UserAccountSecurityType")) {
