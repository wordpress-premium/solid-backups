    ...
    */
    public function getBusinessAddress()
    {
        if (array_key_exists("businessAddress", $this->_propDict)) {
            if (is_a($this->_propDict["businessAddress"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PhysicalAddress")) {
    ...
    */
    public function getHomeAddress()
    {
        if (array_key_exists("homeAddress", $this->_propDict)) {
            if (is_a($this->_propDict["homeAddress"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PhysicalAddress")) {
    ...
    */
    public function getOtherAddress()
    {
        if (array_key_exists("otherAddress", $this->_propDict)) {
            if (is_a($this->_propDict["otherAddress"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PhysicalAddress")) {
