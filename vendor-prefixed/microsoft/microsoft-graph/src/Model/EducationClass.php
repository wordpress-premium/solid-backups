    ...
    */
    public function getCourse()
    {
        if (array_key_exists("course", $this->_propDict)) {
            if (is_a($this->_propDict["course"], "Solid_Backups\Strauss\Microsoft\Graph\Model\EducationCourse")) {
    ...
    */
    public function getExternalSource()
    {
        if (array_key_exists("externalSource", $this->_propDict)) {
            if (is_a($this->_propDict["externalSource"], "Solid_Backups\Strauss\Microsoft\Graph\Model\EducationExternalSource")) {
    ...
    */
    public function getTerm()
    {
        if (array_key_exists("term", $this->_propDict)) {
            if (is_a($this->_propDict["term"], "Solid_Backups\Strauss\Microsoft\Graph\Model\EducationTerm")) {
