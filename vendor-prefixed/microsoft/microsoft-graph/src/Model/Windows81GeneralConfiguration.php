    ...
    */
    public function getBrowserInternetSecurityLevel()
    {
        if (array_key_exists("browserInternetSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserInternetSecurityLevel"], "Solid_Backups\Strauss\Microsoft\Graph\Model\InternetSiteSecurityLevel")) {
    ...
    */
    public function getBrowserIntranetSecurityLevel()
    {
        if (array_key_exists("browserIntranetSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserIntranetSecurityLevel"], "Solid_Backups\Strauss\Microsoft\Graph\Model\SiteSecurityLevel")) {
    ...
    */
    public function getBrowserTrustedSitesSecurityLevel()
    {
        if (array_key_exists("browserTrustedSitesSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserTrustedSitesSecurityLevel"], "Solid_Backups\Strauss\Microsoft\Graph\Model\SiteSecurityLevel")) {
    ...
    */
    public function getUserAccountControlSettings()
    {
        if (array_key_exists("userAccountControlSettings", $this->_propDict)) {
            if (is_a($this->_propDict["userAccountControlSettings"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WindowsUserAccountControlSettings")) {
