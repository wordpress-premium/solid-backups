    ...
    */
    public function getCategoryAxis()
    {
        if (array_key_exists("categoryAxis", $this->_propDict)) {
            if (is_a($this->_propDict["categoryAxis"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkbookChartAxis")) {
    ...
    */
    public function getSeriesAxis()
    {
        if (array_key_exists("seriesAxis", $this->_propDict)) {
            if (is_a($this->_propDict["seriesAxis"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkbookChartAxis")) {
    ...
    */
    public function getValueAxis()
    {
        if (array_key_exists("valueAxis", $this->_propDict)) {
            if (is_a($this->_propDict["valueAxis"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkbookChartAxis")) {
