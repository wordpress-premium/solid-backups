    ...
    */
    public function getAllowedPresenters()
    {
        if (array_key_exists("allowedPresenters", $this->_propDict)) {
            if (is_a($this->_propDict["allowedPresenters"], "Solid_Backups\Strauss\Microsoft\Graph\Model\OnlineMeetingPresenters")) {
    ...
    */
    public function getAudioConferencing()
    {
        if (array_key_exists("audioConferencing", $this->_propDict)) {
            if (is_a($this->_propDict["audioConferencing"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AudioConferencing")) {
    ...
    */
    public function getJoinInformation()
    {
        if (array_key_exists("joinInformation", $this->_propDict)) {
            if (is_a($this->_propDict["joinInformation"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ItemBody")) {
    ...
    */
    public function getLobbyBypassSettings()
    {
        if (array_key_exists("lobbyBypassSettings", $this->_propDict)) {
            if (is_a($this->_propDict["lobbyBypassSettings"], "Solid_Backups\Strauss\Microsoft\Graph\Model\LobbyBypassSettings")) {
    ...
    */
    public function getParticipants()
    {
        if (array_key_exists("participants", $this->_propDict)) {
            if (is_a($this->_propDict["participants"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MeetingParticipants")) {
