    ...
    */
    public function getApplicableDeviceType()
    {
        if (array_key_exists("applicableDeviceType", $this->_propDict)) {
            if (is_a($this->_propDict["applicableDeviceType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IosDeviceType")) {
    ...
    */
    public function getLicensingType()
    {
        if (array_key_exists("licensingType", $this->_propDict)) {
            if (is_a($this->_propDict["licensingType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\VppLicensingType")) {
    ...
    */
    public function getVppTokenAccountType()
    {
        if (array_key_exists("vppTokenAccountType", $this->_propDict)) {
            if (is_a($this->_propDict["vppTokenAccountType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\VppTokenAccountType")) {
