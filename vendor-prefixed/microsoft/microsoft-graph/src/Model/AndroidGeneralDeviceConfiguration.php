    ...
    */
    public function getPasswordRequiredType()
    {
        if (array_key_exists("passwordRequiredType", $this->_propDict)) {
            if (is_a($this->_propDict["passwordRequiredType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AndroidRequiredPasswordType")) {
    ...
    */
    public function getWebBrowserCookieSettings()
    {
        if (array_key_exists("webBrowserCookieSettings", $this->_propDict)) {
            if (is_a($this->_propDict["webBrowserCookieSettings"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WebBrowserCookieSettings")) {
