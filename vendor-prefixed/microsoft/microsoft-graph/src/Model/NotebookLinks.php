    ...
    */
    public function getOneNoteClientUrl()
    {
        if (array_key_exists("oneNoteClientUrl", $this->_propDict)) {
            if (is_a($this->_propDict["oneNoteClientUrl"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ExternalLink")) {
    ...
    */
    public function getOneNoteWebUrl()
    {
        if (array_key_exists("oneNoteWebUrl", $this->_propDict)) {
            if (is_a($this->_propDict["oneNoteWebUrl"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ExternalLink")) {
