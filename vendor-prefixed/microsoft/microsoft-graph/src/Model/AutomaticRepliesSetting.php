    ...
    */
    public function getExternalAudience()
    {
        if (array_key_exists("externalAudience", $this->_propDict)) {
            if (is_a($this->_propDict["externalAudience"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ExternalAudienceScope")) {
    ...
    */
    public function getScheduledEndDateTime()
    {
        if (array_key_exists("scheduledEndDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledEndDateTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DateTimeTimeZone")) {
    ...
    */
    public function getScheduledStartDateTime()
    {
        if (array_key_exists("scheduledStartDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledStartDateTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DateTimeTimeZone")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AutomaticRepliesStatus")) {
