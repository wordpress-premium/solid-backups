    ...
    */
    public function getB()
    {
        if (array_key_exists("b", $this->_propDict)) {
            if (is_a($this->_propDict["b"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Byte")) {
    ...
    */
    public function getG()
    {
        if (array_key_exists("g", $this->_propDict)) {
            if (is_a($this->_propDict["g"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Byte")) {
    ...
    */
    public function getR()
    {
        if (array_key_exists("r", $this->_propDict)) {
            if (is_a($this->_propDict["r"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Byte")) {
