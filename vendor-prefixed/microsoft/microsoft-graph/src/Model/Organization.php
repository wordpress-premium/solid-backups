    ...
    */
    public function getPrivacyProfile()
    {
        if (array_key_exists("privacyProfile", $this->_propDict)) {
            if (is_a($this->_propDict["privacyProfile"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrivacyProfile")) {
    ...
    */
    public function getMobileDeviceManagementAuthority()
    {
        if (array_key_exists("mobileDeviceManagementAuthority", $this->_propDict)) {
            if (is_a($this->_propDict["mobileDeviceManagementAuthority"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MdmAuthority")) {
    ...
    */
    public function getBranding()
    {
        if (array_key_exists("branding", $this->_propDict)) {
            if (is_a($this->_propDict["branding"], "Solid_Backups\Strauss\Microsoft\Graph\Model\OrganizationalBranding")) {
