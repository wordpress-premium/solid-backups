    ...
    */
    public function getPartnerAppType()
    {
        if (array_key_exists("partnerAppType", $this->_propDict)) {
            if (is_a($this->_propDict["partnerAppType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DeviceManagementPartnerAppType")) {
    ...
    */
    public function getPartnerState()
    {
        if (array_key_exists("partnerState", $this->_propDict)) {
            if (is_a($this->_propDict["partnerState"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DeviceManagementPartnerTenantState")) {
