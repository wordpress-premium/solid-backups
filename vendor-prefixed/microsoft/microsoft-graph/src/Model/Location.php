    ...
    */
    public function getAddress()
    {
        if (array_key_exists("address", $this->_propDict)) {
            if (is_a($this->_propDict["address"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PhysicalAddress")) {
    ...
    */
    public function getCoordinates()
    {
        if (array_key_exists("coordinates", $this->_propDict)) {
            if (is_a($this->_propDict["coordinates"], "Solid_Backups\Strauss\Microsoft\Graph\Model\OutlookGeoCoordinates")) {
    ...
    */
    public function getLocationType()
    {
        if (array_key_exists("locationType", $this->_propDict)) {
            if (is_a($this->_propDict["locationType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\LocationType")) {
    ...
    */
    public function getUniqueIdType()
    {
        if (array_key_exists("uniqueIdType", $this->_propDict)) {
            if (is_a($this->_propDict["uniqueIdType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\LocationUniqueIdType")) {
