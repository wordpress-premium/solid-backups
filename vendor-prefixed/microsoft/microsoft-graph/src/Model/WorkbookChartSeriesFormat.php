    ...
    */
    public function getFill()
    {
        if (array_key_exists("fill", $this->_propDict)) {
            if (is_a($this->_propDict["fill"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkbookChartFill")) {
    ...
    */
    public function getLine()
    {
        if (array_key_exists("line", $this->_propDict)) {
            if (is_a($this->_propDict["line"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WorkbookChartLineFormat")) {
