    ...
    */
    public function getApplication()
    {
        if (array_key_exists("application", $this->_propDict)) {
            if (is_a($this->_propDict["application"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Application")) {
    ...
    */
    public function getServicePrincipal()
    {
        if (array_key_exists("servicePrincipal", $this->_propDict)) {
            if (is_a($this->_propDict["servicePrincipal"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ServicePrincipal")) {
