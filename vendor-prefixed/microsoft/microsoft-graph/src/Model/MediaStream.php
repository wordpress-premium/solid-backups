    ...
    */
    public function getDirection()
    {
        if (array_key_exists("direction", $this->_propDict)) {
            if (is_a($this->_propDict["direction"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MediaDirection")) {
    ...
    */
    public function getMediaType()
    {
        if (array_key_exists("mediaType", $this->_propDict)) {
            if (is_a($this->_propDict["mediaType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Modality")) {
