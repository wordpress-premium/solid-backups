    ...
    */
    public function getProposedNewTime()
    {
        if (array_key_exists("proposedNewTime", $this->_propDict)) {
            if (is_a($this->_propDict["proposedNewTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\TimeSlot")) {
    ...
    */
    public function getResponseType()
    {
        if (array_key_exists("responseType", $this->_propDict)) {
            if (is_a($this->_propDict["responseType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ResponseType")) {
