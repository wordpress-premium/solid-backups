    ...
    */
    public function getAttendees()
    {
        if (array_key_exists("attendees", $this->_propDict)) {
            if (is_a($this->_propDict["attendees"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MeetingParticipantInfo")) {
    ...
    */
    public function getOrganizer()
    {
        if (array_key_exists("organizer", $this->_propDict)) {
            if (is_a($this->_propDict["organizer"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MeetingParticipantInfo")) {
