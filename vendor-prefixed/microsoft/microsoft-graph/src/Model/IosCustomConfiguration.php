...
class IosCustomConfiguration extends DeviceConfiguration
{
    ...
    *
    * @return \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream The payload
    */
    public function getPayload()
    {
        if (array_key_exists("payload", $this->_propDict)) {
            if (is_a($this->_propDict["payload"], "\Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream")) {
                return $this->_propDict["payload"];
            } else {
                $this->_propDict["payload"] = \Solid_Backups\Strauss\GuzzleHttp\Psr7\stream_for($this->_propDict["payload"]);
                return $this->_propDict["payload"];
            }
        }
        return null;
    ...
    * Payload. (UTF8 encoded byte array)
    *
    * @param \Solid_Backups\Strauss\GuzzleHttp\Psr7\Stream $val The payload
    *
