    ...
    */
    public function getEmailAddress()
    {
        if (array_key_exists("emailAddress", $this->_propDict)) {
            if (is_a($this->_propDict["emailAddress"], "Solid_Backups\Strauss\Microsoft\Graph\Model\EmailAddress")) {
    ...
    */
    public function getRole()
    {
        if (array_key_exists("role", $this->_propDict)) {
            if (is_a($this->_propDict["role"], "Solid_Backups\Strauss\Microsoft\Graph\Model\CalendarRoleType")) {
