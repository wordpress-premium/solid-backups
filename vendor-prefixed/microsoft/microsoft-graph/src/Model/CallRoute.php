    ...
    */
    public function getFinal()
    {
        if (array_key_exists("final", $this->_propDict)) {
            if (is_a($this->_propDict["final"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getOriginal()
    {
        if (array_key_exists("original", $this->_propDict)) {
            if (is_a($this->_propDict["original"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySet")) {
    ...
    */
    public function getRoutingType()
    {
        if (array_key_exists("routingType", $this->_propDict)) {
            if (is_a($this->_propDict["routingType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\RoutingType")) {
