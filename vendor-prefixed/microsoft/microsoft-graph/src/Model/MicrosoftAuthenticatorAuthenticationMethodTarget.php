    ...
    */
    public function getAuthenticationMode()
    {
        if (array_key_exists("authenticationMode", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationMode"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MicrosoftAuthenticatorAuthenticationMode")) {
    ...
    */
    public function getFeatureSettings()
    {
        if (array_key_exists("featureSettings", $this->_propDict)) {
            if (is_a($this->_propDict["featureSettings"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AuthenticatorAppFeatureSettings")) {
