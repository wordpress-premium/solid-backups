    ...
    */
    public function getKeyStrength()
    {
        if (array_key_exists("keyStrength", $this->_propDict)) {
            if (is_a($this->_propDict["keyStrength"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AuthenticationMethodKeyStrength")) {
    ...
    */
    public function getDevice()
    {
        if (array_key_exists("device", $this->_propDict)) {
            if (is_a($this->_propDict["device"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Device")) {
