    ...
    */
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "Solid_Backups\Strauss\Microsoft\Graph\Model\OnenotePatchActionType")) {
    ...
    */
    public function getPosition()
    {
        if (array_key_exists("position", $this->_propDict)) {
            if (is_a($this->_propDict["position"], "Solid_Backups\Strauss\Microsoft\Graph\Model\OnenotePatchInsertPosition")) {
