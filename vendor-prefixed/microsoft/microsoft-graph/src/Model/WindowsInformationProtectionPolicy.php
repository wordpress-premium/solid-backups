    ...
    */
    public function getPinLowercaseLetters()
    {
        if (array_key_exists("pinLowercaseLetters", $this->_propDict)) {
            if (is_a($this->_propDict["pinLowercaseLetters"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WindowsInformationProtectionPinCharacterRequirements")) {
    ...
    */
    public function getPinSpecialCharacters()
    {
        if (array_key_exists("pinSpecialCharacters", $this->_propDict)) {
            if (is_a($this->_propDict["pinSpecialCharacters"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WindowsInformationProtectionPinCharacterRequirements")) {
    ...
    */
    public function getPinUppercaseLetters()
    {
        if (array_key_exists("pinUppercaseLetters", $this->_propDict)) {
            if (is_a($this->_propDict["pinUppercaseLetters"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WindowsInformationProtectionPinCharacterRequirements")) {
