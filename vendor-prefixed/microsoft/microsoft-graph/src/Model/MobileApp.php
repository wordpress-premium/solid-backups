    ...
    */
    public function getLargeIcon()
    {
        if (array_key_exists("largeIcon", $this->_propDict)) {
            if (is_a($this->_propDict["largeIcon"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MimeContent")) {
    ...
    */
    public function getPublishingState()
    {
        if (array_key_exists("publishingState", $this->_propDict)) {
            if (is_a($this->_propDict["publishingState"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MobileAppPublishingState")) {
