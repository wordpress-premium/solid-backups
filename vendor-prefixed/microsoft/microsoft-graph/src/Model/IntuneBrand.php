    ...
    */
    public function getDarkBackgroundLogo()
    {
        if (array_key_exists("darkBackgroundLogo", $this->_propDict)) {
            if (is_a($this->_propDict["darkBackgroundLogo"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MimeContent")) {
    ...
    */
    public function getLightBackgroundLogo()
    {
        if (array_key_exists("lightBackgroundLogo", $this->_propDict)) {
            if (is_a($this->_propDict["lightBackgroundLogo"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MimeContent")) {
    ...
    */
    public function getThemeColor()
    {
        if (array_key_exists("themeColor", $this->_propDict)) {
            if (is_a($this->_propDict["themeColor"], "Solid_Backups\Strauss\Microsoft\Graph\Model\RgbColor")) {
