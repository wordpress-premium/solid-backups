    ...
    */
    public function getCapabilities()
    {
        if (array_key_exists("capabilities", $this->_propDict)) {
            if (is_a($this->_propDict["capabilities"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrinterCapabilities")) {
    ...
    */
    public function getDefaults()
    {
        if (array_key_exists("defaults", $this->_propDict)) {
            if (is_a($this->_propDict["defaults"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrinterDefaults")) {
    ...
    */
    public function getLocation()
    {
        if (array_key_exists("location", $this->_propDict)) {
            if (is_a($this->_propDict["location"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrinterLocation")) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrinterStatus")) {
