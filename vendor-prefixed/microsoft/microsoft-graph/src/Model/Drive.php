    ...
    */
    public function getQuota()
    {
        if (array_key_exists("quota", $this->_propDict)) {
            if (is_a($this->_propDict["quota"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Quota")) {
    ...
    */
    public function getSystem()
    {
        if (array_key_exists("system", $this->_propDict)) {
            if (is_a($this->_propDict["system"], "Solid_Backups\Strauss\Microsoft\Graph\Model\SystemFacet")) {
