    ...
    */
    public function getInfo()
    {
        if (array_key_exists("info", $this->_propDict)) {
            if (is_a($this->_propDict["info"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ParticipantInfo")) {
    ...
    */
    public function getRecordingInfo()
    {
        if (array_key_exists("recordingInfo", $this->_propDict)) {
            if (is_a($this->_propDict["recordingInfo"], "Solid_Backups\Strauss\Microsoft\Graph\Model\RecordingInfo")) {
