    ...
    */
    public function getAndroidRestriction()
    {
        if (array_key_exists("androidRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["androidRestriction"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DeviceEnrollmentPlatformRestriction")) {
    ...
    */
    public function getIosRestriction()
    {
        if (array_key_exists("iosRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["iosRestriction"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DeviceEnrollmentPlatformRestriction")) {
    ...
    */
    public function getMacOSRestriction()
    {
        if (array_key_exists("macOSRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["macOSRestriction"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DeviceEnrollmentPlatformRestriction")) {
    ...
    */
    public function getWindowsMobileRestriction()
    {
        if (array_key_exists("windowsMobileRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["windowsMobileRestriction"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DeviceEnrollmentPlatformRestriction")) {
    ...
    */
    public function getWindowsRestriction()
    {
        if (array_key_exists("windowsRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["windowsRestriction"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DeviceEnrollmentPlatformRestriction")) {
