    ...
    */
    public function getLarge()
    {
        if (array_key_exists("large", $this->_propDict)) {
            if (is_a($this->_propDict["large"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Thumbnail")) {
    ...
    */
    public function getMedium()
    {
        if (array_key_exists("medium", $this->_propDict)) {
            if (is_a($this->_propDict["medium"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Thumbnail")) {
    ...
    */
    public function getSmall()
    {
        if (array_key_exists("small", $this->_propDict)) {
            if (is_a($this->_propDict["small"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Thumbnail")) {
    ...
    */
    public function getSource()
    {
        if (array_key_exists("source", $this->_propDict)) {
            if (is_a($this->_propDict["source"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Thumbnail")) {
