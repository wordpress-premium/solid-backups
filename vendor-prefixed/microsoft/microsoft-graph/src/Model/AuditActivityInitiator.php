    ...
    */
    public function getApp()
    {
        if (array_key_exists("app", $this->_propDict)) {
            if (is_a($this->_propDict["app"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AppIdentity")) {
    ...
    */
    public function getUser()
    {
        if (array_key_exists("user", $this->_propDict)) {
            if (is_a($this->_propDict["user"], "Solid_Backups\Strauss\Microsoft\Graph\Model\UserIdentity")) {
