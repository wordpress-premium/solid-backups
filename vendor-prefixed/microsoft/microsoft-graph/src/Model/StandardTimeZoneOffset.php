    ...
    */
    public function getDayOfWeek()
    {
        if (array_key_exists("dayOfWeek", $this->_propDict)) {
            if (is_a($this->_propDict["dayOfWeek"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DayOfWeek")) {
    ...
    */
    public function getTime()
    {
        if (array_key_exists("time", $this->_propDict)) {
            if (is_a($this->_propDict["time"], "Solid_Backups\Strauss\Microsoft\Graph\Model\TimeOfDay")) {
