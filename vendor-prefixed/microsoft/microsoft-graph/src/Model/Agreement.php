    ...
    */
    public function getTermsExpiration()
    {
        if (array_key_exists("termsExpiration", $this->_propDict)) {
            if (is_a($this->_propDict["termsExpiration"], "Solid_Backups\Strauss\Microsoft\Graph\Model\TermsExpiration")) {
    ...
    */
    public function getUserReacceptRequiredFrequency()
    {
        if (array_key_exists("userReacceptRequiredFrequency", $this->_propDict)) {
            if (is_a($this->_propDict["userReacceptRequiredFrequency"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Duration")) {
    ...
    */
    public function getFile()
    {
        if (array_key_exists("file", $this->_propDict)) {
            if (is_a($this->_propDict["file"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AgreementFile")) {
