    ...
    */
    public function getMaintenanceWindowStartTime()
    {
        if (array_key_exists("maintenanceWindowStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["maintenanceWindowStartTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\TimeOfDay")) {
    ...
    */
    public function getMiracastChannel()
    {
        if (array_key_exists("miracastChannel", $this->_propDict)) {
            if (is_a($this->_propDict["miracastChannel"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MiracastChannel")) {
    ...
    */
    public function getWelcomeScreenMeetingInformation()
    {
        if (array_key_exists("welcomeScreenMeetingInformation", $this->_propDict)) {
            if (is_a($this->_propDict["welcomeScreenMeetingInformation"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WelcomeScreenMeetingInformation")) {
