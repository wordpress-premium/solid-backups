    ...
    */
    public function getAuthenticationMethodsPolicy()
    {
        if (array_key_exists("authenticationMethodsPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationMethodsPolicy"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AuthenticationMethodsPolicy")) {
    ...
    */
    public function getAuthorizationPolicy()
    {
        if (array_key_exists("authorizationPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["authorizationPolicy"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AuthorizationPolicy")) {
    ...
    */
    public function getIdentitySecurityDefaultsEnforcementPolicy()
    {
        if (array_key_exists("identitySecurityDefaultsEnforcementPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["identitySecurityDefaultsEnforcementPolicy"], "Solid_Backups\Strauss\Microsoft\Graph\Model\IdentitySecurityDefaultsEnforcementPolicy")) {
