    ...
    */
    public function getChangeType()
    {
        if (array_key_exists("changeType", $this->_propDict)) {
            if (is_a($this->_propDict["changeType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ChangeType")) {
    ...
    */
    public function getEncryptedContent()
    {
        if (array_key_exists("encryptedContent", $this->_propDict)) {
            if (is_a($this->_propDict["encryptedContent"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ChangeNotificationEncryptedContent")) {
    ...
    */
    public function getLifecycleEvent()
    {
        if (array_key_exists("lifecycleEvent", $this->_propDict)) {
            if (is_a($this->_propDict["lifecycleEvent"], "Solid_Backups\Strauss\Microsoft\Graph\Model\LifecycleEventType")) {
    ...
    */
    public function getResourceData()
    {
        if (array_key_exists("resourceData", $this->_propDict)) {
            if (is_a($this->_propDict["resourceData"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ResourceData")) {
