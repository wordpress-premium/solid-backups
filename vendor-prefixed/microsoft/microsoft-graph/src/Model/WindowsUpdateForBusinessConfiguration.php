    ...
    */
    public function getAutomaticUpdateMode()
    {
        if (array_key_exists("automaticUpdateMode", $this->_propDict)) {
            if (is_a($this->_propDict["automaticUpdateMode"], "Solid_Backups\Strauss\Microsoft\Graph\Model\AutomaticUpdateMode")) {
    ...
    */
    public function getBusinessReadyUpdatesOnly()
    {
        if (array_key_exists("businessReadyUpdatesOnly", $this->_propDict)) {
            if (is_a($this->_propDict["businessReadyUpdatesOnly"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WindowsUpdateType")) {
    ...
    */
    public function getDeliveryOptimizationMode()
    {
        if (array_key_exists("deliveryOptimizationMode", $this->_propDict)) {
            if (is_a($this->_propDict["deliveryOptimizationMode"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WindowsDeliveryOptimizationMode")) {
    ...
    */
    public function getInstallationSchedule()
    {
        if (array_key_exists("installationSchedule", $this->_propDict)) {
            if (is_a($this->_propDict["installationSchedule"], "Solid_Backups\Strauss\Microsoft\Graph\Model\WindowsUpdateInstallScheduleType")) {
    ...
    */
    public function getPrereleaseFeatures()
    {
        if (array_key_exists("prereleaseFeatures", $this->_propDict)) {
            if (is_a($this->_propDict["prereleaseFeatures"], "Solid_Backups\Strauss\Microsoft\Graph\Model\PrereleaseFeatures")) {
