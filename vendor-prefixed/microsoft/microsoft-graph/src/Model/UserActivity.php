    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Status")) {
    ...
    */
    public function getVisualElements()
    {
        if (array_key_exists("visualElements", $this->_propDict)) {
            if (is_a($this->_propDict["visualElements"], "Solid_Backups\Strauss\Microsoft\Graph\Model\VisualInfo")) {
