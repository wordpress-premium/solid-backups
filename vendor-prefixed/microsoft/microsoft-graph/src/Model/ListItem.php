    ...
    */
    public function getContentType()
    {
        if (array_key_exists("contentType", $this->_propDict)) {
            if (is_a($this->_propDict["contentType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ContentTypeInfo")) {
    ...
    */
    public function getFields()
    {
        if (array_key_exists("fields", $this->_propDict)) {
            if (is_a($this->_propDict["fields"], "Solid_Backups\Strauss\Microsoft\Graph\Model\FieldValueSet")) {
