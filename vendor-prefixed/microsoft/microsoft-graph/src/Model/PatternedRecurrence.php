    ...
    */
    public function getPattern()
    {
        if (array_key_exists("pattern", $this->_propDict)) {
            if (is_a($this->_propDict["pattern"], "Solid_Backups\Strauss\Microsoft\Graph\Model\RecurrencePattern")) {
    ...
    */
    public function getRange()
    {
        if (array_key_exists("range", $this->_propDict)) {
            if (is_a($this->_propDict["range"], "Solid_Backups\Strauss\Microsoft\Graph\Model\RecurrenceRange")) {
