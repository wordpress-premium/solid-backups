    ...
    */
    public function getEventEndTime()
    {
        if (array_key_exists("eventEndTime", $this->_propDict)) {
            if (is_a($this->_propDict["eventEndTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DateTimeTimeZone")) {
    ...
    */
    public function getEventLocation()
    {
        if (array_key_exists("eventLocation", $this->_propDict)) {
            if (is_a($this->_propDict["eventLocation"], "Solid_Backups\Strauss\Microsoft\Graph\Model\Location")) {
    ...
    */
    public function getEventStartTime()
    {
        if (array_key_exists("eventStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["eventStartTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DateTimeTimeZone")) {
    ...
    */
    public function getReminderFireTime()
    {
        if (array_key_exists("reminderFireTime", $this->_propDict)) {
            if (is_a($this->_propDict["reminderFireTime"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DateTimeTimeZone")) {
