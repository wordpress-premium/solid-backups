    ...
    */
    public function getDaylightOffset()
    {
        if (array_key_exists("daylightOffset", $this->_propDict)) {
            if (is_a($this->_propDict["daylightOffset"], "Solid_Backups\Strauss\Microsoft\Graph\Model\DaylightTimeZoneOffset")) {
    ...
    */
    public function getStandardOffset()
    {
        if (array_key_exists("standardOffset", $this->_propDict)) {
            if (is_a($this->_propDict["standardOffset"], "Solid_Backups\Strauss\Microsoft\Graph\Model\StandardTimeZoneOffset")) {
