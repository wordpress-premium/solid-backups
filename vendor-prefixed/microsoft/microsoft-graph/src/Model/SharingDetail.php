    ...
    */
    public function getSharedBy()
    {
        if (array_key_exists("sharedBy", $this->_propDict)) {
            if (is_a($this->_propDict["sharedBy"], "Solid_Backups\Strauss\Microsoft\Graph\Model\InsightIdentity")) {
    ...
    */
    public function getSharingReference()
    {
        if (array_key_exists("sharingReference", $this->_propDict)) {
            if (is_a($this->_propDict["sharingReference"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ResourceReference")) {
