    ...
    */
    public function getAppDataEncryptionType()
    {
        if (array_key_exists("appDataEncryptionType", $this->_propDict)) {
            if (is_a($this->_propDict["appDataEncryptionType"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ManagedAppDataEncryptionType")) {
    ...
    */
    public function getDeploymentSummary()
    {
        if (array_key_exists("deploymentSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentSummary"], "Solid_Backups\Strauss\Microsoft\Graph\Model\ManagedAppPolicyDeploymentSummary")) {
