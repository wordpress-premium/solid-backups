    ...
    */
    public function getLargeCover()
    {
        if (array_key_exists("largeCover", $this->_propDict)) {
            if (is_a($this->_propDict["largeCover"], "Solid_Backups\Strauss\Microsoft\Graph\Model\MimeContent")) {
    ...
    */
    public function getInstallSummary()
    {
        if (array_key_exists("installSummary", $this->_propDict)) {
            if (is_a($this->_propDict["installSummary"], "Solid_Backups\Strauss\Microsoft\Graph\Model\EBookInstallSummary")) {
