<?php
namespace Solid_Backups\Strauss\JmesPath;
...
class TreeCompiler
{
    ...
    public function visit(array $ast, $fnName, $expr)
    {
        ...
        $this->write("<?php\n")
            ->write('use Solid_Backups\\Strauss\\JmesPath\\TreeInterpreter as Ti;')
            ->write('use Solid_Backups\\Strauss\\JmesPath\\FnDispatcher as Fd;')
            ->write('use Solid_Backups\\Strauss\\JmesPath\\Utils;')
            ->write('')
