<?php
/* Solid Backups Stash Live Manual Snapshot GUI
 *
...
<div class="pb_backupbuddy_alert postbox backupbuddy-live-snapshot-complete-container" id="backupbuddy_live_snapshot-success" style="padding:0!important">
	...
	<p class="backupbuddy-live-snapshot-complete-message">
		<span id="backupbuddy_live_snapshot-stashed" style="display: none;">
			<?php _e( 'This snapshot has also been copied to your Solid Backups Stash storage based on your settings for long-term storage.', 'it-l10n-backupbuddy' ); ?>
		</span>
		<?php _e( 'You may download the snapshot files below (links valid for 24 hours) which may be used just like a normal Solid Backups backup for restoring with the Importer Restore Tool.', 'it-l10n-backupbuddy' ); ?>
	</p>
	...
	<div class="backupbuddy-live-snapshot-complete-downloads">
		...
		<ul>
			<li id="backupbuddy_live_snapshot-success-backup_importbuddy"><a href="" class="backupbuddy-live-button primary blue"><?php _e( 'Importer Restore Tool', 'it-l10n-backupbuddy' ); ?></a></li>
		</ul>
	</div>
