...
if ( pb_backupbuddy::_GET( 'downloadlink_file' ) != '' ) {
	$link = pb_backupbuddy_destination_s33::getFileURL( $settings, pb_backupbuddy::_GET( 'downloadlink_file' ) );
...
$files = pb_backupbuddy_destination_s33::listFiles( $settings, $remotePath, $marker );
if ( ! is_array( $files ) ) {
