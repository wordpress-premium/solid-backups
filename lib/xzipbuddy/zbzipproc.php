...
if ( !class_exists( "pluginbuddy_zbzipproc" ) ) {
	...
	class pluginbuddy_zbzipproc extends pluginbuddy_zbzipcore {
		...
		/*	get_file_contents()
		 *
		 *	Get the contents of a file in a zip file.
		 *
		 *	@param		string		$zip_file	The file to list the content of
		 *	@param      string      $file_path  Path to file getting contents of.
		 *	@return		bool|string				false on failure, otherwise string of file contents.
		 */
